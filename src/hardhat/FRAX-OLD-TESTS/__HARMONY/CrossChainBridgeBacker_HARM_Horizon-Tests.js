...
contract('CrossChainBridgeBacker_HARM_Horizon-Tests', async (accounts) => {
	...
	it('Main test', async () => {
		...
		await oneFRAX_instance.transfer(COLLATERAL_FRAX_AND_FXS_OWNER, new BigNumber('10000e18'), {
			from: ADDRESS_WITH_oneFRAX,
		});
		...
		await oneFXS_instance.transfer(COLLATERAL_FRAX_AND_FXS_OWNER, new BigNumber('1000e18'), {
			from: ADDRESS_WITH_oneFXS,
		});
		...
		await oneUSDC_instance.transfer(COLLATERAL_FRAX_AND_FXS_OWNER, new BigNumber('10000e6'), {
			from: ADDRESS_WITH_oneUSDC,
		});
		...
		await canFRAX_instance.nominateNewOwner(COLLATERAL_FRAX_AND_FXS_OWNER, {
			from: process.env.HARMONY_ONE_ADDRESS,
		});
		...
		await oneFRAX_instance.transfer(canFRAX_instance.address, new BigNumber('5000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await oneFXS_instance.transfer(canFXS_instance.address, new BigNumber('5000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('=========================DUMP IN SOME oneFRAX [SIMULATES BRIDGE]========================='),
		);
		const dump_amt_oneFRAX = new BigNumber('125e18');
		console.log('dump_amt_oneFRAX: ', dump_amt_oneFRAX.div(BIG18).toNumber());

		await oneFRAX_instance.transfer(cc_bridge_backer_instance.address, dump_amt_oneFRAX, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('=========================DUMP IN SOME oneFXS [SIMULATES BRIDGE]========================='),
		);
		const dump_amt_oneFXS = new BigNumber('125e18');
		console.log('dump_amt_oneFXS: ', dump_amt_oneFXS.div(BIG18).toNumber());

		await oneFXS_instance.transfer(cc_bridge_backer_instance.address, dump_amt_oneFXS, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		await oneUSDC_instance.transfer(cc_bridge_backer_instance.address, dump_amt_USDC, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================GIVE THE canFRAX CONTRACT SOME oneFRAX ==========================='),
		);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================SWAP oneFRAX for canFRAX manually==========================='),
		);
		...
		await cc_bridge_backer_instance.swapAnyForCanonical(0, swapAnyForCanonical_amt_oneFRAX, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================SWAP oneFXS for canFXS manually==========================='),
		);
		...
		await cc_bridge_backer_instance.swapAnyForCanonical(1, swapAnyForCanonical_amt_oneFXS, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================MINT SOME canFRAX and oneFRAX==========================='),
		);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================BURN SOME canFRAX and oneFRAX==========================='),
		);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================COLLECT SOME oneFRAX AND oneFXS==========================='),
		);
		const canToken_collect_amt = new BigNumber('1e18');
		console.log('canToken_collect_amt: ', canToken_collect_amt.div(BIG18).toNumber());

		await cc_bridge_backer_instance.collectBridgeTokens(0, oneFRAX_instance.address, canToken_collect_amt, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await cc_bridge_backer_instance.collectBridgeTokens(1, oneFXS_instance.address, canToken_collect_amt, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold(
					'===========================NOTE SOME SushiSwapLiquidityAMO_HARM INFO===========================',
				),
		);
		...
		let amo_canFXS_bal_before = new BigNumber(await canFXS_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		let amo_usdc_bal_before = new BigNumber(await oneUSDC_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG6)
			.toNumber();
		...
		let amo_canFXS_bal_after = new BigNumber(await canFXS_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		let amo_usdc_bal_after = new BigNumber(await oneUSDC_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG6)
			.toNumber();
		...
		await cc_bridge_backer_instance.lendFraxToAMO(
			SushiSwapLiquidityAMO_HARM_instance.address,
		...
		amo_canFXS_bal_before = new BigNumber(await canFXS_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		amo_usdc_bal_before = new BigNumber(await oneUSDC_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG6)
			.toNumber();
		...
		await oneUSDC_instance.approve(cc_bridge_backer_instance.address, new BigNumber('25e6'), {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		await cc_bridge_backer_instance.receiveBackViaAMO(oneUSDC_instance.address, new BigNumber('25e6'), false, {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		...
		amo_canFXS_bal_after = new BigNumber(await canFXS_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		amo_usdc_bal_after = new BigNumber(await oneUSDC_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG6)
			.toNumber();
		...
		await SushiSwapLiquidityAMO_HARM_instance.giveFRAXBack(new BigNumber('25e18'), false, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Give back 25 canFXS');
		await SushiSwapLiquidityAMO_HARM_instance.giveFXSBack(new BigNumber('25e18'), false, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Give back 25 oneUSDC');
		await SushiSwapLiquidityAMO_HARM_instance.giveCollatBack(new BigNumber('25e6'), false, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		await oneUSDC_instance.approve(cc_bridge_backer_instance.address, new BigNumber('1e6'), {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		await cc_bridge_backer_instance.receiveBackViaAMO(oneUSDC_instance.address, new BigNumber('1e6'), true, {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		...
		console.log('Give 1 canFRAX');
		await SushiSwapLiquidityAMO_HARM_instance.giveFRAXBack(new BigNumber('1e18'), true, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Give 1 canFXS');
		await SushiSwapLiquidityAMO_HARM_instance.giveFXSBack(new BigNumber('1e18'), true, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Give 1 oneUSDC');
		await SushiSwapLiquidityAMO_HARM_instance.giveCollatBack(new BigNumber('1e6'), true, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		await cc_bridge_backer_instance.execute(oneFRAX_instance.address, 0, calldata, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
