...
contract('CrossChainBridgeBacker_MNBM_Nomad-Tests', async (accounts) => {
	...
	it('Main test', async () => {
		...
		await madFRAX_instance.transfer(COLLATERAL_FRAX_AND_FXS_OWNER, new BigNumber('10000e18'), {
			from: ADDRESS_WITH_MADFRAX,
		});
		...
		await madFXS_instance.transfer(COLLATERAL_FRAX_AND_FXS_OWNER, new BigNumber('1000e18'), {
			from: ADDRESS_WITH_MADFXS,
		});
		...
		await madUSDC_instance.transfer(COLLATERAL_FRAX_AND_FXS_OWNER, new BigNumber('10000e6'), {
			from: ADDRESS_WITH_MADUSDC,
		});
		...
		await canFRAX_instance.nominateNewOwner(COLLATERAL_FRAX_AND_FXS_OWNER, {
			from: process.env.MOONBEAM_ONE_ADDRESS,
		});
		...
		await madFRAX_instance.transfer(canFRAX_instance.address, new BigNumber('5000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await madFXS_instance.transfer(canFXS_instance.address, new BigNumber('500e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('=========================DUMP IN SOME madFRAX [SIMULATES BRIDGE]========================='),
		);
		const dump_amt_madFRAX = new BigNumber('125e18');
		console.log('dump_amt_madFRAX: ', dump_amt_madFRAX.div(BIG18).toNumber());

		await madFRAX_instance.transfer(cc_bridge_backer_instance.address, dump_amt_madFRAX, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('=========================DUMP IN SOME madFXS [SIMULATES BRIDGE]========================='),
		);
		const dump_amt_madFXS = new BigNumber('50e18');
		console.log('dump_amt_madFXS: ', dump_amt_madFXS.div(BIG18).toNumber());

		await madFXS_instance.transfer(cc_bridge_backer_instance.address, dump_amt_madFXS, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		await madUSDC_instance.transfer(cc_bridge_backer_instance.address, dump_amt_USDC, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================GIVE THE canFRAX CONTRACT SOME madFRAX ==========================='),
		);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================SWAP madFRAX for canFRAX manually==========================='),
		);
		...
		await cc_bridge_backer_instance.swapAnyForCanonical(0, swapAnyForCanonical_amt_madFRAX, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================SWAP madFXS for canFXS manually==========================='),
		);
		...
		await cc_bridge_backer_instance.swapAnyForCanonical(1, swapAnyForCanonical_amt_madFXS, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================MINT SOME canFRAX and madFRAX==========================='),
		);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================BURN SOME canFRAX and madFRAX==========================='),
		);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('==========COLLECT SOME madFRAX AND madFXS FROM THE CANONICAL CONTRACTS=========='),
		);
		const canToken_collect_amt = new BigNumber('1e18');
		console.log('canToken_collect_amt: ', canToken_collect_amt.div(BIG18).toNumber());

		await cc_bridge_backer_instance.collectBridgeTokens(0, madFRAX_instance.address, canToken_collect_amt, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await cc_bridge_backer_instance.collectBridgeTokens(1, madFXS_instance.address, canToken_collect_amt, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		let amo_canFXS_bal_before = new BigNumber(await canFXS_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		let amo_usdc_bal_before = new BigNumber(await madUSDC_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG6)
			.toNumber();
		...
		let amo_canFXS_bal_after = new BigNumber(await canFXS_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		let amo_usdc_bal_after = new BigNumber(await madUSDC_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG6)
			.toNumber();
		...
		amo_canFXS_bal_before = new BigNumber(await canFXS_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		amo_usdc_bal_before = new BigNumber(await madUSDC_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG6)
			.toNumber();
		...
		await madUSDC_instance.approve(cc_bridge_backer_instance.address, new BigNumber('5e6'), {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		await cc_bridge_backer_instance.receiveBackViaAMO(madUSDC_instance.address, new BigNumber('5e6'), false, {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		...
		amo_canFXS_bal_after = new BigNumber(await canFXS_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		amo_usdc_bal_after = new BigNumber(await madUSDC_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG6)
			.toNumber();
		...
		await madUSDC_instance.approve(cc_bridge_backer_instance.address, new BigNumber('1e6'), {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		await cc_bridge_backer_instance.receiveBackViaAMO(madUSDC_instance.address, new BigNumber('1e6'), true, {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		...
		await cc_bridge_backer_instance.execute(madFRAX_instance.address, 0, calldata, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
