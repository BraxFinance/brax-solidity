...
contract('CrossChainBridgeBacker_AVAX_AnySwap-Tests', async (accounts) => {
	...
	it('Main test', async () => {
		...
		await cc_bridge_backer_instance.nominateNewOwner(COLLATERAL_FRAX_AND_FXS_OWNER, {
			from: process.env.AVALANCHE_ONE_ADDRESS,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================NOTE SOME PangolinLiquidityAMO INFO==========================='),
		);
		...
		console.log('Lend 1000 canFRAX');
		await cc_bridge_backer_instance.lendFraxToAMO(pangolinLiquidityAMO_instance.address, new BigNumber('1000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Lend 1000 canFXS');
		await cc_bridge_backer_instance.lendFxsToAMO(pangolinLiquidityAMO_instance.address, new BigNumber('1000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		await pangolinLiquidityAMO_instance.giveFRAXBack(new BigNumber('250e18'), false, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Give back 250 canFXS');
		await pangolinLiquidityAMO_instance.giveFXSBack(new BigNumber('250e18'), false, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log('Give 100 canFRAX');
		await pangolinLiquidityAMO_instance.giveFRAXBack(new BigNumber('100e18'), true, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Give 100 canFXS');
		await pangolinLiquidityAMO_instance.giveFXSBack(new BigNumber('100e18'), true, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
