...
contract('PangolinLiquidityAMO-Tests', async (accounts) => {
	...
	it('Main test', async () => {
		...
		await usdc_instance.transfer(pangolin_liquidity_amo_instance.address, new BigNumber('100000e6'), {
		...
		const FXS_ORACLE_PRICE_E6 = new BigNumber(
			await cross_chain_oracle_instance.getPrice.call(CONTRACT_ADDRESSES.avalanche.canonicals.FXS),
		);
		...
		await canFRAX_instance.transfer(cc_bridge_backer_instance.address, initial_dump_amt_ccbb_canToken, {
			from: GOVERNOR_GUARDIAN_ADDRESS,
		});
		await canFXS_instance.transfer(cc_bridge_backer_instance.address, initial_dump_amt_ccbb_canToken, {
			from: GOVERNOR_GUARDIAN_ADDRESS,
		});
		...
		utilities.printAllocations(
			...
			cc_bridge_backer_allocations,
			cc_bridge_backer_old_allocations,
		);
		utilities.printTokenBalances(
			'CROSS_CHAIN_BRIDGE_BACKER',
			cc_bridge_backer_token_balances,
			cc_bridge_backer_old_balances,
		);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold(
					'=========================GIVE THE PangolinLiquidityAMO SOME canFRAX AND canFXS=========================',
				),
		);
		...
		console.log('Give the bridge backer some canFRAX and canFXS');
		await canFRAX_instance.transfer(pangolin_liquidity_amo_instance.address, initial_dump_amt_amo_canToken, {
			from: GOVERNOR_GUARDIAN_ADDRESS,
		});
		await canFXS_instance.transfer(pangolin_liquidity_amo_instance.address, initial_dump_amt_amo_canToken, {
			from: GOVERNOR_GUARDIAN_ADDRESS,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================CREATE SOME FRAX/FXS LP TOKENS==========================='),
		);
		const FXS_PRICE_FROM_LP0_E18 = new BigNumber(
			await pangolin_liquidity_amo_instance.pair_reserve_ratio_E18.call(
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================CREATE SOME FRAX/USDC.e LP TOKENS==========================='),
		);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================CREATE SOME FXS/USDC.e LP TOKENS==========================='),
		);
		const FXS_PRICE_FROM_LP2_E18 = new BigNumber(
			await pangolin_liquidity_amo_instance.pair_reserve_ratio_E18.call(
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================SWAP SOME FRAX FOR USDC.e==========================='),
		);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================SWAP SOME FRAX FOR USDC.e VIA FXS==========================='),
		);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold(
					'===========================GIVE SOME CANONICAL TOKENS TO THE PangolinLiquidityAMO===========================',
				),
		);

		console.log('Lend 1000 canFRAX');
		await cc_bridge_backer_instance.lendFraxToAMO(cc_bridge_backer_instance.address, new BigNumber('1000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Lend 1000 canFXS');
		await cc_bridge_backer_instance.lendFxsToAMO(cc_bridge_backer_instance.address, new BigNumber('1000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================AMO GIVES BACK TOKENS [NO BRIDGE]==========================='),
		);

		console.log('Give back 250 canFRAX');
		await pangolin_liquidity_amo_instance.giveFRAXBack(new BigNumber('250e18'), false, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Give back 250 canFXS');
		await pangolin_liquidity_amo_instance.giveFXSBack(new BigNumber('250e18'), false, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Give back 250 USDC.e');
		await pangolin_liquidity_amo_instance.giveCollatBack(new BigNumber('250e6'), false, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================AMO GIVES BACK TOKENS [WITH BRIDGE]==========================='),
		);

		console.log('Give back 1 canFRAX');
		await pangolin_liquidity_amo_instance.giveFRAXBack(new BigNumber('1e18'), true, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Give back 1 canFXS');
		await pangolin_liquidity_amo_instance.giveFXSBack(new BigNumber('1e18'), true, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		await pangolin_liquidity_amo_instance.execute(canFRAX_instance.address, 0, calldata, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
