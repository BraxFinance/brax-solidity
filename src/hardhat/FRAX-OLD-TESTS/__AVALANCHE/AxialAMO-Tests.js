	...
	it('Main test', async () => {
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold(
					'===========================LEND SOME CANONICAL TOKENS TO THE AxialAMO===========================',
				),
		);

		console.log('Lend 1000 canFRAX');
		await cc_bridge_backer_instance.lendFraxToAMO(axial_amo_instance.address, new BigNumber('1000e18'), {
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================DEPOSIT TSD ALONE FOR LP TOKENS==========================='),
		);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================DEPOSIT MIM ALONE FOR LP TOKENS==========================='),
		);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================DEPOSIT ALL 4 TOKENS FOR LP TOKENS==========================='),
		);
		...
		await axial_amo_instance.ac4dDeposit(
			tsd_mixed_deposit_amt,
			mim_mixed_deposit_amt,
		...
		console.log(
			chalk.hex('#ff8b3d').bold('===========================WITHDRAW TSD ONLY==========================='),
		);
		...
		console.log(
			chalk.hex('#ff8b3d').bold('===========================WITHDRAW MIM ONLY==========================='),
		);
		...
		console.log(
			chalk.hex('#ff8b3d').bold('===========================WITHDRAW DAI ONLY==========================='),
		);
		...
		await axial_amo_instance.ac4dWithdrawAtCurRatio(mixed_lp_withdraw_amt, 0, 0, 0, 0, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk.hex('#ff8b3d').bold('===========================DEPOSIT TO MASTERCHEF==========================='),
		);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================WAIT SOME TIME AND CLAIM REWARDS==========================='),
		);
		// Advance a few days
		for (let j = 0; j < 8; j++) {
		...
		console.log(
			'AXIAL balance before: ',
			new BigNumber(await axial_instance.balanceOf.call(axial_amo_instance.address)).div(BIG18).toNumber(),
		);
		...
		console.log(
			chalk.hex('#ff8b3d').bold('===========================WITHDRAW FROM MASTERCHEF==========================='),
		);
		...
		await axial_amo_instance.execute(canFRAX_instance.address, 0, calldata, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
