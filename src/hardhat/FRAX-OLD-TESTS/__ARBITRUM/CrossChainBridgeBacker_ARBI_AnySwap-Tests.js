...
contract('CrossChainBridgeBacker_ARBI_AnySwap-Tests', async (accounts) => {
	...
	it('Main test', async () => {
		...
		await anyFRAX_instance.transfer(COLLATERAL_FRAX_AND_FXS_OWNER, new BigNumber('1000e18'), {
			from: ADDRESS_WITH_anyFRAX,
		});
		...
		await anyFXS_instance.transfer(COLLATERAL_FRAX_AND_FXS_OWNER, new BigNumber('1000e18'), {
			from: ADDRESS_WITH_anyFXS,
		});
		...
		await canFRAX_instance.nominateNewOwner(COLLATERAL_FRAX_AND_FXS_OWNER, {
			from: process.env.ARBITRUM_ONE_ADDRESS,
		});
		...
		await anyFRAX_instance.transfer(canFRAX_instance.address, new BigNumber('500e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await anyFXS_instance.transfer(canFXS_instance.address, new BigNumber('500e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold(
					'===========================NOTE SOME SushiSwapLiquidityAMO_ARBI INFO===========================',
				),
		);
		...
		let amo_canFXS_bal_before = new BigNumber(await canFXS_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		let amo_usdc_bal_before = new BigNumber(await arbiUSDC_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG6)
			.toNumber();
		...
		let amo_canFXS_bal_after = new BigNumber(await canFXS_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		let amo_usdc_bal_after = new BigNumber(await arbiUSDC_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG6)
			.toNumber();
		...
		await cc_bridge_backer_instance.lendFraxToAMO(
			SushiSwapLiquidityAMO_ARBI_instance.address,
		...
		amo_canFXS_bal_before = new BigNumber(await canFXS_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		amo_usdc_bal_before = new BigNumber(await arbiUSDC_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG6)
			.toNumber();
		...
		amo_canFXS_bal_after = new BigNumber(await canFXS_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		amo_usdc_bal_after = new BigNumber(await arbiUSDC_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG6)
			.toNumber();
		...
		console.log(
			'arbiUSDC balance [STAKING_REWARDS_DISTRIBUTOR] change: ',
		...
		await SushiSwapLiquidityAMO_ARBI_instance.giveFRAXBack(new BigNumber('25e18'), false, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Give back 25 canFXS');
		await SushiSwapLiquidityAMO_ARBI_instance.giveFXSBack(new BigNumber('25e18'), false, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log('Give 1 canFRAX');
		await SushiSwapLiquidityAMO_ARBI_instance.giveFRAXBack(new BigNumber('1e18'), true, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Give 1 canFXS');
		await SushiSwapLiquidityAMO_ARBI_instance.giveFXSBack(new BigNumber('1e18'), true, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
