...
module.exports = async (deployer) => {
	...
	cross_chain_canonical_frax_instance = await CrossChainCanonicalFRAX.at(
		CONTRACT_ADDRESSES.moonriver.canonicals.FRAX,
	);
	...
	// Bridges
	cross_chain_bridge_backer_instance = await CrossChainBridgeBacker_MOON_AnySwap.at(
		CONTRACT_ADDRESSES.moonriver.bridge_backers.anySwap,
	);
	...
	combo_oracle_univ2_univ3_instance = await ComboOracle_UniV2_UniV3.at(
		CONTRACT_ADDRESSES.moonriver.oracles_other.combo_oracle_univ2_univ3,
	);
	...
	await cross_chain_bridge_backer_instance.addAMO(ccfrax_1to1_amm_instance.address, false, {
