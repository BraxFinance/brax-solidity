...
contract('FraxBond_NFT-Tests', async (accounts) => {
	...
	it('Main test', async () => {
		...
		await frax_instance.approve(bondInstance_FXBA10000M3.address, new BigNumber(100000e18), {
		...
		const expected_values_CALL = await bondInstance_FXBA10000M3.redeemBond.call(0, {
			from: FRAX_UTILITY_CONTRACTOR,
		});
		...
		console.log('---------NOTE FRAX BALANCE BEFORE---------');
		const frax_balance_before_bond1 = new BigNumber(await frax_instance.balanceOf(FRAX_UTILITY_CONTRACTOR)).div(
			BIG18,
		);
		...
		await expectRevert.unspecified(
			bondInstance_FXBA10000M3.safeTransferFrom(FRAX_UTILITY_CONTRACTOR, frax_instance.address, 0, {
				from: FRAX_UTILITY_CONTRACTOR,
			}),
		);
		...
		await expectRevert.unspecified(
			bondInstance_FXBA10000M3.transferFrom(ORACLE_ADDRESS, FRAX_UTILITY_CONTRACTOR, 0, { from: TIMELOCK_ADMIN }),
		);
		...
		await bondInstance_FXBA10000M3.transferFrom(FRAX_UTILITY_CONTRACTOR, TIMELOCK_ADMIN, 0, {
			from: FRAX_UTILITY_CONTRACTOR,
		});

		console.log('---------SAFE TRANSFER BOND #1 TO ANOTHER ADDRESS---------');
		await bondInstance_FXBA10000M3.safeTransferFrom(FRAX_UTILITY_CONTRACTOR, TIMELOCK_ADMIN, 1, {
			from: FRAX_UTILITY_CONTRACTOR,
		});
		...
		await bondInstance_FXBA10000M3.transferFrom(FRAX_UTILITY_CONTRACTOR, TIMELOCK_ADMIN, 2, {
			from: TIMELOCK_ADMIN,
		});
