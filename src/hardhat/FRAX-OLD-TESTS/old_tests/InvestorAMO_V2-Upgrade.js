...
contract('InvestorAMO_V3-Tests', async (accounts) => {
	...
	it('Main test', async () => {
		...
		const deployed_investor_v2_proxy_target = new web3.eth.Contract(
			[
				{
					anonymous: false,
					inputs: [
				...
				{
					inputs: [],
					name: 'aaveCollect_Cooldowned_AAVE',
					outputs: [],
				...
				{
					inputs: [],
					name: 'aaveCooldown_Show_Cooldowns',
					outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
					stateMutability: 'view',
					type: 'function',
				},
				...
				{
					inputs: [],
					name: 'aaveCooldown_stkAAVE',
					outputs: [],
					stateMutability: 'nonpayable',
					type: 'function',
				},
				{
					inputs: [{ internalType: 'uint256', name: 'USDC_amount', type: 'uint256' }],
					name: 'aaveDepositUSDC',
					outputs: [],
					stateMutability: 'nonpayable',
					type: 'function',
				},
				{
					inputs: [{ internalType: 'uint256', name: 'aUSDC_amount', type: 'uint256' }],
					name: 'aaveWithdrawUSDC',
					outputs: [],
					stateMutability: 'nonpayable',
					type: 'function',
				},
				...
				{
					inputs: [{ internalType: 'uint256', name: 'USDC_amount', type: 'uint256' }],
					name: 'compoundMint_cUSDC',
					outputs: [],
					stateMutability: 'nonpayable',
					type: 'function',
				},
				{
					inputs: [{ internalType: 'uint256', name: 'cUSDC_amount', type: 'uint256' }],
					name: 'compoundRedeem_cUSDC',
					outputs: [],
					stateMutability: 'nonpayable',
					type: 'function',
				},
				...
				{
					inputs: [
						{ internalType: 'address', name: '_frax_contract_address', type: 'address' },
						{ internalType: 'address', name: '_fxs_contract_address', type: 'address' },
						{ internalType: 'address', name: '_pool_address', type: 'address' },
						{ internalType: 'address', name: '_collateral_address', type: 'address' },
				...
				{
					inputs: [{ internalType: 'uint256', name: 'frax_amount', type: 'uint256' }],
					name: 'mintRedeemPart1',
					outputs: [],
					stateMutability: 'nonpayable',
					type: 'function',
				},
				{ inputs: [], name: 'mintRedeemPart2', outputs: [], stateMutability: 'nonpayable', type: 'function' },
				{
					inputs: [],
				...
				{
					inputs: [
						{ internalType: 'bool', name: '_yearn', type: 'bool' },
						{ internalType: 'bool', name: '_aave', type: 'bool' },
						{ internalType: 'bool', name: '_compound', type: 'bool' },
					],
					name: 'setAllowedStrategies',
					outputs: [],
					stateMutability: 'nonpayable',
					type: 'function',
				},
				{
					inputs: [{ internalType: 'uint256', name: '_borrow_cap', type: 'uint256' }],
					name: 'setBorrowCap',
					outputs: [],
					stateMutability: 'nonpayable',
					type: 'function',
				...
				{
					inputs: [{ internalType: 'address', name: '_pool_address', type: 'address' }],
					name: 'setPool',
					outputs: [],
					stateMutability: 'nonpayable',
					type: 'function',
				...
				{
					inputs: [{ internalType: 'address', name: '_weth_address', type: 'address' }],
					name: 'setWethAddress',
					outputs: [],
					stateMutability: 'nonpayable',
					type: 'function',
				},
				{
					...
					outputs: [{ internalType: 'uint256[5]', name: 'allocations', type: 'uint256[5]' }],
					stateMutability: 'view',
					type: 'function',
				},
				{
					inputs: [],
					name: 'showRewards',
					outputs: [{ internalType: 'uint256[3]', name: 'rewards', type: 'uint256[3]' }],
					stateMutability: 'view',
					type: 'function',
				},
				{
				...
				{
					inputs: [{ internalType: 'uint256', name: 'yUSDC_amount', type: 'uint256' }],
					name: 'yWithdrawUSDC',
					outputs: [],
					stateMutability: 'nonpayable',
					type: 'function',
			...
			'0x9b6c44168f7a29a44949429ca55f411acd8391d0',
		);

		// instantiate admin contract of proxy contract
		const admin_of_proxy = new web3.eth.Contract(
			[
				{
					anonymous: false,
					inputs: [
			...
			'0x069c24600c2A03147D4E1D9b04d193151676F577',
		);

		// upgrade proxy's implementation [params: (ProxyAddress, Implementation Address)]
		await admin_of_proxy.methods
			.upgrade('0x2B4d259a8f6E765AD881C4C1D04045D629dA01b4', '0x9b6c44168f7a29a44949429ca55f411acd8391d0')
			.send({ from: '0xa448833bece66fd8803ac0c390936c79b5fd6edf' });

		// instantiate upgraded proxy with implementation ABI and proxy address
		const proxy_upgraded = new web3.eth.Contract(
			[
				{
					anonymous: false,
					inputs: [
			...
			'0x2B4d259a8f6E765AD881C4C1D04045D629dA01b4',
		);
		console.log(
			'test upgraded proxy admin function:',
			new BigNumber(await proxy_upgraded.methods.test_upgrade().call()).toNumber(),
		);

		// set it back to original implementation
		await admin_of_proxy.methods
			.upgrade('0x2B4d259a8f6E765AD881C4C1D04045D629dA01b4', '0xEccA5a27B4f8f92a2bFFd006F20168A7188C0A0C')
			.send({ from: '0xa448833bece66fd8803ac0c390936c79b5fd6edf' });

		// instantiate proxy contract with original implementation
		const proxy_original = new web3.eth.Contract(
			[
				{
					anonymous: false,
					inputs: [
		...
		console.log(
			'proxy on original implementation collatDollarBalance:',
			new BigNumber(await proxy_original.methods.collatDollarBalance().call()).div(BIG18).toNumber(),
		);
