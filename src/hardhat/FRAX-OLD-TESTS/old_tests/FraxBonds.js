...
contract('FraxBond-Tests', async (accounts) => {
	...
	it('Initialization related', async () => {
		...
		console.log(
			'---------Add bond issuer as a pool (on FRAX) and an issuer (on FXB) so it can mint / burn---------',
		);
		...
		await frax_instance.pool_mint(FRAX_UTILITY_CONTRACTOR, new BigNumber('25000000e18'), {
			from: BOND_CONTROLLER_ADDRESS,
		});
	...
	it('Main test', async () => {
		...
		const maximum_fxb_AMM_sellable_above_floor = new BigNumber(
			await bondIssuerInstance.maximum_fxb_AMM_sellable_above_floor.call(),
		).div(BIG18);
		...
		const maximum_fxb_AMM_sellable_above_floor_2 = new BigNumber(
			await bondIssuerInstance.maximum_fxb_AMM_sellable_above_floor.call(),
		).div(BIG18);
		...
		const maximum_fxb_AMM_sellable_above_floor_3 = new BigNumber(
			await bondIssuerInstance.maximum_fxb_AMM_sellable_above_floor.call(),
		).div(BIG18);
		...
		await fxbInstance.approve(bondIssuerInstance.address, new BigNumber('25e18'), {
			from: FRAX_UTILITY_CONTRACTOR,
		});
		await expectRevert(
		...
		const maximum_fxb_AMM_sellable_above_floor_5 = new BigNumber(
			await bondIssuerInstance.maximum_fxb_AMM_sellable_above_floor.call(),
		).div(BIG18);
		...
		const maximum_fxb_AMM_sellable_above_floor_7 = new BigNumber(
			await bondIssuerInstance.maximum_fxb_AMM_sellable_above_floor.call(),
		).div(BIG18);
		...
		const frax_balance_before_redeem_1 = new BigNumber(await frax_instance.balanceOf(FRAX_UTILITY_CONTRACTOR)).div(
			BIG18,
		);
		const fxb_balance_before_redeem_1 = new BigNumber(await fxbInstance.balanceOf(FRAX_UTILITY_CONTRACTOR)).div(
			BIG18,
		);
		...
		const frax_balance_after_redeem_1 = new BigNumber(await frax_instance.balanceOf(FRAX_UTILITY_CONTRACTOR)).div(
			BIG18,
		);
		const fxb_balance_after_redeem_1 = new BigNumber(await fxbInstance.balanceOf(FRAX_UTILITY_CONTRACTOR)).div(
			BIG18,
		);
		...
		const maximum_fxb_AMM_sellable_above_floor_8 = new BigNumber(
			await bondIssuerInstance.maximum_fxb_AMM_sellable_above_floor.call(),
		).div(BIG18);
		...
		await bondIssuerInstance.expand_AMM_liquidity(new BigNumber('100000e18'), 1, {
		...
		const maximum_fxb_AMM_sellable_above_floor_9 = new BigNumber(
			await bondIssuerInstance.maximum_fxb_AMM_sellable_above_floor.call(),
		).div(BIG18);
		...
		await bondIssuerInstance.contract_AMM_liquidity(new BigNumber('300000e18'), 1, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		const maximum_fxb_AMM_sellable_above_floor_10 = new BigNumber(
			await bondIssuerInstance.maximum_fxb_AMM_sellable_above_floor.call(),
		).div(BIG18);
		...
		await bondIssuerInstance.setMaxFXBOutstanding(new BigNumber('100000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await bondIssuerInstance.setTargetLiquidity(new BigNumber('10000e18'), 0, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		const maximum_fxb_AMM_sellable_above_floor_11 = new BigNumber(
			await bondIssuerInstance.maximum_fxb_AMM_sellable_above_floor.call(),
		).div(BIG18);
		...
		const maximum_fxb_AMM_sellable_above_floor_11aaaa = new BigNumber(
			await bondIssuerInstance.maximum_fxb_AMM_sellable_above_floor.call(),
		).div(BIG18);
		...
		const maximum_fxb_AMM_sellable_above_floor_11ab = new BigNumber(
			await bondIssuerInstance.maximum_fxb_AMM_sellable_above_floor.call(),
		).div(BIG18);
		...
		const expected_values_CALL_11aaa = await bondIssuerInstance.buyFXBfromAMM.call(buying_amount_11aaa, 1, {
			from: FRAX_UTILITY_CONTRACTOR,
		});
		...
		const maximum_fxb_AMM_sellable_above_floor_11aaa = new BigNumber(
			await bondIssuerInstance.maximum_fxb_AMM_sellable_above_floor.call(),
		).div(BIG18);
		...
		const expected_values_CALL_11aa = await bondIssuerInstance.buyFXBfromAMM.call(buying_amount_11aa, 1, {
			from: FRAX_UTILITY_CONTRACTOR,
		});
		...
		const maximum_fxb_AMM_sellable_above_floor_11aa = new BigNumber(
			await bondIssuerInstance.maximum_fxb_AMM_sellable_above_floor.call(),
		).div(BIG18);
		...
		const expected_values_CALL_13 = await bondIssuerInstance.sellFXBintoAMM.call(selling_amount_13, 0, {
			from: FRAX_UTILITY_CONTRACTOR,
		});
		...
		const maximum_fxb_AMM_sellable_above_floor_13 = new BigNumber(
			await bondIssuerInstance.maximum_fxb_AMM_sellable_above_floor.call(),
		).div(BIG18);
		...
		const expected_values_CALL_11d = await bondIssuerInstance.sellFXBintoAMM.call(selling_amount_11d, 0, {
			from: FRAX_UTILITY_CONTRACTOR,
		});
		...
		const maximum_fxb_AMM_sellable_above_floor_11d = new BigNumber(
			await bondIssuerInstance.maximum_fxb_AMM_sellable_above_floor.call(),
		).div(BIG18);
		...
		await bondIssuerInstance.setMaxFXBOutstanding(new BigNumber('1000000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await bondIssuerInstance.setTargetLiquidity(new BigNumber('500000e18'), 0, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		const maximum_fxb_AMM_sellable_above_floor_12 = new BigNumber(
			await bondIssuerInstance.maximum_fxb_AMM_sellable_above_floor.call(),
		).div(BIG18);
		...
		const maximum_fxb_AMM_sellable_above_floor_15 = new BigNumber(
			await bondIssuerInstance.maximum_fxb_AMM_sellable_above_floor.call(),
		).div(BIG18);
		...
		const expected_values_CALL_16 = await bondIssuerInstance.buyFXBfromAMM.call(buying_amount_16, 1, {
			from: FRAX_UTILITY_CONTRACTOR,
		});
		...
		const maximum_fxb_AMM_sellable_above_floor_16 = new BigNumber(
			await bondIssuerInstance.maximum_fxb_AMM_sellable_above_floor.call(),
		).div(BIG18);
		...
		const expected_values_CALL_17 = await bondIssuerInstance.sellFXBintoAMM.call(selling_amount_17, 0, {
			from: FRAX_UTILITY_CONTRACTOR,
		});
		...
		const maximum_fxb_AMM_sellable_above_floor_17 = new BigNumber(
			await bondIssuerInstance.maximum_fxb_AMM_sellable_above_floor.call(),
		).div(BIG18);
		...
		const expected_values_CALL_18 = await bondIssuerInstance.sellFXBintoAMM.call(selling_amount_18, 0, {
			from: FRAX_UTILITY_CONTRACTOR,
		});
		...
		const maximum_fxb_AMM_sellable_above_floor_18 = new BigNumber(
			await bondIssuerInstance.maximum_fxb_AMM_sellable_above_floor.call(),
		).div(BIG18);
		...
		const expected_values_CALL_19 = await bondIssuerInstance.buyFXBfromAMM.call(buying_amount_19, 1, {
			from: FRAX_UTILITY_CONTRACTOR,
		});
		...
		const maximum_fxb_AMM_sellable_above_floor_19 = new BigNumber(
			await bondIssuerInstance.maximum_fxb_AMM_sellable_above_floor.call(),
		).div(BIG18);
		...
		const expected_values_CALL_20 = await bondIssuerInstance.buyFXBfromAMM.call(buying_amount_20, 1, {
			from: FRAX_UTILITY_CONTRACTOR,
		});
		...
		const maximum_fxb_AMM_sellable_above_floor_20 = new BigNumber(
			await bondIssuerInstance.maximum_fxb_AMM_sellable_above_floor.call(),
		).div(BIG18);
		...
		await bondIssuerInstance.rebalance_AMM_liquidity_to_price(floor_price_21.multipliedBy(BIG6), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		const amm_spot_price_21 = new BigNumber(await bondIssuerInstance.amm_spot_price.call()).div(BIG6);

		const maximum_fxb_AMM_sellable_above_floor_21 = new BigNumber(
			await bondIssuerInstance.maximum_fxb_AMM_sellable_above_floor.call(),
		).div(BIG18);
		...
		const maximum_fxb_AMM_sellable_above_floor_22 = new BigNumber(
			await bondIssuerInstance.maximum_fxb_AMM_sellable_above_floor.call(),
		).div(BIG18);
		...
		await bondIssuerInstance.setIssuableFXB(new_issue_amount_23, new_issue_price_23, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		const maximum_fxb_AMM_sellable_above_floor_24 = new BigNumber(
			await bondIssuerInstance.maximum_fxb_AMM_sellable_above_floor.call(),
		).div(BIG18);
		...
		const expected_values_CALL_24aa = await bondIssuerInstance.buyFXBfromAMM.call(buying_amount_24aa, 1, {
			from: FRAX_UTILITY_CONTRACTOR,
		});
		...
		const maximum_fxb_AMM_sellable_above_floor_24aa = new BigNumber(
			await bondIssuerInstance.maximum_fxb_AMM_sellable_above_floor.call(),
		).div(BIG18);
		...
		const expected_values_CALL_24ab = await bondIssuerInstance.buyFXBfromAMM.call(buying_amount_24ab, 1, {
			from: FRAX_UTILITY_CONTRACTOR,
		});
		...
		const maximum_fxb_AMM_sellable_above_floor_24ab = new BigNumber(
			await bondIssuerInstance.maximum_fxb_AMM_sellable_above_floor.call(),
		).div(BIG18);
		...
		const expected_values_CALL_24ac = await bondIssuerInstance.buyUnissuedFXB.call(buying_amount_24ac, 1, {
			from: FRAX_UTILITY_CONTRACTOR,
		});
		...
		const maximum_fxb_AMM_sellable_above_floor_24ac = new BigNumber(
			await bondIssuerInstance.maximum_fxb_AMM_sellable_above_floor.call(),
		).div(BIG18);
		...
		await bondIssuerInstance.setIssuableFXB(new_issue_amount_23aaaa, new_issue_price_23aaaa, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		const expected_values_CALL_27 = await bondIssuerInstance.buyFXBfromAMM.call(buying_amount_27, 1, {
			from: FRAX_UTILITY_CONTRACTOR,
		});
		...
		const maximum_fxb_AMM_sellable_above_floor_27 = new BigNumber(
			await bondIssuerInstance.maximum_fxb_AMM_sellable_above_floor.call(),
		).div(BIG18);
		...
		const expected_values_CALL_28 = await bondIssuerInstance.buyUnissuedFXB.call(buying_amount_28, 1, {
			from: FRAX_UTILITY_CONTRACTOR,
		});
		...
		const maximum_fxb_AMM_sellable_above_floor_28 = new BigNumber(
			await bondIssuerInstance.maximum_fxb_AMM_sellable_above_floor.call(),
		).div(BIG18);
		...
		await bondIssuerInstance.setTargetLiquidity(new BigNumber('2500e18'), true, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		const expected_values_CALL_30 = await bondIssuerInstance.buyFXBfromAMM.call(buying_amount_30, 1, {
			from: FRAX_UTILITY_CONTRACTOR,
		});
		...
		const maximum_fxb_AMM_sellable_above_floor_30 = new BigNumber(
			await bondIssuerInstance.maximum_fxb_AMM_sellable_above_floor.call(),
		).div(BIG18);
