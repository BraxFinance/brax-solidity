...
contract('FraxCrossChainLiquidityTracker-Tests', async (accounts) => {
	...
	it('Main test', async () => {
		...
		console.log(
			'Tracker collatDollarBalance:',
			new BigNumber((await frax_cc_liq_tracker_instance.dollarBalances.call())[1]).div(BIG18).toNumber(),
		);
		console.log(
		...
		await frax_cc_liq_tracker_instance.noteFraxMint(43114, new BigNumber('100000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Note a Fantom mint');
		await frax_cc_liq_tracker_instance.noteFraxMint(250, new BigNumber('25000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			'Tracker FRAX value:',
			new BigNumber((await frax_cc_liq_tracker_instance.dollarBalances.call())[0]).div(BIG18).toNumber(),
		);
		console.log(
			'Tracker collatDollarBalance:',
			new BigNumber((await frax_cc_liq_tracker_instance.dollarBalances.call())[1]).div(BIG18).toNumber(),
		...
		await frax_cc_liq_tracker_instance.noteFraxRetirement(43114, new BigNumber('1000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Note a Fantom retirement');
		await frax_cc_liq_tracker_instance.noteFraxRetirement(250, new BigNumber('1000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			'AMO Profit:',
			new BigNumber(await frax_amo_minter_instance.fraxTrackedAMO.call(frax_cc_liq_tracker_instance.address))
				.div(BIG18)
				.toNumber(),
		);
		console.log(
