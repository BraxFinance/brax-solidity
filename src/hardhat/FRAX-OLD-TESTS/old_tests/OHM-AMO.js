...
contract('OHM AMO Tests', async (accounts) => {
	...
	it('Main test', async () => {
		...
		await frax_amo_minter_instance.mintFraxForAMO(ohm_amo_instance.address, new BigNumber('20250e18'), {
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================GET SOME OHM (SWAP FRAX FOR OHM)==========================='),
		);
		...
		const frax_balance_bonding_before = new BigNumber(
			await frax_instance.balanceOf.call(ohm_amo_instance.address),
		).div(BIG18);
		...
		const frax_balance_bonding_after = new BigNumber(
			await frax_instance.balanceOf.call(ohm_amo_instance.address),
		).div(BIG18);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================WAIT 5 DAYS FOR THE BOND TO MATURE==========================='),
		);
		...
		console.log(
			chalk.hex('#ff8b3d').bold('=====================STAKE OHM (WITH HELPER) FOR sOHM====================='),
		);
		// Stake OHM for sOHM
		...
		console.log(
			chalk.hex('#ff8b3d').bold('=====================STAKE OHM (NO HELPER) FOR sOHM====================='),
		);
		// Stake OHM for sOHM
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================WAIT 5 DAYS TO MATURE THE STAKE==========================='),
		);
		...
		await expectRevert.unspecified(
			ohm_amo_instance.stakeOHM_WithHelper(new BigNumber('1e9'), { from: COLLATERAL_FRAX_AND_FXS_OWNER }),
		);
		...
		console.log(
			chalk.hex('#ff8b3d').bold('===========================SELL OHM FOR FRAX==========================='),
		);
		// Get the OHM balance
		...
		console.log(
			'AMO Profit:',
			new BigNumber(await frax_amo_minter_instance.fraxTrackedAMO.call(ohm_amo_instance.address))
				.div(BIG18)
				.toNumber(),
		);
		console.log(
