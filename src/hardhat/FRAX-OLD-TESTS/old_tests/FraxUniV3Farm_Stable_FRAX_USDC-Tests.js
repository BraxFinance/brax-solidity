...
contract('FraxUniV3Farm_Stable_FRAX_USDC-Tests', async (accounts) => {
	...
	it('Initialize FraxGaugeController', async () => {
		...
		await frax_gauge_controller.add_gauge(fraxFarmInstance_FRAX_USDC.address, 0, 1000, {
			from: ORIGINAL_FRAX_ONE_ADDRESS,
		});

		// Add the FRAX-WETH contract as a gauge (to take up weight)
		await frax_gauge_controller.add_gauge(stakingInstance_FRAX_WETH.address, 0, 1000, {
			from: ORIGINAL_FRAX_ONE_ADDRESS,
		});
		...
		await frax_gauge_controller.vote_for_gauge_weights(fraxFarmInstance_FRAX_USDC.address, 9000, {
			from: ADDRESS_WITH_UNI_V3_NFT_9,
		});

		// Vote for the FRAX-WETH farm
		// 10000 = 100% of your weight. 1 = 0.01% of your weight
		await frax_gauge_controller.vote_for_gauge_weights(stakingInstance_FRAX_WETH.address, 1000, {
			from: ADDRESS_WITH_UNI_V3_NFT_9,
		});
		...
		const FRAX_USDC_relative_weight = new BigNumber(
			await frax_gauge_controller.gauge_relative_weight.call(fraxFarmInstance_FRAX_USDC.address),
		)
			.div(BIG18)
			.toNumber();
		const FRAX_WETH_relative_weight = new BigNumber(
			await frax_gauge_controller.gauge_relative_weight.call(stakingInstance_FRAX_WETH.address),
		)
			.div(BIG18)
			.toNumber();
		...
		// Print out the gauge relative weights
		const FRAX_USDC_relative_weight_0 = new BigNumber(
			await frax_gauge_controller.gauge_relative_weight.call(fraxFarmInstance_FRAX_USDC.address),
		)
			.div(BIG18)
			.toNumber();
		const FRAX_WETH_relative_weight_0 = new BigNumber(
			await frax_gauge_controller.gauge_relative_weight.call(stakingInstance_FRAX_WETH.address),
		)
			.div(BIG18)
			.toNumber();
	...
	it('Initialization related', async () => {
		...
		await fxs_instance.transfer(fraxFarmInstance_FRAX_USDC.address, new BigNumber('1000000e18'), {
			from: ADDRESS_WITH_FXS,
		});
		await fxs_instance.transfer(COLLATERAL_FRAX_AND_FXS_OWNER, new BigNumber('25000e18'), {
			from: ADDRESS_WITH_FXS,
		});
	...
	it('Locked stakes - WITH EMISSION FACTOR', async () => {
		...
		await veFXS_instance.create_lock(deposit_amount_1_e18, veFXS_deposit_end_timestamp, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		// Print the emission factor
		const emission_factor_week_0 = new BigNumber(await fraxFarmInstance_FRAX_USDC.emissionFactor.call())
			.div(BIG18)
			.toNumber();
		...
		// account[1]
		await uniswapV3PositionsNFTInstance.approve(fraxFarmInstance_FRAX_USDC.address, TOKEN_ID_1, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await uniswapV3PositionsNFTInstance.approve(fraxFarmInstance_FRAX_USDC.address, TOKEN_ID_1_ALT_GOOD, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		// account[9]
		await uniswapV3PositionsNFTInstance.approve(fraxFarmInstance_FRAX_USDC.address, TOKEN_ID_9, {
			from: accounts[9],
		});
		...
		await fraxFarmInstance_FRAX_USDC.stakeLocked(TOKEN_ID_1_ALT_GOOD, 548 * 86400, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		}); // 548 days
		...
		const regular_balance_1 = new BigNumber(
			await fraxFarmInstance_FRAX_USDC.lockedLiquidityOf.call(COLLATERAL_FRAX_AND_FXS_OWNER),
		).div(BIG18);
		const combined_weight_1 = new BigNumber(
			await fraxFarmInstance_FRAX_USDC.combinedWeightOf.call(COLLATERAL_FRAX_AND_FXS_OWNER),
		).div(BIG18);
		const regular_balance_9 = new BigNumber(
			await fraxFarmInstance_FRAX_USDC.lockedLiquidityOf.call(accounts[9]),
		).div(BIG18);
		const combined_weight_9 = new BigNumber(
			await fraxFarmInstance_FRAX_USDC.combinedWeightOf.call(accounts[9]),
		).div(BIG18);
		...
		// Print the emission factor
		const emission_factor_week_1 = new BigNumber(await fraxFarmInstance_FRAX_USDC.emissionFactor.call())
			.div(BIG18)
			.toNumber();
		...
		console.log(
			'Expected yearly reward (with emission factor) [FXS]: ',
			duration_reward_1_fxs.multipliedBy(52.1429).multipliedBy(emission_factor_week_1).toString(),
		);
		...
		const user_staked_frax_1 = new BigNumber(
			await fraxFarmInstance_FRAX_USDC.userStakedFrax(COLLATERAL_FRAX_AND_FXS_OWNER, {
				from: COLLATERAL_FRAX_AND_FXS_OWNER,
			}),
		)
			.div(BIG18)
			.toNumber();
		const user_staked_frax_9 = new BigNumber(
			await fraxFarmInstance_FRAX_USDC.userStakedFrax(accounts[9], { from: COLLATERAL_FRAX_AND_FXS_OWNER }),
		)
			.div(BIG18)
			.toNumber();
		...
		// Print the emission factor
		const emission_factor_week_5 = new BigNumber(await fraxFarmInstance_FRAX_USDC.emissionFactor.call())
			.div(BIG18)
			.toNumber();
		...
		console.log(
			'Expected yearly reward (with emission factor) [FXS]: ',
			duration_reward_3_fxs.multipliedBy(52.1429).multipliedBy(emission_factor_week_5).toString(),
		);
		...
		await expectRevert.unspecified(
			fraxFarmInstance_FRAX_USDC.withdrawLocked(TOKEN_ID_1_ALT_GOOD, { from: COLLATERAL_FRAX_AND_FXS_OWNER }),
		);
		...
		await utilities.printCalcCurCombinedWeight(fraxFarmInstance_FRAX_USDC, COLLATERAL_FRAX_AND_FXS_OWNER);
		await utilities.printCalcCurCombinedWeight(fraxFarmInstance_FRAX_USDC, accounts[9]);
		const _total_liquidity_staked_0 = new BigNumber(
			await fraxFarmInstance_FRAX_USDC.totalLiquidityLocked.call(),
		).div(BIG18);
		const _total_combined_weight_0 = new BigNumber(await fraxFarmInstance_FRAX_USDC.totalCombinedWeight.call()).div(
			BIG18,
		);
		...
		// Show the stake structs
		const locked_NFT_structs_post_unlock_1 = await fraxFarmInstance_FRAX_USDC.lockedNFTsOf.call(
		...
		await utilities.printCalcCurCombinedWeight(fraxFarmInstance_FRAX_USDC, COLLATERAL_FRAX_AND_FXS_OWNER);
		await utilities.printCalcCurCombinedWeight(fraxFarmInstance_FRAX_USDC, accounts[9]);
		const _total_liquidity_staked_1 = new BigNumber(
			await fraxFarmInstance_FRAX_USDC.totalLiquidityLocked.call(),
		).div(BIG18);
		const _total_combined_weight_1 = new BigNumber(await fraxFarmInstance_FRAX_USDC.totalCombinedWeight.call()).div(
			BIG18,
		);
	...
	it('Migration Staking / Withdrawal Tests', async () => {
		...
		console.log(
			...
			new BigNumber(await fraxFarmInstance_FRAX_USDC.lockedLiquidityOf(COLLATERAL_FRAX_AND_FXS_OWNER))
				.div(BIG18)
				.toNumber(),
		);
		...
		console.log(
			...
			new BigNumber(await fraxFarmInstance_FRAX_USDC.combinedWeightOf(COLLATERAL_FRAX_AND_FXS_OWNER))
				.div(BIG18)
				.toNumber(),
		);
		...
		await utilities.printCalcCurCombinedWeight(fraxFarmInstance_FRAX_USDC, COLLATERAL_FRAX_AND_FXS_OWNER);
		await utilities.printCalcCurCombinedWeight(fraxFarmInstance_FRAX_USDC, accounts[9]);
		const _total_liquidity_staked_2 = new BigNumber(
			await fraxFarmInstance_FRAX_USDC.totalLiquidityLocked.call(),
		).div(BIG18);
		const _total_combined_weight_2 = new BigNumber(await fraxFarmInstance_FRAX_USDC.totalCombinedWeight.call()).div(
			BIG18,
		);
		...
		await fraxFarmInstance_FRAX_USDC.migrator_withdraw_locked(COLLATERAL_FRAX_AND_FXS_OWNER, TOKEN_ID_1, {
			from: MIGRATOR_ADDRESS,
		});
		console.log(
			'Migrator (accounts[10]) lockedLiquidityOf:',
			new BigNumber(await fraxFarmInstance_FRAX_USDC.lockedLiquidityOf(MIGRATOR_ADDRESS)).div(BIG18).toNumber(),
		);
		console.log(
			'accounts[1] lockedLiquidityOf:',
			new BigNumber(await fraxFarmInstance_FRAX_USDC.lockedLiquidityOf(COLLATERAL_FRAX_AND_FXS_OWNER))
				.div(BIG18)
				.toNumber(),
		);
		console.log(
			'accounts[1] combinedWeightOf:',
			new BigNumber(await fraxFarmInstance_FRAX_USDC.combinedWeightOf(COLLATERAL_FRAX_AND_FXS_OWNER))
				.div(BIG18)
				.toNumber(),
		);
		...
		await fraxFarmInstance_FRAX_USDC.migrator_stakeLocked_for(
			COLLATERAL_FRAX_AND_FXS_OWNER,
			TOKEN_ID_1,
			28 * 86400,
	...
	it('Fail Tests ', async () => {
		...
		await uniswapV3PositionsNFTInstance.approve(
			fraxFarmInstance_FRAX_USDC.address,
			TOKEN_ID_9_INVALID_WRONG_TICKS,
			{ from: accounts[9] },
		);
		await expectRevert(
		...
		await uniswapV3PositionsNFTInstance.approve(fraxFarmInstance_FRAX_USDC.address, TOKEN_ID_9_INSIDE_WRONG_TICKS, {
			from: accounts[9],
		});
		await expectRevert(
		...
		await expectRevert(
			fraxFarmInstance_FRAX_USDC.stakeLocked(TOKEN_ID_9_INVALID_WRONG_UNDERLYING_TOKENS, 28 * 86400, {
				from: accounts[9],
			}),
			'Wrong token characteristics',
		);
		...
		await uniswapV3PositionsNFTInstance.approve(fraxFarmInstance_FRAX_USDC.address, TOKEN_ID_9_INVALID_WRONG_FEE, {
			from: accounts[9],
		});
		await expectRevert(
		...
		await expectRevert(
			fraxFarmInstance_FRAX_USDC.migrator_withdraw_locked(COLLATERAL_FRAX_AND_FXS_OWNER, TOKEN_ID_1, {
				from: MIGRATOR_ADDRESS,
			}),
			'Not in migration',
		);
		...
		await expectRevert(
			fraxFarmInstance_FRAX_USDC.migrator_stakeLocked_for(
				COLLATERAL_FRAX_AND_FXS_OWNER,
				TOKEN_ID_1,
				28 * 86400,
		...
		await expectRevert(
			fraxFarmInstance_FRAX_USDC.stakerAllowMigrator(INVESTOR_CUSTODIAN_ADDRESS, {
				from: COLLATERAL_FRAX_AND_FXS_OWNER,
			}),
		...
		await expectRevert(
			fraxFarmInstance_FRAX_USDC.recoverERC20(uniswapV3PositionsNFTInstance.address, test_amount_1, {
				from: STAKING_OWNER,
			}),
			'Not in migration',
		);
		...
		await expectRevert(
			fraxFarmInstance_FRAX_USDC.recoverERC721(uniswapV3PositionsNFTInstance.address, TOKEN_ID_1, {
				from: STAKING_OWNER,
			}),
			'Not in migration',
		);
		...
		await fraxFarmInstance_FRAX_USDC.recoverERC721(uniswapV3PositionsNFTInstance.address, TOKEN_ID_1, {
			from: STAKING_OWNER,
		}),
			await uniswapV3PositionsNFTInstance.safeTransferFrom(
				STAKING_OWNER,
		...
		await fraxFarmInstance_FRAX_USDC.stakerDisallowMigrator(MIGRATOR_ADDRESS, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
