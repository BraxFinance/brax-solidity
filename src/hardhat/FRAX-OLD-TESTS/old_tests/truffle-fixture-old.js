...
const FraxMiddlemanGauge_ARBI_Curve_VSTFRAX = artifacts.require(
	'Curve/Middleman_Gauges/FraxMiddlemanGauge_ARBI_Curve_VSTFRAX',
);
...
module.exports = async (deployer) => {
	...
	priceConsumerInstance = await ChainlinkETHUSDPriceConsumer.at(
		CONTRACT_ADDRESSES.ethereum.pricing.chainlink_eth_usd,
	);
	priceConsumerInstance_FXS = await ChainlinkFXSUSDPriceConsumer.at(
		CONTRACT_ADDRESSES.ethereum.pricing.chainlink_fxs_usd,
	);
	...
	vefxs_boost_deleg_proxy_instance = await veFXSBoostDelegationProxy.at(
		CONTRACT_ADDRESSES.ethereum.main.veFXS_boost_delegation_proxy,
	);
	...
	FRAX3CRV_V2_Instance = await MetaImplementationUSD.at(
	...
	uniswapV3PositionsNFTInstance = await IUniswapV3PositionsNFT.at(
	...
	oracle_instance_FRAX_USDC = await UniswapPairOracle_FRAX_USDC.at(
		CONTRACT_ADDRESSES.ethereum.retired_oracles.FRAX_USDC,
	);
	oracle_instance_FXS_WETH = await UniswapPairOracle_FXS_WETH.at(
		CONTRACT_ADDRESSES.ethereum.retired_oracles.FXS_WETH,
	);
	oracle_instance_USDC_WETH = await UniswapPairOracle_USDC_WETH.at(
		CONTRACT_ADDRESSES.ethereum.retired_oracles.USDC_WETH,
	);
	...
	combo_oracle_instance_univ2_univ3 = await ComboOracle_UniV2_UniV3.at(
		CONTRACT_ADDRESSES.ethereum.oracles_other.combo_oracle_univ2_univ3,
	);
	...
	stakingInstanceDualV5_FRAX_OHM = await StakingRewardsDualV5_FRAX_OHM.at(
		CONTRACT_ADDRESSES.ethereum.staking_contracts['Uniswap FRAX/OHM'],
	);
	communalFarmInstance_Saddle_D4 = await CommunalFarm_SaddleD4.at(
		CONTRACT_ADDRESSES.ethereum.staking_contracts['Saddle alUSD/FEI/FRAX/LUSD'],
	);
	fraxUniV3Farm_Stable_FRAX_DAI = await FraxUniV3Farm_Stable_FRAX_DAI.at(
		CONTRACT_ADDRESSES.ethereum.staking_contracts['Uniswap V3 FRAX/DAI'],
	);
	fraxUniV3Farm_Stable_FRAX_USDC = await FraxUniV3Farm_Stable_FRAX_USDC.at(
		CONTRACT_ADDRESSES.ethereum.staking_contracts['Uniswap V3 FRAX/USDC'],
	);
	middlemanGauge_ARBI_Curve_VSTFRAX = await FraxMiddlemanGauge_ARBI_Curve_VSTFRAX.at(
		CONTRACT_ADDRESSES.ethereum.middleman_gauges['Curve VSTFRAX-f'],
	);
	middlemanGauge_FRAX_mUSD = await FraxMiddlemanGauge_FRAX_mUSD.at(
		CONTRACT_ADDRESSES.ethereum.middleman_gauges['mStable FRAX/mUSD'],
	);
	...
	stakingInstanceMultiGauge_FRAX_SUSHI = await StakingRewardsMultiGauge_FRAX_SUSHI.at(
		CONTRACT_ADDRESSES.ethereum.staking_contracts['Sushi FRAX/SUSHI'],
	);
	fraxUnifiedFarm_Gelato_FRAX_DAI_instance = await FraxUnifiedFarm_ERC20_Gelato_FRAX_DAI.at(
		CONTRACT_ADDRESSES.ethereum.staking_contracts['Gelato Uniswap FRAX/DAI'],
	);
	fraxUnifiedFarm_Vesper_FRAX_instance = await FraxUnifiedFarm_ERC20_Vesper_Orbit_FRAX.at(
		CONTRACT_ADDRESSES.ethereum.staking_contracts['Vesper Orbit FRAX'],
	);
	fraxUnifiedFarm_Temple_FRAX_TEMPLE_instance = await FraxUnifiedFarm_ERC20_Temple_FRAX_TEMPLE.at(
		CONTRACT_ADDRESSES.ethereum.staking_contracts['Temple FRAX/TEMPLE'],
	);
	...
	univ3_liquidity_amo_v2_instance = await UniV3LiquidityAMO_V2.at(
		CONTRACT_ADDRESSES.ethereum.misc.uniV3_liquidity_amo,
	);
	...
	frax_gauge_controller_v2 = await FraxGaugeControllerV2.at(
		CONTRACT_ADDRESSES.ethereum.misc.frax_gauge_controller_v2,
	);
	gauge_rewards_distributor_instance = await FraxGaugeFXSRewardsDistributor.at(
	...
	veFXSYieldDistributorV4_instance = await veFXSYieldDistributorV4.at(
	...
	await frax_amo_minter_instance.addAMO(frax_liquidity_bridger_aur_rainbow_instance.address, 0, {
