...
contract('MigratableFarmBSC_FRAX_FXS-Tests', async (accounts) => {
	...
	beforeEach(async () => {
		...
		pair_instance_Pancake_FRAX_FXS = await IPancakePair.at(
	...
	it('Initialization related', async () => {
		...
		await cakeInstance.transfer(migratableFarmBSC_FRAX_FXS_instance.address, new BigNumber('10000e18'), {
			from: ADDRESS_WITH_CAKE,
		});
		...
		await fxs_instance.transfer(migratableFarmBSC_FRAX_FXS_instance.address, new BigNumber('1000000e18'), {
		...
		await pair_instance_Pancake_FRAX_FXS.transfer(accounts[1], new BigNumber('250e18'), {
			from: ADDRESS_WITH_LP_TOKENS,
		});
		await pair_instance_Pancake_FRAX_FXS.transfer(accounts[9], new BigNumber('250e18'), {
			from: ADDRESS_WITH_LP_TOKENS,
		});
	...
	it('PART 1: Normal stakes at CR = 0', async () => {
		...
		await pair_instance_Pancake_FRAX_FXS.approve(
			migratableFarmBSC_FRAX_FXS_instance.address,
			token1_pool_tokens_1,
		...
		const uni_pool_1st_stake_1 = new BigNumber(
			await pair_instance_Pancake_FRAX_FXS.balanceOf.call(COLLATERAL_FRAX_AND_FXS_OWNER),
		).div(BIG18);
		const fxs_1st_stake_1 = new BigNumber(await fxs_instance.balanceOf.call(COLLATERAL_FRAX_AND_FXS_OWNER)).div(
			BIG18,
		);
		const token1_1st_stake_1 = new BigNumber(await cakeInstance.balanceOf.call(COLLATERAL_FRAX_AND_FXS_OWNER)).div(
			BIG18,
		);

		const rewards_balance_1st_stake_1_FXS = new BigNumber(
			await migratableFarmBSC_FRAX_FXS_instance.rewards0.call(COLLATERAL_FRAX_AND_FXS_OWNER),
		).div(BIG18);
		const rewards_balance_1st_stake_1_TOKEN1 = new BigNumber(
			await migratableFarmBSC_FRAX_FXS_instance.rewards1.call(COLLATERAL_FRAX_AND_FXS_OWNER),
		).div(BIG18);
		...
		console.log(
			...
			new BigNumber(await migratableFarmBSC_FRAX_FXS_instance.balanceOf(COLLATERAL_FRAX_AND_FXS_OWNER))
				.div(BIG18)
				.toNumber(),
		);
		console.log(
			'accounts[1] boostedBalanceOf:',
			new BigNumber(await migratableFarmBSC_FRAX_FXS_instance.boostedBalanceOf(COLLATERAL_FRAX_AND_FXS_OWNER))
				.div(BIG18)
				.toNumber(),
		);
		console.log('');
		...
		await pair_instance_Pancake_FRAX_FXS.approve(migratableFarmBSC_FRAX_FXS_instance.address, uni_pool_tokens_9, {
			from: accounts[9],
		});
		console.log('accounts[9] approve FRAX_FXS staking pool for 2.5 (E18) LP tokens');
		const uni_pool_1st_stake_9 = new BigNumber(
			await pair_instance_Pancake_FRAX_FXS.balanceOf.call(accounts[9]),
		).div(BIG18);
		...
		const rewards_balance_1st_stake_9_FXS = new BigNumber(
			await migratableFarmBSC_FRAX_FXS_instance.rewards0(accounts[9]),
		).div(BIG18);
		const rewards_balance_1st_stake_9_TOKEN1 = new BigNumber(
			await migratableFarmBSC_FRAX_FXS_instance.rewards1(accounts[9]),
		).div(BIG18);
		...
		console.log(
			...
			new BigNumber(await migratableFarmBSC_FRAX_FXS_instance.balanceOf(accounts[9])).div(BIG18).toNumber(),
		);
		console.log(
			'accounts[9] boostedBalanceOf:',
			new BigNumber(await migratableFarmBSC_FRAX_FXS_instance.boostedBalanceOf(accounts[9]))
				.div(BIG18)
				.toNumber(),
		);
		console.log('');
		...
		let rewards_contract_lastUpdateTime = new BigNumber(
			await migratableFarmBSC_FRAX_FXS_instance.lastUpdateTime.call(),
		);
		...
		let rewards_contract_periodFinish = new BigNumber(
			await migratableFarmBSC_FRAX_FXS_instance.periodFinish.call(),
		);
		...
		let rewards_contract_lastTimeRewardApplicable = new BigNumber(
			await migratableFarmBSC_FRAX_FXS_instance.lastTimeRewardApplicable.call(),
		);
		...
		const rewards_contract_stored_uni_pool = new BigNumber(
			await migratableFarmBSC_FRAX_FXS_instance.totalSupply.call(),
		).div(BIG18);
		...
		const token1_post_reward_1 = new BigNumber(
			await cakeInstance.balanceOf.call(COLLATERAL_FRAX_AND_FXS_OWNER),
		).div(BIG18);
		...
		const staking_ew_earned_1 = await migratableFarmBSC_FRAX_FXS_instance.earned.call(
		...
		await migratableFarmBSC_FRAX_FXS_instance.withdraw(token1_pool_tokens_1, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await time.advanceBlock();
		console.log('');
		...
		await migratableFarmBSC_FRAX_FXS_instance.setRewardRates(curr_token0_rate, new_token1_rate, false, {
			from: STAKING_OWNER,
		});
		...
		// Show the reward
		const staking_part2_earned_1 = await migratableFarmBSC_FRAX_FXS_instance.earned.call(
			COLLATERAL_FRAX_AND_FXS_OWNER,
		);
		...
		const uni_pool_2nd_time_balance_1 = new BigNumber(
			await pair_instance_Pancake_FRAX_FXS.balanceOf.call(COLLATERAL_FRAX_AND_FXS_OWNER),
		).div(BIG18);
		const fxs_2nd_time_balance_1 = new BigNumber(
			await fxs_instance.balanceOf.call(COLLATERAL_FRAX_AND_FXS_OWNER),
		).div(BIG18);

		const rewards_earned_2nd_time_1 = await migratableFarmBSC_FRAX_FXS_instance.earned.call(
			COLLATERAL_FRAX_AND_FXS_OWNER,
		);
		...
		const sum_reward_week_3_fxs = staking_part2_earned_1_fxs
			.plus(staking_part2_earned_9_fxs)
			.plus(staking_wk1_earned_1_fxs);
		const sum_reward_week_3_token1 = staking_part2_earned_1_token1
			.plus(staking_part2_earned_9_token1)
			.plus(staking_wk1_earned_1_token1);
		...
		console.log(
			'Effective weekly reward at week 3 [may be lower if delayed] [CAKE]:',
			sum_reward_week_3_token1.div(2).toString(),
		); // Total over 3 weeks
		console.log('Effective yearly reward at week 3 [FXS]:', effective_yearly_reward_at_week_3_fxs.toString());
		console.log(
			'Effective yearly reward at week 3 [may be lower if delayed] [CAKE]:',
			effective_yearly_reward_at_week_3_token1.toString(),
		);
		...
		console.log(
			'accounts[9] CAKE balance change:',
			acc_9_TOKEN1_balance_after.minus(token1_1st_stake_9).toNumber(),
		);
	});
	...
	it('blocks a greylisted address which tries to stake; SHOULD FAIL', async () => {
		...
		await expectRevert.unspecified(
			migratableFarmBSC_FRAX_FXS_instance.stake(new BigNumber('1e18'), { from: accounts[9] }),
		);
	});
	...
	it('PART 2: Locked stakes', async () => {
		...
		await pair_instance_Pancake_FRAX_FXS.approve(migratableFarmBSC_FRAX_FXS_instance.address, uni_pool_normal_1, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await pair_instance_Pancake_FRAX_FXS.approve(migratableFarmBSC_FRAX_FXS_instance.address, uni_pool_normal_9, {
			from: accounts[9],
		});
		...
		await pair_instance_Pancake_FRAX_FXS.approve(migratableFarmBSC_FRAX_FXS_instance.address, uni_pool_locked_9, {
			from: accounts[9],
		});
		...
		// Stake Locked
		// account[1]
		await migratableFarmBSC_FRAX_FXS_instance.stakeLocked(uni_pool_locked_1, 7 * 86400, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		}); // 15 days
		await migratableFarmBSC_FRAX_FXS_instance.stakeLocked(new BigNumber('25e17'), 548 * 86400, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		}); // 270 days
		...
		const locked_stake_structs_1 = await migratableFarmBSC_FRAX_FXS_instance.lockedStakesOf.call(
			COLLATERAL_FRAX_AND_FXS_OWNER,
		);
		...
		const regular_balance_1 = new BigNumber(
			await migratableFarmBSC_FRAX_FXS_instance.balanceOf.call(COLLATERAL_FRAX_AND_FXS_OWNER),
		).div(BIG18);
		const boosted_balance_1 = new BigNumber(
			await migratableFarmBSC_FRAX_FXS_instance.boostedBalanceOf.call(COLLATERAL_FRAX_AND_FXS_OWNER),
		).div(BIG18);
		const unlocked_balance_1 = new BigNumber(
			await migratableFarmBSC_FRAX_FXS_instance.unlockedBalanceOf.call(COLLATERAL_FRAX_AND_FXS_OWNER),
		).div(BIG18);
		const locked_balance_1 = new BigNumber(
			await migratableFarmBSC_FRAX_FXS_instance.lockedBalanceOf.call(COLLATERAL_FRAX_AND_FXS_OWNER),
		).div(BIG18);
		const regular_balance_9 = new BigNumber(
			await migratableFarmBSC_FRAX_FXS_instance.balanceOf.call(accounts[9]),
		).div(BIG18);
		const boosted_balance_9 = new BigNumber(
			await migratableFarmBSC_FRAX_FXS_instance.boostedBalanceOf.call(accounts[9]),
		).div(BIG18);
		const unlocked_balance_9 = new BigNumber(
			await migratableFarmBSC_FRAX_FXS_instance.unlockedBalanceOf.call(accounts[9]),
		).div(BIG18);
		const locked_balance_9 = new BigNumber(
			await migratableFarmBSC_FRAX_FXS_instance.lockedBalanceOf.call(accounts[9]),
		).div(BIG18);
		...
		await expectRevert.unspecified(
			migratableFarmBSC_FRAX_FXS_instance.withdrawLocked(locked_stake_structs_1[0].kek_id, {
				from: COLLATERAL_FRAX_AND_FXS_OWNER,
			}),
		);
		await expectRevert.unspecified(
			migratableFarmBSC_FRAX_FXS_instance.withdrawLocked(locked_stake_structs_9[0].kek_id, { from: accounts[9] }),
		);
		await time.advanceBlock();
		...
		await migratableFarmBSC_FRAX_FXS_instance.withdrawLocked(locked_stake_structs_1[0].kek_id, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await expectRevert.unspecified(
			migratableFarmBSC_FRAX_FXS_instance.withdrawLocked(locked_stake_structs_9[0].kek_id, { from: accounts[9] }),
		...
		await migratableFarmBSC_FRAX_FXS_instance.setRewardRates(curr_token0_rate_again, new_token1_rate_again, false, {
			from: STAKING_OWNER,
		});
		...
		await migratableFarmBSC_FRAX_FXS_instance.withdrawLocked(locked_stake_structs_9[0].kek_id, {
			from: accounts[9],
		});
		await migratableFarmBSC_FRAX_FXS_instance.getReward({ from: accounts[9] });
		await expectRevert.unspecified(
			migratableFarmBSC_FRAX_FXS_instance.withdrawLocked(locked_stake_structs_1[1].kek_id, {
				from: COLLATERAL_FRAX_AND_FXS_OWNER,
			}),
		);
		...
		await migratableFarmBSC_FRAX_FXS_instance.withdrawLocked(locked_stake_structs_1[1].kek_id, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
	...
	it('Migration Staking / Withdrawal Tests', async () => {
		...
		await migratableFarmBSC_FRAX_FXS_instance.stakerAllowMigrator(MIGRATOR_ADDRESS, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		// Print the balance
		console.log(
			'accounts[1] ERC20 balanceOf LP token:',
			new BigNumber(await pair_instance_Pancake_FRAX_FXS.balanceOf(COLLATERAL_FRAX_AND_FXS_OWNER))
				.div(BIG18)
				.toNumber(),
		);

		// Stake Normal
		await pair_instance_Pancake_FRAX_FXS.approve(migratableFarmBSC_FRAX_FXS_instance.address, stake_amt_unlocked, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await migratableFarmBSC_FRAX_FXS_instance.stake(stake_amt_unlocked, { from: COLLATERAL_FRAX_AND_FXS_OWNER });

		// Stake Locked
		await pair_instance_Pancake_FRAX_FXS.approve(migratableFarmBSC_FRAX_FXS_instance.address, stake_amt_locked, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await migratableFarmBSC_FRAX_FXS_instance.stakeLocked(stake_amt_locked, 7 * 86400, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		// Show the stake structs
		const locked_stake_structs = await migratableFarmBSC_FRAX_FXS_instance.lockedStakesOf.call(
			COLLATERAL_FRAX_AND_FXS_OWNER,
		);
		...
		console.log(
			'accounts[1] staked balanceOf <BEFORE>:',
			new BigNumber(await migratableFarmBSC_FRAX_FXS_instance.balanceOf(COLLATERAL_FRAX_AND_FXS_OWNER))
				.div(BIG18)
				.toNumber(),
		);
		console.log(
			'accounts[1] staked boostedBalanceOf <BEFORE>:',
			new BigNumber(await migratableFarmBSC_FRAX_FXS_instance.boostedBalanceOf(COLLATERAL_FRAX_AND_FXS_OWNER))
				.div(BIG18)
				.toNumber(),
		);
		...
		await migratableFarmBSC_FRAX_FXS_instance.migrator_withdraw_unlocked(COLLATERAL_FRAX_AND_FXS_OWNER, {
			from: MIGRATOR_ADDRESS,
		});
		console.log(
			`Migrator (accounts[10]) withdrew ${withdraw_unlocked_amt.div(
				BIG18,
			)} (E18) unlocked LP tokens from accounts[1]`,
		);
		console.log(
			'Migrator (accounts[10]) ERC20 balanceOf LP token:',
			new BigNumber(await pair_instance_Pancake_FRAX_FXS.balanceOf(MIGRATOR_ADDRESS)).div(BIG18).toNumber(),
		);
		console.log(
			'accounts[1] staked balanceOf:',
			new BigNumber(await migratableFarmBSC_FRAX_FXS_instance.balanceOf(COLLATERAL_FRAX_AND_FXS_OWNER))
				.div(BIG18)
				.toNumber(),
		);
		console.log(
			'accounts[1] staked boostedBalanceOf:',
			new BigNumber(await migratableFarmBSC_FRAX_FXS_instance.boostedBalanceOf(COLLATERAL_FRAX_AND_FXS_OWNER))
				.div(BIG18)
				.toNumber(),
		);
		...
		await migratableFarmBSC_FRAX_FXS_instance.migrator_withdraw_locked(
			COLLATERAL_FRAX_AND_FXS_OWNER,
			locked_stake_structs[2].kek_id,
			{ from: MIGRATOR_ADDRESS },
		);
		console.log(
		...
		await pair_instance_Pancake_FRAX_FXS.approve(migratableFarmBSC_FRAX_FXS_instance.address, proxy_stake_amt, {
			from: MIGRATOR_ADDRESS,
		});
		await migratableFarmBSC_FRAX_FXS_instance.migrator_stake_for(COLLATERAL_FRAX_AND_FXS_OWNER, proxy_stake_amt, {
			from: MIGRATOR_ADDRESS,
		});
		...
		await migratableFarmBSC_FRAX_FXS_instance.migrator_stakeLocked_for(
			COLLATERAL_FRAX_AND_FXS_OWNER,
			proxy_stake_lock_amt,
			28 * 86400,
			{ from: MIGRATOR_ADDRESS },
	...
	it('Fail Tests ', async () => {
		...
		await expectRevert(
			migratableFarmBSC_FRAX_FXS_instance.migrator_withdraw_unlocked(COLLATERAL_FRAX_AND_FXS_OWNER, {
				from: MIGRATOR_ADDRESS,
			}),
			'Not in migration',
		);
		...
		await expectRevert(
			migratableFarmBSC_FRAX_FXS_instance.migrator_withdraw_locked(
				COLLATERAL_FRAX_AND_FXS_OWNER,
				locked_stake_structs[2].kek_id,
				{ from: MIGRATOR_ADDRESS },
			),
		...
		await expectRevert(
			migratableFarmBSC_FRAX_FXS_instance.migrator_stake_for(COLLATERAL_FRAX_AND_FXS_OWNER, test_amount_1, {
				from: MIGRATOR_ADDRESS,
			}),
			'Not in migration',
		);
		...
		await expectRevert(
			migratableFarmBSC_FRAX_FXS_instance.migrator_stakeLocked_for(
				COLLATERAL_FRAX_AND_FXS_OWNER,
				test_amount_1,
				28 * 86400,
				{ from: MIGRATOR_ADDRESS },
		...
		await expectRevert(
			migratableFarmBSC_FRAX_FXS_instance.stakerAllowMigrator(INVESTOR_CUSTODIAN_ADDRESS, {
				from: COLLATERAL_FRAX_AND_FXS_OWNER,
			}),
		...
		await expectRevert(
			migratableFarmBSC_FRAX_FXS_instance.recoverBEP20(pair_instance_Pancake_FRAX_FXS.address, test_amount_1, {
				from: STAKING_OWNER,
			}),
			'Not in migration',
		);
		...
		await pair_instance_Pancake_FRAX_FXS.approve(migratableFarmBSC_FRAX_FXS_instance.address, test_amount_1, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await expectRevert(
		...
		await expectRevert(
			migratableFarmBSC_FRAX_FXS_instance.stakeLocked(test_amount_1, 28 * 86400, {
				from: COLLATERAL_FRAX_AND_FXS_OWNER,
			}),
			'Staking paused or in migration',
		);
		...
		await migratableFarmBSC_FRAX_FXS_instance.stakerDisallowMigrator(MIGRATOR_ADDRESS, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
