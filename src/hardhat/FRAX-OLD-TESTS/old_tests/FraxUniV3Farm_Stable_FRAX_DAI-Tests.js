...
contract('FraxUniV3Farm_Stable_FRAX_DAI-Tests', async (accounts) => {
	...
	it('Initialize FraxGaugeController', async () => {
		...
		const FRAX_DAI_relative_weight = new BigNumber(
			await frax_gauge_controller.gauge_relative_weight.call(fraxFarmInstance_FRAX_DAI.address),
		)
			.div(BIG18)
			.toNumber();
		...
		await frax_gauge_controller.gauge_relative_weight_write(
			fraxFarmInstance_FRAX_DAI.address,
			current_timestamp_0,
			{ from: accounts[9] },
		);
	...
	it('Initialization related', async () => {
		...
		await fxs_instance.transfer(fraxFarmInstance_FRAX_DAI.address, new BigNumber('1000000e18'), {
		...
		await fraxFarmInstance_FRAX_DAI.nominateNewOwner(STAKING_OWNER, {
			from: '0xfF5B4BCbf765FE363269114e1c765229a29eDeFD',
		});
	...
	it('Locked stakes - WITH EMISSION FACTOR', async () => {
		...
		const emission_factor_week_0 = new BigNumber(await fraxFarmInstance_FRAX_DAI.emissionFactor.call())
			.div(BIG18)
			.toNumber();
		...
		// account[1]
		await uniswapV3PositionsNFTInstance.approve(fraxFarmInstance_FRAX_DAI.address, TOKEN_ID_1, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await uniswapV3PositionsNFTInstance.approve(fraxFarmInstance_FRAX_DAI.address, TOKEN_ID_1_ALT_GOOD, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		// account[9]
		await uniswapV3PositionsNFTInstance.approve(fraxFarmInstance_FRAX_DAI.address, TOKEN_ID_9, {
			from: accounts[9],
		});
		...
		await fraxFarmInstance_FRAX_DAI.stakeLocked(TOKEN_ID_1_ALT_GOOD, 548 * 86400, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		}); // 548 days
		...
		const regular_balance_1 = new BigNumber(
			await fraxFarmInstance_FRAX_DAI.lockedLiquidityOf.call(COLLATERAL_FRAX_AND_FXS_OWNER),
		).div(BIG18);
		const combined_weight_1 = new BigNumber(
			await fraxFarmInstance_FRAX_DAI.combinedWeightOf.call(COLLATERAL_FRAX_AND_FXS_OWNER),
		).div(BIG18);
		const regular_balance_9 = new BigNumber(
			await fraxFarmInstance_FRAX_DAI.lockedLiquidityOf.call(accounts[9]),
		).div(BIG18);
		const combined_weight_9 = new BigNumber(await fraxFarmInstance_FRAX_DAI.combinedWeightOf.call(accounts[9])).div(
			BIG18,
		);
		...
		const user_staked_frax_1_0 = new BigNumber(
			await fraxFarmInstance_FRAX_DAI.userStakedFrax(COLLATERAL_FRAX_AND_FXS_OWNER, {
				from: COLLATERAL_FRAX_AND_FXS_OWNER,
			}),
		)
			.div(BIG18)
			.toNumber();
		const user_staked_frax_9_0 = new BigNumber(
			await fraxFarmInstance_FRAX_DAI.userStakedFrax(accounts[9], { from: COLLATERAL_FRAX_AND_FXS_OWNER }),
		)
			.div(BIG18)
			.toNumber();
		...
		// Print the emission factor
		const emission_factor_week_1 = new BigNumber(await fraxFarmInstance_FRAX_DAI.emissionFactor.call())
			.div(BIG18)
			.toNumber();
		...
		// Print the emission factor
		const emission_factor_week_5 = new BigNumber(await fraxFarmInstance_FRAX_DAI.emissionFactor.call())
			.div(BIG18)
			.toNumber();
		...
		await expectRevert.unspecified(
			fraxFarmInstance_FRAX_DAI.withdrawLocked(TOKEN_ID_1_ALT_GOOD, { from: COLLATERAL_FRAX_AND_FXS_OWNER }),
		);
		...
		const _total_liquidity_staked_0 = new BigNumber(
			await fraxFarmInstance_FRAX_DAI.totalLiquidityLocked.call(),
		).div(BIG18);
		const _total_combined_weight_0 = new BigNumber(await fraxFarmInstance_FRAX_DAI.totalCombinedWeight.call()).div(
			BIG18,
		);
		...
		// Show the stake structs
		const locked_NFT_structs_post_unlock_1 = await fraxFarmInstance_FRAX_DAI.lockedNFTsOf.call(
		...
		const _total_combined_weight_1 = new BigNumber(await fraxFarmInstance_FRAX_DAI.totalCombinedWeight.call()).div(
			BIG18,
		);
	...
	it('Migration Staking / Withdrawal Tests', async () => {
		...
		console.log(
			...
			new BigNumber(await fraxFarmInstance_FRAX_DAI.lockedLiquidityOf(COLLATERAL_FRAX_AND_FXS_OWNER))
				.div(BIG18)
				.toNumber(),
		);
		...
		console.log(
			...
			new BigNumber(await fraxFarmInstance_FRAX_DAI.combinedWeightOf(COLLATERAL_FRAX_AND_FXS_OWNER))
				.div(BIG18)
				.toNumber(),
		);
		...
		const _total_combined_weight_2 = new BigNumber(await fraxFarmInstance_FRAX_DAI.totalCombinedWeight.call()).div(
			BIG18,
		);
		...
		await fraxFarmInstance_FRAX_DAI.migrator_withdraw_locked(COLLATERAL_FRAX_AND_FXS_OWNER, TOKEN_ID_1, {
			from: MIGRATOR_ADDRESS,
		});
		console.log(
			'Migrator (accounts[10]) lockedLiquidityOf:',
			new BigNumber(await fraxFarmInstance_FRAX_DAI.lockedLiquidityOf(MIGRATOR_ADDRESS)).div(BIG18).toNumber(),
		);
		console.log(
		...
		await fraxFarmInstance_FRAX_DAI.migrator_stakeLocked_for(
			COLLATERAL_FRAX_AND_FXS_OWNER,
			TOKEN_ID_1,
			28 * 86400,
	...
	it('Fail Tests ', async () => {
		...
		await uniswapV3PositionsNFTInstance.approve(fraxFarmInstance_FRAX_DAI.address, TOKEN_ID_9_INVALID_WRONG_TICKS, {
			from: accounts[9],
		});
		await expectRevert(
		...
		await uniswapV3PositionsNFTInstance.approve(fraxFarmInstance_FRAX_DAI.address, TOKEN_ID_9_INSIDE_WRONG_TICKS, {
			from: accounts[9],
		});
		await expectRevert(
		...
		await expectRevert(
			fraxFarmInstance_FRAX_DAI.stakeLocked(TOKEN_ID_9_INVALID_WRONG_UNDERLYING_TOKENS, 28 * 86400, {
				from: accounts[9],
			}),
			'Wrong token characteristics',
		);
		...
		await uniswapV3PositionsNFTInstance.approve(fraxFarmInstance_FRAX_DAI.address, TOKEN_ID_9_INVALID_WRONG_FEE, {
			from: accounts[9],
		});
		await expectRevert(
		...
		await expectRevert(
			fraxFarmInstance_FRAX_DAI.migrator_withdraw_locked(COLLATERAL_FRAX_AND_FXS_OWNER, TOKEN_ID_1, {
				from: MIGRATOR_ADDRESS,
			}),
			'Not in migration',
		);
		...
		await expectRevert(
			fraxFarmInstance_FRAX_DAI.migrator_stakeLocked_for(
				COLLATERAL_FRAX_AND_FXS_OWNER,
				TOKEN_ID_1,
				28 * 86400,
		...
		await expectRevert(
			fraxFarmInstance_FRAX_DAI.stakerAllowMigrator(INVESTOR_CUSTODIAN_ADDRESS, {
				from: COLLATERAL_FRAX_AND_FXS_OWNER,
			}),
		...
		await expectRevert(
			fraxFarmInstance_FRAX_DAI.recoverERC721(uniswapV3PositionsNFTInstance.address, TOKEN_ID_1, {
				from: STAKING_OWNER,
			}),
			'Not in migration',
		);
		...
		await fraxFarmInstance_FRAX_DAI.recoverERC721(uniswapV3PositionsNFTInstance.address, TOKEN_ID_1, {
			from: STAKING_OWNER,
		}),
			await uniswapV3PositionsNFTInstance.safeTransferFrom(
				STAKING_OWNER,
		...
		await fraxFarmInstance_FRAX_DAI.stakerDisallowMigrator(MIGRATOR_ADDRESS, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
