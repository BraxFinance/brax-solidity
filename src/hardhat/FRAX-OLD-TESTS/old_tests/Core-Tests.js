...
contract('FRAX Core Tests', async (accounts) => {
	...
	beforeEach(async () => {
		...
		pair_addr_FRAX_WETH = await uniswapFactoryInstance.getPair(frax_instance.address, WETH.address, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		pair_addr_FRAX_USDC = await uniswapFactoryInstance.getPair(frax_instance.address, FakeCollateral_USDC.address, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		pair_addr_FRAX_USDT = await uniswapFactoryInstance.getPair(frax_instance.address, FakeCollateral_USDT.address, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		pair_addr_FXS_WETH = await uniswapFactoryInstance.getPair(fxs_instance.address, WETH.address, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		pair_addr_FXS_USDC = await uniswapFactoryInstance.getPair(fxs_instance.address, FakeCollateral_USDC.address, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		pair_addr_FXS_USDT = await uniswapFactoryInstance.getPair(fxs_instance.address, FakeCollateral_USDT.address, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		pair_addr_USDT_WETH = await uniswapFactoryInstance.getPair(FakeCollateral_USDT.address, WETH.address, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		pair_addr_USDC_WETH = await uniswapFactoryInstance.getPair(FakeCollateral_USDC.address, WETH.address, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
	...
	it('Check up on the oracles and make sure the prices are set', async () => {
		...
		let frax_price_from_FRAX_USDC = new BigNumber(
			await oracle_instance_FRAX_USDC.consult.call(frax_instance.address, new BigNumber('1e18')),
		).div(BIG6);
		let frax_price_from_FRAX_USDT = new BigNumber(
			await oracle_instance_FRAX_USDT.consult.call(frax_instance.address, new BigNumber('1e18')),
		).div(BIG6);
		...
		let fxs_price_from_FXS_USDC = new BigNumber(
			await oracle_instance_FXS_USDC.consult.call(fxs_instance.address, new BigNumber('1e18')),
		).div(BIG6);
		let fxs_price_from_FXS_USDT = new BigNumber(
			await oracle_instance_FXS_USDT.consult.call(fxs_instance.address, new BigNumber('1e18')),
		).div(BIG6);
		let USDT_price_from_USDT_WETH = new BigNumber(
			await oracle_instance_USDT_WETH.consult.call(WETH.address, new BigNumber('1e18')),
		).div(BIG6);
		let USDC_price_from_USDC_WETH = new BigNumber(
			await oracle_instance_USDC_WETH.consult.call(WETH.address, new BigNumber('1e18')),
		).div(BIG6);
		...
		await wethInstance.approve(routerInstance.address, new BigNumber(2000000e18), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await usdc_instance.approve(routerInstance.address, new BigNumber(2000000e18), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await col_instance_USDT.approve(routerInstance.address, new BigNumber(2000000e18), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await frax_instance.approve(routerInstance.address, new BigNumber(1000000e18), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await fxs_instance.approve(routerInstance.address, new BigNumber(5000000e18), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		// Add allowances to the swapToPrice contract
		await wethInstance.approve(swapToPriceInstance.address, new BigNumber(2000000e18), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await usdc_instance.approve(swapToPriceInstance.address, new BigNumber(2000000e18), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await col_instance_USDT.approve(swapToPriceInstance.address, new BigNumber(2000000e18), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await frax_instance.approve(swapToPriceInstance.address, new BigNumber(1000000e18), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await fxs_instance.approve(swapToPriceInstance.address, new BigNumber(5000000e18), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		frax_price_from_FRAX_USDC = new BigNumber(
			await oracle_instance_FRAX_USDC.consult.call(FakeCollateral_USDC.address, 1e6),
		)
			.div(BIG6)
			.toNumber();
		frax_price_from_FRAX_USDT = new BigNumber(
			await oracle_instance_FRAX_USDT.consult.call(FakeCollateral_USDT.address, 1e6),
		)
			.div(BIG6)
			.toNumber();
		fxs_price_from_FXS_WETH = new BigNumber(await oracle_instance_FXS_WETH.consult.call(wethInstance.address, 1e6))
			.div(BIG6)
			.toNumber();
		fxs_price_from_FXS_USDC = new BigNumber(
			await oracle_instance_FXS_USDC.consult.call(FakeCollateral_USDC.address, 1e6),
		)
			.div(BIG6)
			.toNumber();
		fxs_price_from_FXS_USDT = new BigNumber(
			await oracle_instance_FXS_USDT.consult.call(FakeCollateral_USDT.address, 1e6),
		)
			.div(BIG6)
			.toNumber();
		...
		console.log(
			...
			new BigNumber((await frax_instance.frax_info.call())['7']).div(1e6).toString(),
			'USD = 1 ETH',
		);
		console.log('frax_price_from_FRAX_WETH: ', frax_price_from_FRAX_WETH.toString(), 'FRAX = 1 WETH');
		console.log(
			'FRAX-USD price from Chainlink, Uniswap:',
			new BigNumber(await frax_instance.frax_price.call()).div(1e6).toString(),
			'FRAX = 1 USD',
		);
		//console.log("frax_price_from_FRAX_USDC: ", frax_price_from_FRAX_USDC.toString(), "FRAX = 1 USDC");
		//console.log("frax_price_from_FRAX_USDT: ", frax_price_from_FRAX_USDT.toString(), "FRAX = 1 USDT");
		...
		console.log(
			...
			new BigNumber(await pool_instance_USDT.getCollateralPrice.call()).div(1e6).toString(),
			'USDT = 1 USD',
		);
		console.log(
			'USDC_price_from_pool: ',
			new BigNumber(await pool_instance_USDC.getCollateralPrice.call()).div(1e6).toString(),
			'USDC = 1 USD',
		);
	});
	...
	it('Deploys a vesting contract and then executes a governance proposal to revoke it', async () => {
		...
		await fxs_instance.approve(vestingInstance.address, new BigNumber('100000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await fxs_instance.transfer(vestingInstance.address, new BigNumber('100000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		const acc_0_FXS_balance_change = new BigNumber(await fxs_instance.balanceOf(accounts[0]))
			.minus(initial_FXS_balance)
			.div(BIG18);
		const acc_5_FXS_balance_change = new BigNumber(await fxs_instance.balanceOf(accounts[5]))
		...
		console.log(
			...
			new BigNumber(await fxs_instance.balanceOf(accounts[5])).minus(initial_FXS_balance_5).div(BIG18).toNumber(),
		);
	});
	...
	it('PART 0: Normal stakes at CR = 100%', async () => {
		...
		await pair_instance_FRAX_USDC.approve(stakingInstance_FRAX_USDC.address, uni_pool_tokens_1, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		console.log('accounts[1] approve FRAX_USDC staking pool for 7.5 (E6) LP tokens');
		const uni_pool_1st_stake_1 = new BigNumber(
			await pair_instance_FRAX_USDC.balanceOf.call(COLLATERAL_FRAX_AND_FXS_OWNER),
		).div(BIG6);
		const fxs_1st_stake_1 = new BigNumber(await fxs_instance.balanceOf.call(COLLATERAL_FRAX_AND_FXS_OWNER)).div(
			BIG18,
		);
		const rewards_balance_1st_stake_1 = new BigNumber(
			await stakingInstance_FRAX_USDC.rewards.call(COLLATERAL_FRAX_AND_FXS_OWNER),
		).div(BIG18);
		...
		console.log(
			...
			new BigNumber(await stakingInstance_FRAX_USDC.balanceOf(COLLATERAL_FRAX_AND_FXS_OWNER))
				.div(BIG6)
				.toNumber(),
		);
		console.log(
			'accounts[1] boostedBalanceOf:',
			new BigNumber(await stakingInstance_FRAX_USDC.boostedBalanceOf(COLLATERAL_FRAX_AND_FXS_OWNER))
				.div(BIG6)
				.toNumber(),
		);
		console.log('');
		...
		await pair_instance_FRAX_USDC.approve(stakingInstance_FRAX_USDC.address, uni_pool_tokens_9, {
			from: accounts[9],
		});
		...
		const rewards_balance_1st_stake_9 = new BigNumber(await stakingInstance_FRAX_USDC.rewards(accounts[9])).div(
			BIG18,
		);
		...
		console.log(
			...
			new BigNumber(await stakingInstance_FRAX_USDC.balanceOf(accounts[9])).div(BIG6).toNumber(),
		);
		console.log(
			'accounts[9] boostedBalanceOf:',
			new BigNumber(await stakingInstance_FRAX_USDC.boostedBalanceOf(accounts[9])).div(BIG6).toNumber(),
		);
		console.log('');
		...
		const rewards_contract_stored_uni_pool = new BigNumber(await stakingInstance_FRAX_USDC.totalSupply.call()).div(
			BIG6,
		);
		...
		const fxs_post_reward_1 = new BigNumber(await fxs_instance.balanceOf.call(COLLATERAL_FRAX_AND_FXS_OWNER)).div(
			BIG18,
		);
		...
		const fxs_after_withdraw_0 = new BigNumber(await fxs_instance.balanceOf(COLLATERAL_FRAX_AND_FXS_OWNER)).div(
			BIG18,
		);
		console.log('accounts[1] FXS balance change:', fxs_after_withdraw_0.minus(fxs_1st_stake_1).toNumber());
		console.log(
			'accounts[9] earned():',
			new BigNumber(await stakingInstance_FRAX_USDC.earned.call(accounts[9])).div(BIG18).toNumber(),
		);
		console.log('====================================================================');
		...
		const staking_fxs_part2_earned_9 = new BigNumber(await stakingInstance_FRAX_USDC.earned.call(accounts[9])).div(
			BIG18,
		);
		...
		const fxs_2nd_time_balance = new BigNumber(
			await fxs_instance.balanceOf.call(COLLATERAL_FRAX_AND_FXS_OWNER),
		).div(BIG18);
		...
		console.log(
			'crBoostMultiplier():',
			new BigNumber(await stakingInstance_FRAX_USDC.crBoostMultiplier()).toNumber(),
		);
		...
		await stakingInstance_FRAX_USDC.sync({ from: COLLATERAL_FRAX_AND_FXS_OWNER });
		console.log(
			'[flag] accounts[9] staking earned():',
			new BigNumber(await stakingInstance_FRAX_USDC.earned.call(accounts[9])).div(BIG18).toString(),
		);
		await stakingInstance_FRAX_USDC.setRewardRate(0, { from: STAKING_OWNER });
		console.log(
			'[flag] accounts[9] staking earned():',
	...
	it('Mint some FRAX using USDC as collateral (collateral ratio = 1) [mint1t1FRAX]', async () => {
		...
		const collateral_before = new BigNumber(await usdc_instance.balanceOf.call(COLLATERAL_FRAX_AND_FXS_OWNER)).div(
			BIG6,
		);
		const pool_collateral_before = new BigNumber(
			await usdc_instance.balanceOf.call(pool_instance_USDC.address),
		).div(BIG6);
		...
		await usdc_instance.approve(pool_instance_USDC.address, collateral_amount, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		// Mint some FRAX
		...
		const collateral_after = new BigNumber(await usdc_instance.balanceOf.call(COLLATERAL_FRAX_AND_FXS_OWNER)).div(
			BIG6,
		);
		const pool_collateral_after = new BigNumber(await usdc_instance.balanceOf.call(pool_instance_USDC.address)).div(
			BIG6,
		);
	...
	it('Redeem some FRAX for USDC (collateral ratio >= 1) [redeem1t1FRAX]', async () => {
		...
		await usdc_instance.transfer(pool_instance_USDC.address, THREE_THOUSAND_DEC6, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await col_instance_USDT.transfer(pool_instance_USDT.address, THREE_THOUSAND_DEC6, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
	...
	it('Reduces the collateral ratio: 1-to-1 Phase => Fractional Phase', async () => {
		...
		for (let i = 0; i < 13; i++) {
			...
			console.log(
				...
				new BigNumber(await frax_instance.global_collateral_ratio.call()).div(BIG6).toNumber(),
			);
		}
	});
	...
	it('Mint some FRAX using FXS and USDC (collateral ratio between .000001 and .999999) [mintFractionalFRAX]', async () => {
		...
		console.log(
			...
			new BigNumber(await fxs_instance.getCurrentVotes(COLLATERAL_FRAX_AND_FXS_OWNER)).div(BIG18).toString(),
		);
		// Note the collateral ratio
		const collateral_ratio_before = new BigNumber(await frax_instance.global_collateral_ratio.call()).div(BIG6);
		console.log('collateral_ratio_before: ', collateral_ratio_before.toNumber());
		...
		await pool_instance_USDC.mintFractionalFRAX(collateral_amount, fxs_amount, new BigNumber('10e6'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
	...
	it('Set the pool ceiling and try to mint above it', async () => {
		...
		await pool_instance_USDC.setPoolParameters(new BigNumber('100e6'), 0, 1, 5500, 4500, 5500, 5500, {
			from: POOL_CREATOR,
		});
		await fxs_instance.approve(pool_instance_USDC.address, new BigNumber('1000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await usdc_instance.approve(pool_instance_USDC.address, new BigNumber('1000e6'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await expectRevert.unspecified(
			pool_instance_USDC.mintFractionalFRAX(new BigNumber('1000e18'), new BigNumber('1000e18'), 0, {
				from: COLLATERAL_FRAX_AND_FXS_OWNER,
			}),
		);
		await pool_instance_USDC.setPoolParameters(new BigNumber('5000000e18'), 0, 1, 5500, 4500, 5500, 5500, {
			from: POOL_CREATOR,
		});
	});
	...
	it("SHOULD FAIL: Mint some FRAX using FXS and USDC, but doesn't send in enough FXS [mintFractionalFRAX]", async () => {
		...
		await expectRevert.unspecified(
			pool_instance_USDC.mintFractionalFRAX(collateral_amount, fxs_amount, new BigNumber('10e18'), {
				from: COLLATERAL_FRAX_AND_FXS_OWNER,
			}),
		);
	...
	it('Redeem some FRAX for FXS and USDC (collateral ratio between .000001 and .999999) [redeemFractionalFRAX]', async () => {
		...
		// Redeem some FRAX
		await pool_instance_USDC.redeemFractionalFRAX(frax_amount, new BigNumber('5e18'), new BigNumber('125e6'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
	...
	it('Mint some FRAX using FXS and USDC (collateral ratio between .000001 and .999999) [mintFractionalFRAX]', async () => {
		...
		await pool_instance_USDC.mintFractionalFRAX(collateral_amount, fxs_amount, new BigNumber('10e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
	...
	it('Recollateralizes the system using recollateralizeFRAX()', async () => {
		...
		let globalCollateralRatio = new BigNumber(await frax_instance.global_collateral_ratio.call())
			.div(BIG6)
			.toNumber();
		let globalCollateralValue = new BigNumber(await frax_instance.globalCollateralValue.call())
			.div(BIG18)
			.toNumber();
		console.log('FRAX price (USD): ', new BigNumber(await frax_instance.frax_price.call()).div(BIG6).toNumber());
		console.log('FXS price (USD): ', new BigNumber(await frax_instance.fxs_price.call()).div(BIG6).toNumber());
		...
		console.log(
			...
			new BigNumber(await pool_instance_USDC.getCollateralPrice.call()).div(BIG6).toNumber(),
		);
		...
		// Redeem some FRAX
		await pool_instance_USDC.recollateralizeFRAX(USDC_amount, new BigNumber('10e6'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
	...
	it('Mint some FRAX using FXS (collateral ratio = 0) [mintAlgorithmicFRAX]', async () => {
		...
		// Mint some FRAX
		await pool_instance_USDC.mintAlgorithmicFRAX(fxs_amount, new BigNumber('10e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
	...
	it('Redeem some FRAX for FXS (collateral ratio = 0) [redeemAlgorithmicFRAX]', async () => {
		...
		// Redeem some FRAX
		await pool_instance_USDC.redeemAlgorithmicFRAX(frax_amount, new BigNumber('10e6'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
	...
	it('Buys back collateral using FXS [should fail if CR = 0]', async () => {
		...
		const global_pool_collateral_before = new BigNumber(await frax_instance.globalCollateralValue.call()).div(
			BIG18,
		);
		bal_fxs = fxs_before;
		col_bal_usdc = collateral_before;
		...
		console.log(
			...
			global_pool_collateral_after.toNumber() - global_pool_collateral_before.toNumber(),
		);
	...
	it('Make sure the StakingRewards (FRAX/USDC) are initialized', async () => {
		...
		assert.equal(
			(rewards_contract_periodFinish - rewards_contract_lastUpdateTime) / REWARDS_DURATION >= 0.9999,
			true,
		);
	});
	...
	it('PART 1: Normal stakes at CR = 0', async () => {
		...
		console.log(
			...
			new BigNumber(await fxs_instance.getCurrentVotes(COLLATERAL_FRAX_AND_FXS_OWNER)).div(BIG18).toNumber(),
		);
		console.log(
	...
	it('blocks a greylisted address which tries to stake; SHOULD FAIL', async () => {
		...
		await pair_instance_FRAX_USDC.approve(stakingInstance_FRAX_USDC.address, new BigNumber('1e6'), {
			from: accounts[9],
		});
	...
	it('PART 2: Locked stakes', async () => {
		...
		await pair_instance_FRAX_USDC.approve(stakingInstance_FRAX_USDC.address, uni_pool_normal_1, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await pair_instance_FRAX_USDC.approve(stakingInstance_FRAX_USDC.address, uni_pool_normal_9, {
			from: accounts[9],
		});
		...
		await pair_instance_FRAX_USDC.approve(stakingInstance_FRAX_USDC.address, uni_pool_locked_1_sum, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await pair_instance_FRAX_USDC.approve(stakingInstance_FRAX_USDC.address, uni_pool_locked_9, {
			from: accounts[9],
		});
		...
		await stakingInstance_FRAX_USDC.stakeLocked(new BigNumber('25e5'), 548 * 86400, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		}); // 270 days
		...
		const locked_stake_structs_1 = await stakingInstance_FRAX_USDC.lockedStakesOf.call(
			COLLATERAL_FRAX_AND_FXS_OWNER,
		);
		...
		const regular_balance_1 = new BigNumber(
			await stakingInstance_FRAX_USDC.balanceOf.call(COLLATERAL_FRAX_AND_FXS_OWNER),
		).div(BIG6);
		const boosted_balance_1 = new BigNumber(
			await stakingInstance_FRAX_USDC.boostedBalanceOf.call(COLLATERAL_FRAX_AND_FXS_OWNER),
		).div(BIG6);
		const unlocked_balance_1 = new BigNumber(
			await stakingInstance_FRAX_USDC.unlockedBalanceOf.call(COLLATERAL_FRAX_AND_FXS_OWNER),
		).div(BIG6);
		const locked_balance_1 = new BigNumber(
			await stakingInstance_FRAX_USDC.lockedBalanceOf.call(COLLATERAL_FRAX_AND_FXS_OWNER),
		).div(BIG6);
		const regular_balance_9 = new BigNumber(await stakingInstance_FRAX_USDC.balanceOf.call(accounts[9])).div(BIG6);
		const boosted_balance_9 = new BigNumber(await stakingInstance_FRAX_USDC.boostedBalanceOf.call(accounts[9])).div(
			BIG6,
		);
		const unlocked_balance_9 = new BigNumber(
			await stakingInstance_FRAX_USDC.unlockedBalanceOf.call(accounts[9]),
		).div(BIG6);
		const locked_balance_9 = new BigNumber(await stakingInstance_FRAX_USDC.lockedBalanceOf.call(accounts[9])).div(
			BIG6,
		);
		...
		await expectRevert.unspecified(
			stakingInstance_FRAX_USDC.withdrawLocked(locked_stake_structs_1[0].kek_id, {
				from: COLLATERAL_FRAX_AND_FXS_OWNER,
			}),
		);
		await expectRevert.unspecified(
			stakingInstance_FRAX_USDC.withdrawLocked(locked_stake_structs_9[0].kek_id, { from: accounts[9] }),
		);
		await time.advanceBlock();
		...
		await stakingInstance_FRAX_USDC.withdrawLocked(locked_stake_structs_1[0].kek_id, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await expectRevert.unspecified(
			stakingInstance_FRAX_USDC.withdrawLocked(locked_stake_structs_9[0].kek_id, { from: accounts[9] }),
		...
		const staking_fxs_earned_28_1 = new BigNumber(await stakingInstance_FRAX_USDC.earned.call(accounts[1])).div(
			BIG18,
		);
		const staking_fxs_earned_28_9 = new BigNumber(await stakingInstance_FRAX_USDC.earned.call(accounts[9])).div(
			BIG18,
		);
		...
		await stakingInstance_FRAX_USDC.getReward({ from: accounts[9] });
		await expectRevert.unspecified(
			stakingInstance_FRAX_USDC.withdrawLocked(locked_stake_structs_1[1].kek_id, {
				from: COLLATERAL_FRAX_AND_FXS_OWNER,
			}),
		);
		...
		await stakingInstance_FRAX_USDC.withdrawLocked(locked_stake_structs_1[1].kek_id, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		await fxs_instance.transfer(stakingInstance_FRAX_USDC.address, new BigNumber('100000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		console.log(
			'stakingInstance FXS balance:',
			new BigNumber(await fxs_instance.balanceOf(stakingInstance_FRAX_USDC.address)).div(BIG18).toNumber(),
		);
		await stakingInstance_FRAX_USDC.getReward({ from: COLLATERAL_FRAX_AND_FXS_OWNER });
		console.log(
			'accounts[1] FXS balance:',
	...
	it('FraxPool security tests; SHOULD FAIL', async () => {
		...
		await expectRevert.unspecified(
			pool_instance_USDC.setCollatETHOracle(DUMP_ADDRESS, DUMP_ADDRESS, { from: accounts[6] }),
		);
	...
	it('Does a fair launch', async () => {
		...
		await fxs_instance.transfer(stakingInstance_FRAX_WETH.address, new BigNumber('1000000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			...
			new BigNumber(await fxs_instance.balanceOf(stakingInstance_FRAX_WETH.address)).div(BIG18).toNumber(),
		);
		console.log(
			'accounts[2] FRAX-WETH LP token balance:',
			new BigNumber(await pair_instance_FRAX_WETH.balanceOf(accounts[2])).div(BIG18).toNumber(),
		);
		console.log(
			'accounts[3] FRAX-WETH LP token balance:',
			new BigNumber(await pair_instance_FRAX_WETH.balanceOf(accounts[3])).div(BIG18).toNumber(),
		);
		...
		console.log(
			...
			new BigNumber(await fxs_instance.balanceOf(accounts[2])).div(BIG18).toNumber(),
		);
		console.log(
			'accounts[3] FXS balance:',
			new BigNumber(await fxs_instance.balanceOf(accounts[3])).div(BIG18).toNumber(),
		);

		await pair_instance_FRAX_WETH.approve(stakingInstance_FRAX_WETH.address, new BigNumber('1e18'), {
			from: accounts[2],
		});
		await pair_instance_FRAX_WETH.approve(stakingInstance_FRAX_WETH.address, new BigNumber('1e18'), {
			from: accounts[3],
		...
		console.log(
			...
			new BigNumber(await fxs_instance.balanceOf(accounts[2]))
		...
		console.log(
			...
			new BigNumber(await fxs_instance.balanceOf(accounts[3]))
		...
		console.log(
			'crBoostMultiplier():',
			new BigNumber(await stakingInstance_FRAX_WETH.crBoostMultiplier()).toNumber(),
		);
	});
});
