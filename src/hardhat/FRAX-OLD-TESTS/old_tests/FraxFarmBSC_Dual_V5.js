...
contract('FraxFarmBSC_Dual_V5-Tests', async (accounts) => {
	...
	beforeEach(async () => {
		...
		pair_instance_impossible_FRAX_IF = await IImpossiblePair.at(
	...
	it('Initialization related', async () => {
		...
		await impossibleFinanceToken.transfer(fraxFarmBSC_Dual_FRAX_IF_instance.address, new BigNumber('10000e18'), {
			from: ADDRESS_WITH_IF,
		});
		...
		await fxs_instance.transfer(fraxFarmBSC_Dual_FRAX_IF_instance.address, new BigNumber('10000e18'), {
		...
		await pair_instance_impossible_FRAX_IF.transfer(accounts[1], new BigNumber('250e18'), {
			from: ADDRESS_WITH_LP_TOKENS,
		});
		await pair_instance_impossible_FRAX_IF.transfer(accounts[9], new BigNumber('250e18'), {
			from: ADDRESS_WITH_LP_TOKENS,
		});
	...
	it('Locked stakes', async () => {
		...
		await pair_instance_impossible_FRAX_IF.approve(
			fraxFarmBSC_Dual_FRAX_IF_instance.address,
			uni_pool_locked_1_sum,
			{ from: COLLATERAL_FRAX_AND_FXS_OWNER },
		);
		await pair_instance_impossible_FRAX_IF.approve(fraxFarmBSC_Dual_FRAX_IF_instance.address, uni_pool_locked_9, {
			from: accounts[9],
		});

		// Stake Locked
		// account[1]
		await fraxFarmBSC_Dual_FRAX_IF_instance.stakeLocked(uni_pool_locked_1, 7 * 86400, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		}); // 15 days
		await fraxFarmBSC_Dual_FRAX_IF_instance.stakeLocked(new BigNumber('25e17'), 548 * 86400, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		}); // 270 days
		...
		const locked_stake_structs_1_0 = await fraxFarmBSC_Dual_FRAX_IF_instance.lockedStakesOf.call(
			COLLATERAL_FRAX_AND_FXS_OWNER,
		);
		...
		const regular_balance_1 = new BigNumber(
			await fraxFarmBSC_Dual_FRAX_IF_instance.lockedLiquidityOf.call(COLLATERAL_FRAX_AND_FXS_OWNER),
		).div(BIG18);
		const boosted_balance_1 = new BigNumber(
			await fraxFarmBSC_Dual_FRAX_IF_instance.combinedWeightOf.call(COLLATERAL_FRAX_AND_FXS_OWNER),
		).div(BIG18);
		const locked_balance_1 = new BigNumber(
			await fraxFarmBSC_Dual_FRAX_IF_instance.lockedLiquidityOf.call(COLLATERAL_FRAX_AND_FXS_OWNER),
		).div(BIG18);
		const regular_balance_9 = new BigNumber(
			await fraxFarmBSC_Dual_FRAX_IF_instance.lockedLiquidityOf.call(accounts[9]),
		).div(BIG18);
		const boosted_balance_9 = new BigNumber(
			await fraxFarmBSC_Dual_FRAX_IF_instance.combinedWeightOf.call(accounts[9]),
		).div(BIG18);
		...
		await expectRevert.unspecified(
			fraxFarmBSC_Dual_FRAX_IF_instance.withdrawLocked(locked_stake_structs_1_0[0].kek_id, {
				from: COLLATERAL_FRAX_AND_FXS_OWNER,
			}),
		);
		await expectRevert.unspecified(
			fraxFarmBSC_Dual_FRAX_IF_instance.withdrawLocked(locked_stake_structs_9_0[0].kek_id, { from: accounts[9] }),
		);
		await time.advanceBlock();
		...
		const _total_liquidity_locked_0 = new BigNumber(
			await fraxFarmBSC_Dual_FRAX_IF_instance.totalLiquidityLocked.call(),
		).div(BIG18);
		const _total_combined_weight_0 = new BigNumber(
			await fraxFarmBSC_Dual_FRAX_IF_instance.totalCombinedWeight.call(),
		).div(BIG18);
		...
		await fraxFarmBSC_Dual_FRAX_IF_instance.withdrawLocked(locked_stake_structs_1_0[0].kek_id, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await expectRevert.unspecified(
			fraxFarmBSC_Dual_FRAX_IF_instance.withdrawLocked(locked_stake_structs_9_0[0].kek_id, { from: accounts[9] }),
		...
		await fraxFarmBSC_Dual_FRAX_IF_instance.setRewardRates(curr_token0_rate_again, new_token1_rate_again, false, {
			from: STAKING_OWNER,
		});
		...
		await fraxFarmBSC_Dual_FRAX_IF_instance.withdrawLocked(locked_stake_structs_9_0[0].kek_id, {
			from: accounts[9],
		});
		await fraxFarmBSC_Dual_FRAX_IF_instance.getReward({ from: accounts[9] });
		await expectRevert.unspecified(
			fraxFarmBSC_Dual_FRAX_IF_instance.withdrawLocked(locked_stake_structs_1_0[1].kek_id, {
				from: COLLATERAL_FRAX_AND_FXS_OWNER,
			}),
		);
		...
		await fraxFarmBSC_Dual_FRAX_IF_instance.withdrawLocked(locked_stake_structs_1_0[1].kek_id, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
	...
	it('Migration Staking / Withdrawal Tests', async () => {
		...
		await fraxFarmBSC_Dual_FRAX_IF_instance.stakerAllowMigrator(MIGRATOR_ADDRESS, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			...
			new BigNumber(await pair_instance_impossible_FRAX_IF.balanceOf(COLLATERAL_FRAX_AND_FXS_OWNER))
				.div(BIG18)
				.toNumber(),
		);

		// Stake Locked
		await pair_instance_impossible_FRAX_IF.approve(fraxFarmBSC_Dual_FRAX_IF_instance.address, stake_amt_locked, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await fraxFarmBSC_Dual_FRAX_IF_instance.stakeLocked(stake_amt_locked, 7 * 86400, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		// Show the stake structs
		const locked_stake_structs = await fraxFarmBSC_Dual_FRAX_IF_instance.lockedStakesOf.call(
			COLLATERAL_FRAX_AND_FXS_OWNER,
		);
		...
		console.log(
			...
			new BigNumber(await fraxFarmBSC_Dual_FRAX_IF_instance.lockedLiquidityOf(COLLATERAL_FRAX_AND_FXS_OWNER))
				.div(BIG18)
				.toNumber(),
		);
		console.log(
			'accounts[1] staked combinedWeightOf <BEFORE>:',
			new BigNumber(await fraxFarmBSC_Dual_FRAX_IF_instance.combinedWeightOf(COLLATERAL_FRAX_AND_FXS_OWNER))
				.div(BIG18)
				.toNumber(),
		);
		...
		await fraxFarmBSC_Dual_FRAX_IF_instance.migrator_withdraw_locked(
			COLLATERAL_FRAX_AND_FXS_OWNER,
		...
		console.log(
			...
			new BigNumber(await pair_instance_impossible_FRAX_IF.balanceOf(MIGRATOR_ADDRESS)).div(BIG18).toNumber(),
		);
		console.log(
		...
		await fraxFarmBSC_Dual_FRAX_IF_instance.migrator_stakeLocked_for(
			COLLATERAL_FRAX_AND_FXS_OWNER,
			proxy_stake_lock_amt,
			28 * 86400,
	...
	it('Fail Tests ', async () => {
		...
		await expectRevert(
			fraxFarmBSC_Dual_FRAX_IF_instance.migrator_withdraw_locked(
				COLLATERAL_FRAX_AND_FXS_OWNER,
				locked_stake_structs[2].kek_id,
				{ from: MIGRATOR_ADDRESS },
			),
		...
		await expectRevert(
			fraxFarmBSC_Dual_FRAX_IF_instance.migrator_stakeLocked_for(
				COLLATERAL_FRAX_AND_FXS_OWNER,
				test_amount_1,
				28 * 86400,
		...
		await expectRevert(
			fraxFarmBSC_Dual_FRAX_IF_instance.stakerAllowMigrator(INVESTOR_CUSTODIAN_ADDRESS, {
				from: COLLATERAL_FRAX_AND_FXS_OWNER,
			}),
		...
		await expectRevert(
			fraxFarmBSC_Dual_FRAX_IF_instance.recoverBEP20(pair_instance_impossible_FRAX_IF.address, test_amount_1, {
				from: STAKING_OWNER,
			}),
			'Not in migration',
		);
		...
		await pair_instance_impossible_FRAX_IF.approve(fraxFarmBSC_Dual_FRAX_IF_instance.address, test_amount_1, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await expectRevert(
			fraxFarmBSC_Dual_FRAX_IF_instance.stakeLocked(test_amount_1, 28 * 86400, {
				from: COLLATERAL_FRAX_AND_FXS_OWNER,
			}),
		...
		await fraxFarmBSC_Dual_FRAX_IF_instance.stakerDisallowMigrator(MIGRATOR_ADDRESS, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
