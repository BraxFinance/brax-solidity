...
contract('PIDController-Tests', async (accounts) => {
	...
	beforeEach(async () => {
		...
		frax_3crv_metapool_instance = await MetaImplementationUSD.at(
	...
	it('Check up on the oracles and make sure the prices are set', async () => {
		...
		await fxs_instance.transfer(COLLATERAL_FRAX_AND_FXS_OWNER, new BigNumber('5000000e18'), {
		...
		await frax_instance.transfer(COLLATERAL_FRAX_AND_FXS_OWNER, new BigNumber('10000e18'), {
		...
		await usdc_instance.transfer(COLLATERAL_FRAX_AND_FXS_OWNER, new BigNumber('120000000e6'), {
		...
		await web3.eth.sendTransaction({
			...
			value: 99600000000000000,
		});
		// Give the COLLATERAL_FRAX_AND_FXS_OWNER address a lot of real USDC
		await usdc_instance.transfer(COLLATERAL_FRAX_AND_FXS_OWNER, new BigNumber('84000000e6'), {
	...
	it('Tests CCR FRAX amount', async () => {
		await usdc_instance.approve(stableswap3pool_instance.address, new BigNumber('200000000e6'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			'COLLATERAL_FRAX_AND_FXS_OWNER USDC balance:',
			new BigNumber(await usdc_instance.balanceOf(COLLATERAL_FRAX_AND_FXS_OWNER)).div(BIG6).toNumber(),
		);
		await stableswap3pool_instance.add_liquidity([0, new BigNumber('20000000e6'), 0], 0, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		console.log(
			'accounts[1] 3CRV balance:',
			new BigNumber(await crv3Instance.balanceOf(COLLATERAL_FRAX_AND_FXS_OWNER)).div(BIG18).toNumber(),
		);
		...
		await pool_instance_USDC.setPoolParameters(new BigNumber('1000000000e18'), 0, 0, 0, 0, 0, 0, {
			from: '0xb39e2041b042f39b8572B6F84dEba99BbB589c8d',
		});
		...
		await frax_instance.setPriceTarget(new BigNumber('2e6'), {
			from: '0x234D953a9404Bf9DbC3b526271d440cD2870bCd2',
		});
		...
		console.log(
			'accounts[1] fake USDC balance:',
			new BigNumber(await usdc_instance.balanceOf(COLLATERAL_FRAX_AND_FXS_OWNER)).div(BIG6).toNumber(),
		);
		await usdc_instance.approve(pool_instance_USDC.address, new BigNumber('170000000e6'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		await crv3Instance.approve(frax_3crv_metapool_instance.address, crv3Amount_metaliq, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await frax_instance.approve(frax_3crv_metapool_instance.address, fraxAmount_metaliq, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			'accounts[1] FRAX3CRV-f metapool LP token balance:',
			new BigNumber(await frax_3crv_metapool_instance.balanceOf(COLLATERAL_FRAX_AND_FXS_OWNER))
				.div(BIG18)
				.toNumber(),
		);
		...
		await frax_instance.approve(frax_3crv_metapool_instance.address, new BigNumber('10000000000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		let amountOut = 1e6;
		let amountSwapped = 0;
...
*/
	...
	it('Tests the Curve TWAP', async () => {
		...
		console.log(
			'\nspot price of (1) 3CRV for (dy) FRAX using get_dy():',
			new BigNumber(
				await frax_3crv_metapool_instance.get_dy(1, 0, new BigNumber('1e18'), {
					from: COLLATERAL_FRAX_AND_FXS_OWNER,
				}),
			)
				.div(BIG18)
		...
		console.log(
			'Swap 1 DAI for X USDC:',
			new BigNumber(
				await frax_3crv_metapool_instance.get_dy_underlying(1, 2, new BigNumber('1e18'), {
					from: COLLATERAL_FRAX_AND_FXS_OWNER,
				}),
			)
				.div(BIG6)
		...
		console.log(
			'Swap 1 USDC for X USDT:',
			new BigNumber(
				await frax_3crv_metapool_instance.get_dy_underlying(2, 3, new BigNumber('1e6'), {
					from: COLLATERAL_FRAX_AND_FXS_OWNER,
				}),
			)
				.div(BIG6)
		...
		console.log(
			'Swap 1 USDT for X DAI:',
			new BigNumber(
				await frax_3crv_metapool_instance.get_dy_underlying(3, 1, new BigNumber('1e6'), {
					from: COLLATERAL_FRAX_AND_FXS_OWNER,
				}),
			)
				.div(BIG18)
		...
		console.log(
			'Swap 1 FRAX for X USDC:',
			new BigNumber(
				await frax_3crv_metapool_instance.get_dy_underlying(0, 2, new BigNumber('1e18'), {
					from: COLLATERAL_FRAX_AND_FXS_OWNER,
				}),
			)
				.div(BIG6)
		...
		console.log(
			'Swap 1 USDC for X FRAX:',
			new BigNumber(
				await frax_3crv_metapool_instance.get_dy_underlying(2, 0, new BigNumber('1e6'), {
					from: COLLATERAL_FRAX_AND_FXS_OWNER,
				}),
			)
				.div(BIG18)
		...
		console.log(
			'metapool FRAX balance:',
			new BigNumber(await frax_3crv_metapool_instance.balances.call(0)).div(BIG18).toNumber(),
		);
		console.log(
			'metapool 3CRV balance:',
			new BigNumber(await frax_3crv_metapool_instance.balances.call(1)).div(BIG18).toNumber(),
		);
		...
		await frax_instance.approve(frax_3crv_metapool_instance.address, new BigNumber('100e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await frax_3crv_metapool_instance.exchange(0, 1, new BigNumber('100e18'), 0, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		const twap_balances = await frax_3crv_metapool_instance.get_twap_balances(
			cum_price_1,
			cum_price_2,
		...
		console.log(
			'twap_balances:',
			new BigNumber(twap_balances[0]).div(BIG18).toNumber(),
			new BigNumber(twap_balances[1]).div(BIG18).toNumber(),
		);

		const virtual_price = new BigNumber(await frax_3crv_metapool_instance.get_virtual_price());
		const twap_dy = new BigNumber(
			await frax_3crv_metapool_instance.get_dy(0, 1, new BigNumber('1e18'), twap_balances, {
				from: COLLATERAL_FRAX_AND_FXS_OWNER,
			}),
		);
		...
		console.log(
			'ReserveTracker refreshFRAXCurveTWAP():',
			new BigNumber(await reserve_tracker_instance.refreshFRAXCurveTWAP.call()).div(BIG6).toNumber(),
		);
		...
		const twap_balances_2 = await frax_3crv_metapool_instance.get_twap_balances(
			cum_price_2,
			cum_price_3,
		...
		console.log(
			'twap_balances:',
			new BigNumber(twap_balances_2[0]).div(BIG18).toNumber(),
			new BigNumber(twap_balances_2[1]).div(BIG18).toNumber(),
		);

		const virtual_price_2 = new BigNumber(await frax_3crv_metapool_instance.get_virtual_price());
		const twap_dy_2 = new BigNumber(
			await frax_3crv_metapool_instance.get_dy(0, 1, new BigNumber('1e18'), twap_balances_2, {
				from: COLLATERAL_FRAX_AND_FXS_OWNER,
			}),
		);
		...
		await crv3Instance.approve(frax_3crv_metapool_instance.address, new BigNumber('1e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		const amt_received = await frax_3crv_metapool_instance.exchange(1, 0, new BigNumber('1e18'), 0, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
	});
	...
	it('Checks the PIDController', async () => {
		...
		console.log(
			'FXS reserves:',
			new BigNumber(await reserve_tracker_instance.getFXSReserves()).div(BIG18).toNumber(),
		);
		...
		console.log(
			'pair FRAX balance:',
			new BigNumber(await frax_instance.balanceOf(pair_instance_FRAX_USDC.address)).div(BIG18).toNumber(),
		);
		await frax_instance.transfer(pair_instance_FRAX_USDC.address, new BigNumber('10000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			'[FRAX-USDC] FRAX price:',
			new BigNumber(await oracle_instance_FRAX_USDC.consult(frax_instance.address, new BigNumber('1e18')))
				.div(BIG6)
				.toNumber(),
		);
		...
		await fxs_instance.transfer(pair_instance_FXS_WETH.address, new BigNumber('100000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		// do a quick swap
