...
contract('StakingRewardsDualV5_FRAX_OHM-Tests', async (accounts) => {
	...
	it('Initialization related', async () => {
		...
		await fxs_instance.transfer(stakingInstanceDualV5_FRAX_OHM.address, new BigNumber('25000e18'), {
		...
		await iq_instance.transfer(stakingInstanceDualV5_FRAX_OHM.address, new BigNumber('10000e18'), {
			from: ADDRESS_WITH_IQ,
		});
	...
	it('Locked stakes', async () => {
		...
		await fxs_instance.approve(veFXS_instance.address, deposit_amount_1_e18, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await veFXS_instance.create_lock(deposit_amount_1_e18, veFXS_deposit_end_timestamp_1, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			'accounts[1] veFXS balance:',
			new BigNumber(await veFXS_instance.balanceOf(COLLATERAL_FRAX_AND_FXS_OWNER)).div(BIG18).toNumber(),
		);
		console.log(
		...
		console.log(
			'accounts[9] veFXS balance:',
			new BigNumber(await veFXS_instance.balanceOf(accounts[9])).div(BIG18).toNumber(),
		);
		...
		await pair_instance_FRAX_IQ.approve(stakingInstanceDualV5_FRAX_OHM.address, uni_pool_locked_1_sum, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await pair_instance_FRAX_IQ.approve(stakingInstanceDualV5_FRAX_OHM.address, uni_pool_locked_9, {
			from: accounts[9],
		});
		...
		// Stake Locked
		// account[1]
		await stakingInstanceDualV5_FRAX_OHM.stakeLocked(uni_pool_locked_1, 7 * 86400, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		}); // 15 days
		await stakingInstanceDualV5_FRAX_OHM.stakeLocked(new BigNumber('25e17'), 548 * 86400, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		}); // 270 days
		...
		const locked_stake_structs_1_0 = await stakingInstanceDualV5_FRAX_OHM.lockedStakesOf.call(
		...
		const regular_balance_1 = new BigNumber(
			await stakingInstanceDualV5_FRAX_OHM.lockedLiquidityOf.call(COLLATERAL_FRAX_AND_FXS_OWNER),
		).div(BIG18);
		const boosted_balance_1 = new BigNumber(
			await stakingInstanceDualV5_FRAX_OHM.combinedWeightOf.call(COLLATERAL_FRAX_AND_FXS_OWNER),
		).div(BIG18);
		const locked_balance_1 = new BigNumber(
			await stakingInstanceDualV5_FRAX_OHM.lockedLiquidityOf.call(COLLATERAL_FRAX_AND_FXS_OWNER),
		).div(BIG18);
		const regular_balance_9 = new BigNumber(
			await stakingInstanceDualV5_FRAX_OHM.lockedLiquidityOf.call(accounts[9]),
		).div(BIG18);
		const boosted_balance_9 = new BigNumber(
			await stakingInstanceDualV5_FRAX_OHM.combinedWeightOf.call(accounts[9]),
		).div(BIG18);
		...
		await expectRevert.unspecified(
			stakingInstanceDualV5_FRAX_OHM.withdrawLocked(locked_stake_structs_1_0[0].kek_id, {
				from: COLLATERAL_FRAX_AND_FXS_OWNER,
			}),
		);
		await expectRevert.unspecified(
			stakingInstanceDualV5_FRAX_OHM.withdrawLocked(locked_stake_structs_9_0[0].kek_id, { from: accounts[9] }),
		);
		await time.advanceBlock();
		...
		const user_min_vefxs_for_max_boost_1_0 = new BigNumber(
			await stakingInstanceDualV5_FRAX_OHM.minVeFXSForMaxBoost.call(COLLATERAL_FRAX_AND_FXS_OWNER),
		).div(BIG18);
		const user_min_vefxs_for_max_boost_9_0 = new BigNumber(
			await stakingInstanceDualV5_FRAX_OHM.minVeFXSForMaxBoost.call(accounts[9]),
		).div(BIG18);
		...
		const _total_liquidity_locked_0 = new BigNumber(
			await stakingInstanceDualV5_FRAX_OHM.totalLiquidityLocked.call(),
		).div(BIG18);
		const _total_combined_weight_0 = new BigNumber(
			await stakingInstanceDualV5_FRAX_OHM.totalCombinedWeight.call(),
		).div(BIG18);
		const frax_per_lp_token_0 = new BigNumber(await stakingInstanceDualV5_FRAX_OHM.fraxPerLPToken.call()).div(
			BIG18,
		);
		...
		const regular_balance_00_9 = new BigNumber(
			await stakingInstanceDualV5_FRAX_OHM.lockedLiquidityOf.call(accounts[9]),
		).div(BIG18);
		const boosted_balance_00_9 = new BigNumber(
			await stakingInstanceDualV5_FRAX_OHM.combinedWeightOf.call(accounts[9]),
		).div(BIG18);
		const locked_balance_00_9 = new BigNumber(
			await stakingInstanceDualV5_FRAX_OHM.lockedLiquidityOf.call(accounts[9]),
		).div(BIG18);
		...
		const user_min_vefxs_for_max_boost_1_1 = new BigNumber(
			await stakingInstanceDualV5_FRAX_OHM.minVeFXSForMaxBoost.call(COLLATERAL_FRAX_AND_FXS_OWNER),
		).div(BIG18);
		const user_min_vefxs_for_max_boost_9_1 = new BigNumber(
			await stakingInstanceDualV5_FRAX_OHM.minVeFXSForMaxBoost.call(accounts[9]),
		).div(BIG18);
		...
		await stakingInstanceDualV5_FRAX_OHM.withdrawLocked(locked_stake_structs_1_0[0].kek_id, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await expectRevert.unspecified(
			stakingInstanceDualV5_FRAX_OHM.withdrawLocked(locked_stake_structs_9_0[0].kek_id, { from: accounts[9] }),
		...
		await stakingInstanceDualV5_FRAX_OHM.setRewardRates(curr_token0_rate_again, new_token1_rate_again, false, {
			from: STAKING_OWNER,
		});
		...
		const regular_balance_01_9 = new BigNumber(
			await stakingInstanceDualV5_FRAX_OHM.lockedLiquidityOf.call(accounts[9]),
		).div(BIG18);
		const boosted_balance_01_9 = new BigNumber(
			await stakingInstanceDualV5_FRAX_OHM.combinedWeightOf.call(accounts[9]),
		).div(BIG18);
		const locked_balance_01_9 = new BigNumber(
			await stakingInstanceDualV5_FRAX_OHM.lockedLiquidityOf.call(accounts[9]),
		).div(BIG18);
		...
		const user_min_vefxs_for_max_boost_1_2 = new BigNumber(
			await stakingInstanceDualV5_FRAX_OHM.minVeFXSForMaxBoost.call(COLLATERAL_FRAX_AND_FXS_OWNER),
		).div(BIG18);
		const user_min_vefxs_for_max_boost_9_2 = new BigNumber(
			await stakingInstanceDualV5_FRAX_OHM.minVeFXSForMaxBoost.call(accounts[9]),
		).div(BIG18);
		...
		await expectRevert.unspecified(
			stakingInstanceDualV5_FRAX_OHM.withdrawLocked(locked_stake_structs_1_0[1].kek_id, {
				from: COLLATERAL_FRAX_AND_FXS_OWNER,
			}),
		);

		const _total_liquidity_locked_1 = new BigNumber(
			await stakingInstanceDualV5_FRAX_OHM.totalLiquidityLocked.call(),
		).div(BIG18);
		const _total_combined_weight_1 = new BigNumber(
			await stakingInstanceDualV5_FRAX_OHM.totalCombinedWeight.call(),
		).div(BIG18);
		...
		await stakingInstanceDualV5_FRAX_OHM.withdrawLocked(locked_stake_structs_1_0[1].kek_id, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		const user_min_vefxs_for_max_boost_1_3 = new BigNumber(
			await stakingInstanceDualV5_FRAX_OHM.minVeFXSForMaxBoost.call(COLLATERAL_FRAX_AND_FXS_OWNER),
		).div(BIG18);
		const user_min_vefxs_for_max_boost_9_3 = new BigNumber(
			await stakingInstanceDualV5_FRAX_OHM.minVeFXSForMaxBoost.call(accounts[9]),
		).div(BIG18);
		...
		const _total_liquidity_locked_2 = new BigNumber(
			await stakingInstanceDualV5_FRAX_OHM.totalLiquidityLocked.call(),
		).div(BIG18);
		const _total_combined_weight_2 = new BigNumber(
			await stakingInstanceDualV5_FRAX_OHM.totalCombinedWeight.call(),
		).div(BIG18);
		const frax_per_lp_token_2 = new BigNumber(await stakingInstanceDualV5_FRAX_OHM.fraxPerLPToken.call()).div(
			BIG18,
		);
	...
	it('Blocks a greylisted address which tries to stake; SHOULD FAIL', async () => {
		...
		await pair_instance_FRAX_IQ.approve(stakingInstanceDualV5_FRAX_OHM.address, new BigNumber('1e18'), {
			from: accounts[9],
		});
	...
	it('Migration Staking / Withdrawal Tests', async () => {
		...
		await stakingInstanceDualV5_FRAX_OHM.stakerAllowMigrator(MIGRATOR_ADDRESS, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		// Print the balance
		console.log(
			'accounts[1] ERC20 balanceOf UniV2 FRAX/IQ LP:',
			new BigNumber(await pair_instance_FRAX_IQ.balanceOf(COLLATERAL_FRAX_AND_FXS_OWNER)).div(BIG18).toNumber(),
		);

		// Stake Locked
		await pair_instance_FRAX_IQ.approve(stakingInstanceDualV5_FRAX_OHM.address, stake_amt_locked, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await stakingInstanceDualV5_FRAX_OHM.stakeLocked(stake_amt_locked, 7 * 86400, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		// Show the stake structs
		const locked_stake_structs = await stakingInstanceDualV5_FRAX_OHM.lockedStakesOf.call(
			COLLATERAL_FRAX_AND_FXS_OWNER,
		);
		...
		console.log(
			...
			new BigNumber(await stakingInstanceDualV5_FRAX_OHM.lockedLiquidityOf(COLLATERAL_FRAX_AND_FXS_OWNER))
				.div(BIG18)
				.toNumber(),
		);
		console.log(
			'accounts[1] staked combinedWeightOf <BEFORE>:',
			new BigNumber(await stakingInstanceDualV5_FRAX_OHM.combinedWeightOf(COLLATERAL_FRAX_AND_FXS_OWNER))
				.div(BIG18)
				.toNumber(),
		);
		...
		await stakingInstanceDualV5_FRAX_OHM.migrator_withdraw_locked(
			COLLATERAL_FRAX_AND_FXS_OWNER,
		...
		console.log(
			...
			new BigNumber(await pair_instance_FRAX_IQ.balanceOf(MIGRATOR_ADDRESS)).div(BIG18).toNumber(),
		);
		console.log(
			'accounts[1] staked lockedLiquidityOf:',
			new BigNumber(await stakingInstanceDualV5_FRAX_OHM.lockedLiquidityOf(COLLATERAL_FRAX_AND_FXS_OWNER))
				.div(BIG18)
				.toNumber(),
		);
		console.log(
			'accounts[1] staked combinedWeightOf:',
			new BigNumber(await stakingInstanceDualV5_FRAX_OHM.combinedWeightOf(COLLATERAL_FRAX_AND_FXS_OWNER))
				.div(BIG18)
				.toNumber(),
		);
		...
		await pair_instance_FRAX_IQ.approve(stakingInstanceDualV5_FRAX_OHM.address, proxy_stake_lock_amt, {
			from: MIGRATOR_ADDRESS,
		});
		await stakingInstanceDualV5_FRAX_OHM.migrator_stakeLocked_for(
			COLLATERAL_FRAX_AND_FXS_OWNER,
	...
	it('Fail Tests ', async () => {
		...
		await expectRevert(
			stakingInstanceDualV5_FRAX_OHM.migrator_withdraw_locked(
				COLLATERAL_FRAX_AND_FXS_OWNER,
				locked_stake_structs[2].kek_id,
				{ from: MIGRATOR_ADDRESS },
			),
		...
		await expectRevert(
			stakingInstanceDualV5_FRAX_OHM.migrator_stakeLocked_for(
				COLLATERAL_FRAX_AND_FXS_OWNER,
				test_amount_1,
				28 * 86400,
				{ from: MIGRATOR_ADDRESS },
		...
		await expectRevert(
			stakingInstanceDualV5_FRAX_OHM.stakerAllowMigrator(INVESTOR_CUSTODIAN_ADDRESS, {
				from: COLLATERAL_FRAX_AND_FXS_OWNER,
			}),
		...
		await expectRevert(
			stakingInstanceDualV5_FRAX_OHM.recoverERC20(pair_instance_FRAX_IQ.address, test_amount_1, {
				from: STAKING_OWNER,
			}),
			'Not in migration',
		);
		...
		await pair_instance_FRAX_IQ.approve(stakingInstanceDualV5_FRAX_OHM.address, test_amount_1, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await expectRevert(
			stakingInstanceDualV5_FRAX_OHM.stakeLocked(test_amount_1, 28 * 86400, {
				from: COLLATERAL_FRAX_AND_FXS_OWNER,
			}),
		...
		await stakingInstanceDualV5_FRAX_OHM.stakerDisallowMigrator(MIGRATOR_ADDRESS, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
