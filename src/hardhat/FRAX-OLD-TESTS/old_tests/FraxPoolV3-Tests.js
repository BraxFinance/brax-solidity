...
contract('FraxPoolV3-Tests', async (accounts) => {
	...
	it('Initialization related', async () => {
		...
		if (START_WITH_ORACLE_WRAPPERS) {
			...
			await frax_instance.setFRAXEthOracle(
				frax_oracle_wrapper_instance.address,
				'0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2',
				{ from: ORIGINAL_FRAX_ONE_ADDRESS },
			);
			...
			await frax_instance.setFXSEthOracle(
				fxs_oracle_wrapper_instance.address,
				'0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2',
				{ from: ORIGINAL_FRAX_ONE_ADDRESS },
			);
			...
			console.log(
				'FXS price:',
				new BigNumber(await fxs_oracle_wrapper_instance.getFXSPrice()).div(BIG6).toNumber(),
			);
		} else {
	...
	it('Main tests', async () => {
		...
		const SLIPPAGE_MULTIPLIER = 0.975;
		...
		console.log(
			'getFRAXInCollateral: ',
			new BigNumber(await pool_instance_v3.getFRAXInCollateral.call(col_idx_lusd, FRAX_AMOUNT))
				.div(BIG18)
				.toNumber(),
		);
		const lusd_mint_result_CALL = await pool_instance_v3.mintFrax.call(col_idx_lusd, FRAX_AMOUNT, FRAX_OUT_MIN, 0, {
			from: accounts[9],
		});
		...
		console.log(
			'getFRAXInCollateral: ',
			new BigNumber(await pool_instance_v3.getFRAXInCollateral.call(col_idx_susd, FRAX_AMOUNT))
				.div(BIG18)
				.toNumber(),
		);
		const susd_mint_result_CALL = await pool_instance_v3.mintFrax.call(col_idx_susd, FRAX_AMOUNT, FRAX_OUT_MIN, 0, {
			from: accounts[9],
		});
		...
		console.log(
			'getFRAXInCollateral: ',
			new BigNumber(await pool_instance_v3.getFRAXInCollateral.call(col_idx_usdp, FRAX_AMOUNT))
				.div(BIG18)
				.toNumber(),
		);
		const usdp_mint_result_CALL = await pool_instance_v3.mintFrax.call(col_idx_usdp, FRAX_AMOUNT, FRAX_OUT_MIN, 0, {
			from: accounts[9],
		});
		...
		console.log(
			'getFRAXInCollateral: ',
			new BigNumber(await pool_instance_v3.getFRAXInCollateral.call(col_idx_dai, FRAX_AMOUNT))
				.div(BIG18)
				.toNumber(),
		);
		const dai_mint_result_CALL = await pool_instance_v3.mintFrax.call(col_idx_dai, FRAX_AMOUNT, FRAX_OUT_MIN, 0, {
			from: accounts[9],
		});
		...
		console.log(
			'getFRAXInCollateral: ',
			new BigNumber(await pool_instance_v3.getFRAXInCollateral.call(col_idx_fei, FRAX_AMOUNT))
				.div(BIG18)
				.toNumber(),
		);
		const fei_mint_result_CALL = await pool_instance_v3.mintFrax.call(col_idx_fei, FRAX_AMOUNT, FRAX_OUT_MIN, 0, {
			from: accounts[9],
		});
		...
		console.log(
			'freeCollatBalance: ',
			new BigNumber(await pool_instance_v3.freeCollatBalance.call(5)).div(BIG6).toNumber(),
		);
		...
		console.log(
			'getFRAXInCollateral: ',
			new BigNumber(await pool_instance_v3.getFRAXInCollateral.call(col_idx_usdc, FRAX_AMOUNT))
				.div(BIG6)
				.toNumber(),
		);
		const usdc_mint_result_CALL = await pool_instance_v3.mintFrax.call(col_idx_usdc, FRAX_AMOUNT, FRAX_OUT_MIN, 0, {
			from: accounts[9],
		});
		...
		const SLIPPAGE_MULTIPLIER_M1T1 = 0.975;
		const FRAX_AMOUNT_M1T1 = new BigNumber('100e18');
		const FRAX_OUT_MIN_M1T1 = FRAX_AMOUNT_M1T1.multipliedBy(SLIPPAGE_MULTIPLIER_M1T1).integerValue(
		...
		console.log(
			'getFRAXInCollateral: ',
			new BigNumber(await pool_instance_v3.getFRAXInCollateral.call(col_idx_lusd, FRAX_AMOUNT_M1T1))
				.div(BIG18)
				.toNumber(),
		);
		const lusd_mint_result_CALL_M1T1 = await pool_instance_v3.mintFrax.call(
			col_idx_lusd,
			FRAX_AMOUNT_M1T1,
			FRAX_OUT_MIN_M1T1,
			1,
		...
		console.log(
			'getFRAXInCollateral: ',
			new BigNumber(await pool_instance_v3.getFRAXInCollateral.call(col_idx_susd, FRAX_AMOUNT_M1T1))
				.div(BIG18)
				.toNumber(),
		);
		const susd_mint_result_CALL_M1T1 = await pool_instance_v3.mintFrax.call(
			col_idx_susd,
			FRAX_AMOUNT_M1T1,
			FRAX_OUT_MIN_M1T1,
			1,
		...
		console.log(
			'getFRAXInCollateral: ',
			new BigNumber(await pool_instance_v3.getFRAXInCollateral.call(col_idx_usdp, FRAX_AMOUNT_M1T1))
				.div(BIG18)
				.toNumber(),
		);
		const usdp_mint_result_CALL_M1T1 = await pool_instance_v3.mintFrax.call(
			col_idx_usdp,
			FRAX_AMOUNT_M1T1,
			FRAX_OUT_MIN_M1T1,
			1,
		...
		console.log(
			'getFRAXInCollateral: ',
			new BigNumber(await pool_instance_v3.getFRAXInCollateral.call(col_idx_dai, FRAX_AMOUNT_M1T1))
				.div(BIG18)
				.toNumber(),
		);
		const dai_mint_result_CALL_M1T1 = await pool_instance_v3.mintFrax.call(
			col_idx_dai,
			FRAX_AMOUNT_M1T1,
			FRAX_OUT_MIN_M1T1,
			1,
		...
		console.log(
			'getFRAXInCollateral: ',
			new BigNumber(await pool_instance_v3.getFRAXInCollateral.call(col_idx_fei, FRAX_AMOUNT_M1T1))
				.div(BIG18)
				.toNumber(),
		);
		const fei_mint_result_CALL_M1T1 = await pool_instance_v3.mintFrax.call(
			col_idx_fei,
			FRAX_AMOUNT_M1T1,
			FRAX_OUT_MIN_M1T1,
			1,
		...
		console.log(
			'getFRAXInCollateral: ',
			new BigNumber(await pool_instance_v3.getFRAXInCollateral.call(col_idx_usdc, FRAX_AMOUNT_M1T1))
				.div(BIG6)
				.toNumber(),
		);
		const usdc_mint_result_CALL_M1T1 = await pool_instance_v3.mintFrax.call(
			col_idx_usdc,
			FRAX_AMOUNT_M1T1,
			FRAX_OUT_MIN_M1T1,
			1,
		...
		const FRAX_FOR_COLLAT_RDM = FRAX_AMOUNT_RDM_SLIPPED.multipliedBy(global_cr)
			.div(BIG6)
		...
		await expectRevert(
			pool_instance_v3.redeemFrax(col_idx_lusd, FRAX_AMOUNT_RDM, FXS_OUT_MIN_RDM, COL_OUT_MIN_LUSD, {
				from: accounts[9],
			}),
			'Frax price too high',
		);
		...
		const lusd_redeem_result_CALL = await pool_instance_v3.redeemFrax.call(
			col_idx_lusd,
			FRAX_AMOUNT_RDM,
			FXS_OUT_MIN_RDM,
			COL_OUT_MIN_LUSD,
		...
		await pool_instance_v3.redeemFrax(col_idx_lusd, FRAX_AMOUNT_RDM, FXS_OUT_MIN_RDM, COL_OUT_MIN_LUSD, {
			from: accounts[9],
		});

		// Make sure an early redemption fails
		await expectRevert(pool_instance_v3.collectRedemption(col_idx_lusd, { from: accounts[9] }), 'Too soon');
		...
		const susd_redeem_result_CALL = await pool_instance_v3.redeemFrax.call(
			col_idx_susd,
			FRAX_AMOUNT_RDM,
			FXS_OUT_MIN_RDM,
			COL_OUT_MIN_sUSD,
		...
		await pool_instance_v3.redeemFrax(col_idx_susd, FRAX_AMOUNT_RDM, FXS_OUT_MIN_RDM, COL_OUT_MIN_sUSD, {
			from: accounts[9],
		});

		// Make sure an early redemption fails
		await expectRevert(pool_instance_v3.collectRedemption(col_idx_susd, { from: accounts[9] }), 'Too soon');
		...
		const usdp_redeem_result_CALL = await pool_instance_v3.redeemFrax.call(
			col_idx_usdp,
			FRAX_AMOUNT_RDM,
			FXS_OUT_MIN_RDM,
			COL_OUT_MIN_USDP,
		...
		await pool_instance_v3.redeemFrax(col_idx_usdp, FRAX_AMOUNT_RDM, FXS_OUT_MIN_RDM, COL_OUT_MIN_USDP, {
			from: accounts[9],
		});

		// Make sure an early redemption fails
		await expectRevert(pool_instance_v3.collectRedemption(col_idx_usdp, { from: accounts[9] }), 'Too soon');
		...
		const dai_redeem_result_CALL = await pool_instance_v3.redeemFrax.call(
			col_idx_dai,
			FRAX_AMOUNT_RDM,
			FXS_OUT_MIN_RDM,
			COL_OUT_MIN_DAI,
		...
		await pool_instance_v3.redeemFrax(col_idx_dai, FRAX_AMOUNT_RDM, FXS_OUT_MIN_RDM, COL_OUT_MIN_DAI, {
			from: accounts[9],
		});

		// Make sure an early redemption fails
		await expectRevert(pool_instance_v3.collectRedemption(col_idx_dai, { from: accounts[9] }), 'Too soon');
		...
		const fei_redeem_result_CALL = await pool_instance_v3.redeemFrax.call(
			col_idx_fei,
			FRAX_AMOUNT_RDM,
			FXS_OUT_MIN_RDM,
			COL_OUT_MIN_FEI,
		...
		await pool_instance_v3.redeemFrax(col_idx_fei, FRAX_AMOUNT_RDM, FXS_OUT_MIN_RDM, COL_OUT_MIN_FEI, {
			from: accounts[9],
		});

		// Make sure an early redemption fails
		await expectRevert(pool_instance_v3.collectRedemption(col_idx_fei, { from: accounts[9] }), 'Too soon');
		...
		const usdc_redeem_result_CALL = await pool_instance_v3.redeemFrax.call(
			col_idx_usdc,
			FRAX_AMOUNT_RDM,
			FXS_OUT_MIN_RDM,
			COL_OUT_MIN_USDC,
		...
		await pool_instance_v3.redeemFrax(col_idx_usdc, FRAX_AMOUNT_RDM, FXS_OUT_MIN_RDM, COL_OUT_MIN_USDC, {
			from: accounts[9],
		});

		// Make sure an early redemption fails
		await expectRevert(pool_instance_v3.collectRedemption(col_idx_usdc, { from: accounts[9] }), 'Too soon');
		...
		const FXS_OUT_MIN_LUSD_RCLT = COLLAT_AMT_LUSD_RCLT_DV.multipliedBy(BIG6)
			.div(fxs_price)
			.integerValue(BigNumber.ROUND_FLOOR);
		const FXS_OUT_MIN_sUSD_RCLT = COLLAT_AMT_sUSD_RCLT_DV.multipliedBy(BIG6)
			.div(fxs_price)
			.integerValue(BigNumber.ROUND_FLOOR);
		const FXS_OUT_MIN_USDP_RCLT = COLLAT_AMT_USDP_RCLT_DV.multipliedBy(BIG6)
			.div(fxs_price)
			.integerValue(BigNumber.ROUND_FLOOR);
		const FXS_OUT_MIN_DAI_RCLT = COLLAT_AMT_DAI_RCLT_DV.multipliedBy(BIG6)
			.div(fxs_price)
			.integerValue(BigNumber.ROUND_FLOOR);
		const FXS_OUT_MIN_FEI_RCLT = COLLAT_AMT_FEI_RCLT_DV.multipliedBy(BIG6)
			.div(fxs_price)
			.integerValue(BigNumber.ROUND_FLOOR);
		const FXS_OUT_MIN_USDC_RCLT = COLLAT_AMT_USDC_RCLT_DV.multipliedBy(BIG6)
			.div(fxs_price)
			.integerValue(BigNumber.ROUND_FLOOR);
		...
		console.log(
			...
			new BigNumber(await pool_instance_v3.buybackAvailableCollat.call()).div(BIG18).toNumber(),
		);
		console.log(
			'recollatTheoColAvailableE18: ',
			new BigNumber(await pool_instance_v3.recollatTheoColAvailableE18.call()).div(BIG18).toNumber(),
		);
		console.log(
			'recollatAvailableFxs: ',
			new BigNumber(await pool_instance_v3.recollatAvailableFxs.call()).div(BIG18).toNumber(),
		);
		...
		const lusd_recollat_result_CALL = await pool_instance_v3.recollateralize.call(
			col_idx_lusd,
			COLLAT_AMT_RCLT,
			FXS_OUT_MIN_LUSD_RCLT,
			{ from: accounts[9] },
		);
		await pool_instance_v3.recollateralize(col_idx_lusd, COLLAT_AMT_RCLT, FXS_OUT_MIN_LUSD_RCLT, {
			from: accounts[9],
		});
		...
		const susd_recollat_result_CALL = await pool_instance_v3.recollateralize.call(
			col_idx_susd,
			COLLAT_AMT_RCLT,
			FXS_OUT_MIN_sUSD_RCLT,
			{ from: accounts[9] },
		);
		await pool_instance_v3.recollateralize(col_idx_susd, COLLAT_AMT_RCLT, FXS_OUT_MIN_sUSD_RCLT, {
			from: accounts[9],
		});
		...
		const usdp_recollat_result_CALL = await pool_instance_v3.recollateralize.call(
			col_idx_usdp,
			COLLAT_AMT_RCLT,
			FXS_OUT_MIN_USDP_RCLT,
			{ from: accounts[9] },
		);
		await pool_instance_v3.recollateralize(col_idx_usdp, COLLAT_AMT_RCLT, FXS_OUT_MIN_USDP_RCLT, {
			from: accounts[9],
		});
		...
		const dai_recollat_result_CALL = await pool_instance_v3.recollateralize.call(
			col_idx_dai,
			COLLAT_AMT_RCLT,
			FXS_OUT_MIN_DAI_RCLT,
			{ from: accounts[9] },
		);
		await pool_instance_v3.recollateralize(col_idx_dai, COLLAT_AMT_RCLT, FXS_OUT_MIN_DAI_RCLT, {
			from: accounts[9],
		});
		...
		const fei_recollat_result_CALL = await pool_instance_v3.recollateralize.call(
			col_idx_fei,
			COLLAT_AMT_RCLT,
			FXS_OUT_MIN_FEI_RCLT,
			{ from: accounts[9] },
		);
		await pool_instance_v3.recollateralize(col_idx_fei, COLLAT_AMT_RCLT, FXS_OUT_MIN_FEI_RCLT, {
			from: accounts[9],
		});
		...
		const usdc_recollat_result_CALL = await pool_instance_v3.recollateralize.call(
			col_idx_usdc,
			COLLAT_AMT_RCLT_E6,
			FXS_OUT_MIN_USDC_RCLT,
			{ from: accounts[9] },
		);
		await pool_instance_v3.recollateralize(col_idx_usdc, COLLAT_AMT_RCLT_E6, FXS_OUT_MIN_USDC_RCLT, {
			from: accounts[9],
		});
		...
		await usdc_instance.transfer('0x1864Ca3d47AaB98Ee78D11fc9DCC5E7bADdA1c0d', usdc_to_dump_in, {
			from: ADDRESS_WITH_USDC,
		});
		...
		const lusd_buyback_result_CALL = await pool_instance_v3.buyBackFxs.call(
			col_idx_lusd,
			FXS_AMT_BBK,
			COL_OUT_MIN_LUSD_BBK,
			{ from: accounts[9] },
		);
		...
		const susd_buyback_result_CALL = await pool_instance_v3.buyBackFxs.call(
			col_idx_susd,
			FXS_AMT_BBK,
			COL_OUT_MIN_sUSD_BBK,
			{ from: accounts[9] },
		);
		...
		const usdp_buyback_result_CALL = await pool_instance_v3.buyBackFxs.call(
			col_idx_usdp,
			FXS_AMT_BBK,
			COL_OUT_MIN_USDP_BBK,
			{ from: accounts[9] },
		);
		...
		const dai_buyback_result_CALL = await pool_instance_v3.buyBackFxs.call(
			col_idx_dai,
			FXS_AMT_BBK,
			COL_OUT_MIN_DAI_BBK,
			{ from: accounts[9] },
		...
		const fei_buyback_result_CALL = await pool_instance_v3.buyBackFxs.call(
			col_idx_fei,
			FXS_AMT_BBK,
			COL_OUT_MIN_FEI_BBK,
			{ from: accounts[9] },
		...
		const usdc_buyback_result_CALL = await pool_instance_v3.buyBackFxs.call(col_idx_usdc, FXS_AMT_BBK, 0, {
			from: accounts[9],
		});
	...
	it('Buyback Fail Tests ', async () => {
		...
		await pool_instance_v3.setBbkRctPerHour(new BigNumber('1e18'), new BigNumber('1000e18'), {
			from: POOL_CREATOR,
		});
		...
		await pool_instance_v3.setBbkRctPerHour(new BigNumber('1000e18'), new BigNumber('1000e18'), {
			from: POOL_CREATOR,
		});
	...
	it('Recollat Fail Tests ', async () => {
		...
		console.log(
			'Unclaimed LUSD: ',
			new BigNumber(await pool_instance_v3.unclaimedPoolCollateral.call(col_idx_lusd)).div(BIG18).toNumber(),
		);
		console.log(
			'Unclaimed sUSD: ',
			new BigNumber(await pool_instance_v3.unclaimedPoolCollateral.call(col_idx_susd)).div(BIG18).toNumber(),
		);
		console.log(
			'Unclaimed USDP: ',
			new BigNumber(await pool_instance_v3.unclaimedPoolCollateral.call(col_idx_usdp)).div(BIG18).toNumber(),
		);
		console.log(
			'Unclaimed DAI: ',
			new BigNumber(await pool_instance_v3.unclaimedPoolCollateral.call(col_idx_dai)).div(BIG18).toNumber(),
		);
		console.log(
			'Unclaimed FEI: ',
			new BigNumber(await pool_instance_v3.unclaimedPoolCollateral.call(col_idx_fei)).div(BIG18).toNumber(),
		);
		console.log(
			'Unclaimed USDC: ',
			new BigNumber(await pool_instance_v3.unclaimedPoolCollateral.call(col_idx_usdc)).div(BIG6).toNumber(),
		);
		...
		console.log(
			...
			new BigNumber(await frax_instance.globalCollateralValue.call()).div(BIG18).toNumber(),
		);
		console.log(
		...
		console.log(
			'collatDollarBalance: ',
			new BigNumber(await pool_instance_v3.collatDollarBalance.call()).div(BIG18).toNumber(),
		);
		...
		console.log('Set the throttle low');
		await pool_instance_v3.setBbkRctPerHour(new BigNumber('1000e18'), new BigNumber('1e18'), {
			from: POOL_CREATOR,
		});

		await pool_instance_v3.recollateralize(col_idx_lusd, OVERTHROTTLED_RECOLLAT_COLLAT_AMT, 0, {
			from: accounts[9],
		});
		await expectRevert(
		...
		await expectRevert(
			pool_instance_v3.recollateralize(col_idx_usdc, DISABLED_RECOLLAT_COLLAT_AMOUNT_E6, 0, {
				from: accounts[9],
			}),
			'Collateral disabled',
		);
	...
	it('Redeem Fail Tests ', async () => {
		...
		const FRAX_FOR_COLLAT_RDM = FRAX_AMOUNT_TEST_RDM_SLIPPED.multipliedBy(global_cr)
			.div(BIG6)
			.integerValue(BigNumber.ROUND_FLOOR);
		const FRAX_FOR_FXS_RDM = FRAX_AMOUNT_TEST_RDM_SLIPPED.minus(FRAX_FOR_COLLAT_RDM);
		const FXS_OUT_MIN_TEST_RDM = FRAX_FOR_FXS_RDM.multipliedBy(BIG6)
			.div(fxs_price)
			.integerValue(BigNumber.ROUND_FLOOR);
		...
		await expectRevert(
			pool_instance_v3.redeemFrax(col_idx_dai, FRAX_AMOUNT_TEST_RDM, FXS_OUT_MIN_TEST_RDM, 0, {
				from: accounts[9],
			}),
			'Frax price too high',
		);
