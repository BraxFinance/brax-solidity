...
module.exports = async (deployer) => {
	...
	// Bridges
	cross_chain_bridge_backer_instance = await CrossChainBridgeBacker_AVAX_AnySwap.at(
	...
	// AMOs
	pangolin_liquidity_amo_instance = await PangolinLiquidityAMO.at(
		CONTRACT_ADDRESSES.avalanche.amos.pangolin_liquidity,
	);
	...
	await cross_chain_bridge_backer_instance.addAMO(axial_amo_instance.address, false, {
