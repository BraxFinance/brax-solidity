...
// Bridges
const CrossChainBridgeBacker_POLY_MaticBridge = artifacts.require(
	'Bridges/Polygon/CrossChainBridgeBacker_POLY_MaticBridge',
);
...
contract('CrossChainBridgeBacker_POLY_MaticBridge-Tests', async (accounts) => {
	...
	it('Main test', async () => {
		...
		await polyFRAX_instance.transfer(COLLATERAL_FRAX_AND_FXS_OWNER, new BigNumber('10000e18'), {
			from: ADDRESS_WITH_POLYFRAX,
		});
		...
		await polyFXS_instance.transfer(COLLATERAL_FRAX_AND_FXS_OWNER, new BigNumber('10000e18'), {
			from: ADDRESS_WITH_POLYFXS,
		});
		...
		await polyUSDC_instance.transfer(COLLATERAL_FRAX_AND_FXS_OWNER, new BigNumber('10000e6'), {
			from: ADDRESS_WITH_POLYUSDC,
		});
		...
		await canFRAX_instance.nominateNewOwner(COLLATERAL_FRAX_AND_FXS_OWNER, {
			from: process.env.POLYGON_ONE_ADDRESS,
		});

		console.log(chalk.yellow('========== SET COLLATERAL_FRAX_AND_FXS_OWNER AS THE canFXS OWNER  =========='));
		await canFXS_instance.nominateNewOwner(COLLATERAL_FRAX_AND_FXS_OWNER, {
			from: process.env.POLYGON_ONE_ADDRESS,
		});
		...
		await canFRAX_instance.minter_mint(GOVERNOR_GUARDIAN_ADDRESS, new BigNumber('100000e18'), {
			from: GOVERNOR_GUARDIAN_ADDRESS,
		});
		await canFXS_instance.minter_mint(GOVERNOR_GUARDIAN_ADDRESS, new BigNumber('100000e18'), {
			from: GOVERNOR_GUARDIAN_ADDRESS,
		});

		console.log('Give the canFRAX and canFXS contracts some old tokens');
		await polyFRAX_instance.transfer(canFRAX_instance.address, new BigNumber('5000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await polyFXS_instance.transfer(canFXS_instance.address, new BigNumber('5000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold(
					'=========================GIVE THE BRIDGE BACKER SOME canFRAX AND canFXS=========================',
				),
		);
		...
		await canFRAX_instance.transfer(cc_bridge_backer_instance.address, initial_dump_amt_canToken, {
			from: GOVERNOR_GUARDIAN_ADDRESS,
		});
		await canFXS_instance.transfer(cc_bridge_backer_instance.address, initial_dump_amt_canToken, {
			from: GOVERNOR_GUARDIAN_ADDRESS,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('=========================DUMP IN SOME polyFRAX [SIMULATES BRIDGE]========================='),
		);
		const dump_amt_polyFRAX = new BigNumber('1025e18');
		console.log('dump_amt_polyFRAX: ', dump_amt_polyFRAX.div(BIG18).toNumber());

		await polyFRAX_instance.transfer(cc_bridge_backer_instance.address, dump_amt_polyFRAX, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('=========================DUMP IN SOME polyFXS [SIMULATES BRIDGE]========================='),
		);
		const dump_amt_polyFXS = new BigNumber('1025e18');
		console.log('dump_amt_polyFXS: ', dump_amt_polyFXS.div(BIG18).toNumber());

		await polyFXS_instance.transfer(cc_bridge_backer_instance.address, dump_amt_polyFXS, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk.hex('#ff8b3d').bold('=====================DUMP IN SOME USDC [SIMULATES BRIDGE]====================='),
		);
		const dump_amt_USDC = new BigNumber('1025e6');
		console.log('dump_amt_USDC: ', dump_amt_USDC.div(BIG6).toNumber());

		await polyUSDC_instance.transfer(cc_bridge_backer_instance.address, dump_amt_USDC, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold(
					'===========================SELF-BRIDGE SOME TOKENS OVER [with internal swap]===========================',
				),
		);
		...
		await cc_bridge_backer_instance.selfBridge(0, self_bridge_swap_amt_E18, true, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Self-Bridge back canFXS (internal swap to polyFXS included)');
		await cc_bridge_backer_instance.selfBridge(1, self_bridge_swap_amt_E18, true, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Self-Bridge back polyUSDC');
		await cc_bridge_backer_instance.selfBridge(2, self_bridge_swap_amt_E6, true, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold(
					'===========================SELF-BRIDGE SOME TOKENS OVER [no internal swap]===========================',
				),
		);
		...
		await cc_bridge_backer_instance.selfBridge(0, self_bridge_no_swap_amt_E18, false, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Self-Bridge back canFXS (no internal swap to polyFXS)');
		await cc_bridge_backer_instance.selfBridge(1, self_bridge_no_swap_amt_E18, false, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Self-Bridge back polyUSDC');
		await cc_bridge_backer_instance.selfBridge(2, self_bridge_no_swap_amt_E6, false, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================GIVE THE canFRAX CONTRACT SOME polyFRAX ==========================='),
		);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================SWAP polyFRAX for canFRAX manually==========================='),
		);
		...
		await cc_bridge_backer_instance.swapAnyForCanonical(0, swapAnyForCanonical_amt_polyFRAX, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================SWAP polyFXS for canFXS manually==========================='),
		);
		...
		await cc_bridge_backer_instance.swapAnyForCanonical(1, swapAnyForCanonical_amt_polyFXS, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================MINT SOME canFRAX and polyFRAX==========================='),
		);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================BURN SOME canFRAX and polyFRAX==========================='),
		);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================COLLECT SOME polyFRAX AND polyFXS==========================='),
		);
		const canToken_collect_amt = new BigNumber('1e18');
		console.log('canToken_collect_amt: ', canToken_collect_amt.div(BIG18).toNumber());

		await cc_bridge_backer_instance.collectBridgeTokens(0, polyFRAX_instance.address, canToken_collect_amt, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await cc_bridge_backer_instance.collectBridgeTokens(1, polyFXS_instance.address, canToken_collect_amt, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================ADD A WALLET ADDRESS AS AN AMO==========================='),
		);
		await cc_bridge_backer_instance.addAMO(STAKING_REWARDS_DISTRIBUTOR, true, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold(
					'===========================NOTE SOME SushiSwapLiquidityAMO_POLY INFO===========================',
				),
		);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================GIVE SOME TOKENS TO AMOS [EOA]==========================='),
		);
		let amo_canFRAX_bal_before = new BigNumber(await canFRAX_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		let amo_canFXS_bal_before = new BigNumber(await canFXS_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		let amo_usdc_bal_before = new BigNumber(await polyUSDC_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG6)
			.toNumber();

		console.log('Lend 100 canFRAX');
		await cc_bridge_backer_instance.lendFraxToAMO(STAKING_REWARDS_DISTRIBUTOR, new BigNumber('100e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Lend 100 canFXS');
		await cc_bridge_backer_instance.lendFxsToAMO(STAKING_REWARDS_DISTRIBUTOR, new BigNumber('100e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Lend 100 polyUSDC');
		await cc_bridge_backer_instance.lendCollatToAMO(STAKING_REWARDS_DISTRIBUTOR, new BigNumber('100e6'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		let amo_canFRAX_bal_after = new BigNumber(await canFRAX_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		let amo_canFXS_bal_after = new BigNumber(await canFXS_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		let amo_usdc_bal_after = new BigNumber(await polyUSDC_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG6)
			.toNumber();
		...
		console.log(
			'FRAX balance [STAKING_REWARDS_DISTRIBUTOR] change: ',
			amo_canFRAX_bal_after - amo_canFRAX_bal_before,
		);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold(
					'===========================GIVE SOME TOKENS TO AMOS [SMART CONTRACT]===========================',
				),
		);

		console.log('Lend 100 canFRAX');
		await cc_bridge_backer_instance.lendFraxToAMO(
			SushiSwapLiquidityAMO_POLY_instance.address,
			new BigNumber('100e18'),
			{ from: COLLATERAL_FRAX_AND_FXS_OWNER },
		);

		console.log('Lend 100 canFXS');
		await cc_bridge_backer_instance.lendFxsToAMO(
			SushiSwapLiquidityAMO_POLY_instance.address,
			new BigNumber('100e18'),
			{ from: COLLATERAL_FRAX_AND_FXS_OWNER },
		);
		...
		console.log('Lend 100 polyUSDC');
		await cc_bridge_backer_instance.lendCollatToAMO(
			SushiSwapLiquidityAMO_POLY_instance.address,
			new BigNumber('100e6'),
			{ from: COLLATERAL_FRAX_AND_FXS_OWNER },
		);
		...
		utilities.printAllocations(
			'SushiSwapLiquidityAMO_POLY',
			the_allocations_sushiswap_amo,
			old_allocations_sushiswap_amo,
		);
		utilities.printTokenBalances(
			'SushiSwapLiquidityAMO_POLY',
			the_token_balances_sushiswap_amo,
			old_balances_sushiswap_amo,
		);

		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================AMO GIVES BACK TOKENS [EOA, NO BRIDGE]==========================='),
		);
		amo_canFRAX_bal_before = new BigNumber(await canFRAX_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		amo_canFXS_bal_before = new BigNumber(await canFXS_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		amo_usdc_bal_before = new BigNumber(await polyUSDC_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG6)
			.toNumber();

		console.log('Give 25 canFRAX');
		await canFRAX_instance.approve(cc_bridge_backer_instance.address, new BigNumber('25e18'), {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		await cc_bridge_backer_instance.receiveBackViaAMO(canFRAX_instance.address, new BigNumber('25e18'), false, {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});

		console.log('Give 25 canFXS');
		await canFXS_instance.approve(cc_bridge_backer_instance.address, new BigNumber('25e18'), {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		await cc_bridge_backer_instance.receiveBackViaAMO(canFXS_instance.address, new BigNumber('25e18'), false, {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});

		console.log('Give 25 polyUSDC');
		await polyUSDC_instance.approve(cc_bridge_backer_instance.address, new BigNumber('25e6'), {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		await cc_bridge_backer_instance.receiveBackViaAMO(polyUSDC_instance.address, new BigNumber('25e6'), false, {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});

		amo_canFRAX_bal_after = new BigNumber(await canFRAX_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		amo_canFXS_bal_after = new BigNumber(await canFXS_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		amo_usdc_bal_after = new BigNumber(await polyUSDC_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG6)
			.toNumber();
		...
		console.log(
			'canFRAX balance [STAKING_REWARDS_DISTRIBUTOR] change: ',
			amo_canFRAX_bal_after - amo_canFRAX_bal_before,
		);
		console.log(
			'canFXS balance [STAKING_REWARDS_DISTRIBUTOR] change: ',
			amo_canFXS_bal_after - amo_canFXS_bal_before,
		);
		console.log(
			'polyUSDC balance [STAKING_REWARDS_DISTRIBUTOR] change: ',
			amo_usdc_bal_after - amo_usdc_bal_before,
		);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold(
					'===========================AMO GIVES BACK TOKENS [SMART CONTRACT, NO BRIDGE]===========================',
				),
		);

		console.log('Give back 25 canFRAX');
		await SushiSwapLiquidityAMO_POLY_instance.giveFRAXBack(new BigNumber('25e18'), false, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Give back 25 canFXS');
		await SushiSwapLiquidityAMO_POLY_instance.giveFXSBack(new BigNumber('25e18'), false, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Give back 25 polyUSDC');
		await SushiSwapLiquidityAMO_POLY_instance.giveCollatBack(new BigNumber('25e6'), false, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================AMO GIVES BACK TOKENS [EOA, WITH BRIDGE]==========================='),
		);
		amo_canFRAX_bal_before = new BigNumber(await canFRAX_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		...
		await canFRAX_instance.approve(cc_bridge_backer_instance.address, new BigNumber('1e18'), {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		await cc_bridge_backer_instance.receiveBackViaAMO(canFRAX_instance.address, new BigNumber('1e18'), true, {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});

		console.log('Give 1 canFXS');
		await canFXS_instance.approve(cc_bridge_backer_instance.address, new BigNumber('1e18'), {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		await cc_bridge_backer_instance.receiveBackViaAMO(canFXS_instance.address, new BigNumber('1e18'), true, {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});

		console.log('Give 1 polyUSDC');
		await polyUSDC_instance.approve(cc_bridge_backer_instance.address, new BigNumber('1e6'), {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		await cc_bridge_backer_instance.receiveBackViaAMO(polyUSDC_instance.address, new BigNumber('1e6'), true, {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold(
					'===========================AMO GIVES BACK TOKENS [SMART CONTRACT, WITH BRIDGE]===========================',
				),
		);

		console.log('Give 1 canFRAX');
		await SushiSwapLiquidityAMO_POLY_instance.giveFRAXBack(new BigNumber('1e18'), true, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Give 1 canFXS');
		await SushiSwapLiquidityAMO_POLY_instance.giveFXSBack(new BigNumber('1e18'), true, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Give 1 polyUSDC');
		await SushiSwapLiquidityAMO_POLY_instance.giveCollatBack(new BigNumber('1e6'), true, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		await cc_bridge_backer_instance.execute(polyFRAX_instance.address, 0, calldata, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
