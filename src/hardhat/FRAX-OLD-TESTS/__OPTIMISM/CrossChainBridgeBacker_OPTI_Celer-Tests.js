...
contract('CrossChainBridgeBacker_OPTI_Celer-Tests', async (accounts) => {
	...
	it('Main test', async () => {
		...
		await celrFRAX_instance.transfer(COLLATERAL_FRAX_AND_FXS_OWNER, new BigNumber('10000e18'), {
			from: ADDRESS_WITH_CELRFRAX,
		});
		...
		await celrFXS_instance.transfer(COLLATERAL_FRAX_AND_FXS_OWNER, new BigNumber('1000e18'), {
			from: ADDRESS_WITH_CELRFXS,
		});
		...
		console.log(
			chalk.yellow(
				'========== GIVE COLLATERAL_FRAX_AND_FXS_OWNER and STAKING_REWARDS_DISTRIBUTOR SOME celrUSDC  ==========',
			),
		);
		await celrUSDC_instance.transfer(COLLATERAL_FRAX_AND_FXS_OWNER, new BigNumber('5000e6'), {
			from: ADDRESS_WITH_OPTIUSDC,
		});
		await celrUSDC_instance.transfer(STAKING_REWARDS_DISTRIBUTOR, new BigNumber('100e6'), {
			from: ADDRESS_WITH_OPTIUSDC,
		});
		...
		await canFRAX_instance.nominateNewOwner(COLLATERAL_FRAX_AND_FXS_OWNER, {
			from: process.env.OPTIMISM_ONE_ADDRESS,
		});
		...
		await celrFRAX_instance.transfer(canFRAX_instance.address, new BigNumber('5000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await celrFXS_instance.transfer(canFXS_instance.address, new BigNumber('500e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Set the bridge backer as fee exempt');
		await canFRAX_instance.toggleFeesForAddress(cc_bridge_backer_instance.address, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await canFXS_instance.toggleFeesForAddress(cc_bridge_backer_instance.address, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('=========================DUMP IN SOME celrFRAX [SIMULATES BRIDGE]========================='),
		);
		const dump_amt_celrFRAX = new BigNumber('125e18');
		console.log('dump_amt_celrFRAX: ', dump_amt_celrFRAX.div(BIG18).toNumber());

		await celrFRAX_instance.transfer(cc_bridge_backer_instance.address, dump_amt_celrFRAX, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('=========================DUMP IN SOME celrFXS [SIMULATES BRIDGE]========================='),
		);
		const dump_amt_celrFXS = new BigNumber('50e18');
		console.log('dump_amt_celrFXS: ', dump_amt_celrFXS.div(BIG18).toNumber());

		await celrFXS_instance.transfer(cc_bridge_backer_instance.address, dump_amt_celrFXS, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		await celrUSDC_instance.transfer(cc_bridge_backer_instance.address, dump_amt_USDC, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================GIVE THE canFRAX CONTRACT SOME celrFRAX ==========================='),
		);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================SWAP celrFRAX for canFRAX manually==========================='),
		);
		...
		await cc_bridge_backer_instance.swapAnyForCanonical(0, swapAnyForCanonical_amt_celrFRAX, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================SWAP celrFXS for canFXS manually==========================='),
		);
		...
		await cc_bridge_backer_instance.swapAnyForCanonical(1, swapAnyForCanonical_amt_celrFXS, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================MINT SOME canFRAX and celrFRAX==========================='),
		);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================BURN SOME canFRAX and celrFRAX==========================='),
		);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('==========COLLECT SOME celrFRAX AND celrFXS FROM THE CANONICAL CONTRACTS=========='),
		);
		const canToken_collect_amt = new BigNumber('1e18');
		console.log('canToken_collect_amt: ', canToken_collect_amt.div(BIG18).toNumber());

		await cc_bridge_backer_instance.collectBridgeTokens(0, celrFRAX_instance.address, canToken_collect_amt, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await cc_bridge_backer_instance.collectBridgeTokens(1, celrFXS_instance.address, canToken_collect_amt, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		let amo_canFXS_bal_before = new BigNumber(await canFXS_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		let amo_usdc_bal_before = new BigNumber(await celrUSDC_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG6)
			.toNumber();
		...
		await cc_bridge_backer_instance.lendFxsToAMO(STAKING_REWARDS_DISTRIBUTOR, new BigNumber('10e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Lend 10 celrUSDC');
		await cc_bridge_backer_instance.lendCollatToAMO(STAKING_REWARDS_DISTRIBUTOR, new BigNumber('10e6'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		let amo_canFXS_bal_after = new BigNumber(await canFXS_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		let amo_usdc_bal_after = new BigNumber(await celrUSDC_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG6)
			.toNumber();
		...
		amo_canFXS_bal_before = new BigNumber(await canFXS_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		amo_usdc_bal_before = new BigNumber(await celrUSDC_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG6)
			.toNumber();
		...
		await canFXS_instance.approve(cc_bridge_backer_instance.address, new BigNumber('5e18'), {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		await cc_bridge_backer_instance.receiveBackViaAMO(canFXS_instance.address, new BigNumber('5e18'), false, {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});

		console.log('Give 5 celrUSDC');
		await celrUSDC_instance.approve(cc_bridge_backer_instance.address, new BigNumber('5e6'), {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		await cc_bridge_backer_instance.receiveBackViaAMO(celrUSDC_instance.address, new BigNumber('5e6'), false, {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		...
		amo_canFXS_bal_after = new BigNumber(await canFXS_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		amo_usdc_bal_after = new BigNumber(await celrUSDC_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG6)
			.toNumber();
		...
		console.log(
			'celrUSDC balance [STAKING_REWARDS_DISTRIBUTOR] change: ',
		...
		await canFRAX_instance.minter_mint(STAKING_REWARDS_DISTRIBUTOR, new BigNumber('100e18'), {
			from: GOVERNOR_GUARDIAN_ADDRESS,
		});
		await canFXS_instance.minter_mint(STAKING_REWARDS_DISTRIBUTOR, new BigNumber('100e18'), {
			from: GOVERNOR_GUARDIAN_ADDRESS,
		});
		...
		await canFRAX_instance.approve(cc_bridge_backer_instance.address, new BigNumber('50e18'), {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		await cc_bridge_backer_instance.receiveBackViaAMO(canFRAX_instance.address, new BigNumber('50e18'), true, {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});

		console.log('Give 50 canFXS');
		await canFXS_instance.approve(cc_bridge_backer_instance.address, new BigNumber('20e18'), {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		await cc_bridge_backer_instance.receiveBackViaAMO(canFXS_instance.address, new BigNumber('20e18'), true, {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});

		console.log('Give 50 celrUSDC');
		await celrUSDC_instance.approve(cc_bridge_backer_instance.address, new BigNumber('50e6'), {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		await cc_bridge_backer_instance.receiveBackViaAMO(celrUSDC_instance.address, new BigNumber('50e6'), true, {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		...
		await cc_bridge_backer_instance.execute(celrFRAX_instance.address, 0, calldata, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
