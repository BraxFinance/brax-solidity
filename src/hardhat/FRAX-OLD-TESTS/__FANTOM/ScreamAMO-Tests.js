...
contract('ScreamAMO-Tests', async (accounts) => {
	...
	it('Main test', async () => {
		...
		await scream_instance.transfer(scream_amo_instance.address, new BigNumber('2500e18'), {
			from: ADDRESS_WITH_SCREAM,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('=========================GIVE THE ScreamAMO SOME canFRAX AND canFXS========================='),
		);
		...
		console.log('Give the bridge backer some canFRAX and canFXS');
		await canFRAX_instance.transfer(scream_amo_instance.address, initial_dump_amt_amo_canToken, {
			from: GOVERNOR_GUARDIAN_ADDRESS,
		});
		await canFXS_instance.transfer(scream_amo_instance.address, initial_dump_amt_amo_canToken, {
			from: GOVERNOR_GUARDIAN_ADDRESS,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold(
					'===========================LEND SOME CANONICAL TOKENS TO THE ScreamAMO===========================',
				),
		);
		...
		console.log(
			chalk.hex('#ff8b3d').bold('===========================DEPOSIT FRAX FOR scFRAX==========================='),
		);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================WITHDRAW SOME scFRAX [redeem_scFRAX]==========================='),
		);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold(
					'===========================WITHDRAW SOME scFRAX [redeemUnderlying_scFRAX]===========================',
				),
		);

		console.log('Withdraw 10 canFRAX');
		await scream_amo_instance.redeemUnderlying_scFRAX(new BigNumber('10e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk.hex('#ff8b3d').bold('===========================STAKE SOME SCREAM==========================='),
		);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================WAIT SOME TIME AND COLLECT==========================='),
		);
		...
		console.log(
			chalk.hex('#ff8b3d').bold('===========================UNSTAKE SOME XSCREAM==========================='),
		);
		...
		await scream_amo_instance.execute(canFRAX_instance.address, 0, calldata, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
