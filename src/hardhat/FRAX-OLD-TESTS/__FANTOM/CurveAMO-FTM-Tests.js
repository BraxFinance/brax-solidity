...
contract('CurveAMO_FTM-Tests', async (accounts) => {
	...
	it('Main test', async () => {
		...
		await dai_instance.transfer(curve_amo_ftm_instance.address, new BigNumber('1000e18'), {
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold(
					'===========================LEND SOME CANONICAL TOKENS TO THE CurveAMO_FTM===========================',
				),
		);

		console.log('Lend 1000 canFRAX');
		await cc_bridge_backer_instance.lendFraxToAMO(curve_amo_ftm_instance.address, new BigNumber('1000e18'), {
		...
		await cc_bridge_backer_instance.lendCollatToAMO(curve_amo_ftm_instance.address, new BigNumber('1000e6'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		await curve_amo_ftm_instance.metapoolDeposit(frax_only_deposit_amt, 0, 0, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================DEPOSIT DAI ALONE FOR LP TOKENS==========================='),
		);

		console.log('Deposit 50 DAI');
		const dai_only_deposit_amt = new BigNumber('50e18');
		await curve_amo_ftm_instance.metapoolDeposit(0, dai_only_deposit_amt, 0, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		await curve_amo_ftm_instance.metapoolDeposit(0, 0, usdc_only_deposit_amt, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold(
					'===========================DEPOSIT FRAX, DAI, AND USDC FOR LP TOKENS===========================',
				),
		);
		...
		await curve_amo_ftm_instance.metapoolDeposit(
			frax_mixed_deposit_amt,
			dai_mixed_deposit_amt,
		...
		await curve_amo_ftm_instance.metapoolWithdrawFrax(frax_only_lp_withdraw_amt, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		await curve_amo_ftm_instance.metapoolWithdrawUsdc(usdc_only_lp_withdraw_amt, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		await curve_amo_ftm_instance.metapoolWithdrawAtCurRatio(mixed_lp_withdraw_amt, 0, 0, 0, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		await curve_amo_ftm_instance.giveFRAXBack(new BigNumber('1e18'), false, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		await curve_amo_ftm_instance.giveCollatBack(new BigNumber('1e6'), false, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log('Give back 1 USDC');
		await curve_amo_ftm_instance.giveCollatBack(new BigNumber('1e6'), true, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		await curve_amo_ftm_instance.execute(canFRAX_instance.address, 0, calldata, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
