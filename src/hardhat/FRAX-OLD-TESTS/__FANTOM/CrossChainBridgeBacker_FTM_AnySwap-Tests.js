...
contract('CrossChainBridgeBacker_FTM_AnySwap-Tests', async (accounts) => {
	...
	it('Main test', async () => {
		...
		await anyFXS_instance.Swapin(
			'0x6666666666666666666666666666666666666666666666666666666666666666',
			COLLATERAL_FRAX_AND_FXS_OWNER,
			new BigNumber('50000e18'),
			{ from: ANYFXS_ADMIN_ADDRESS },
		);
		...
		await anyUSDC_instance.Swapin(
			'0x6666666666666666666666666666666666666666666666666666666666666666',
			COLLATERAL_FRAX_AND_FXS_OWNER,
			new BigNumber('50000e6'),
			{ from: ANYUSDC_ADMIN_ADDRESS },
		);
		...
		console.log(
			chalk.yellow(
				'========== SET COLLATERAL_FRAX_AND_FXS_OWNER AS THE CrossChainBridgeBacker OWNER  ==========',
			),
		);
		await cc_bridge_backer_instance.nominateNewOwner(COLLATERAL_FRAX_AND_FXS_OWNER, {
			from: process.env.FANTOM_ONE_ADDRESS,
		});
		...
		await anyFRAX_instance.transfer(canFRAX_instance.address, new BigNumber('10000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await anyFXS_instance.transfer(canFXS_instance.address, new BigNumber('10000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('=========================DUMP IN SOME anyFRAX [SIMULATES BRIDGE]========================='),
		);
		const dump_amt_anyFRAX = new BigNumber('10025e18');
		console.log('dump_amt_anyFRAX: ', dump_amt_anyFRAX.div(BIG18).toNumber());

		await anyFRAX_instance.transfer(cc_bridge_backer_instance.address, dump_amt_anyFRAX, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('=========================DUMP IN SOME anyFXS [SIMULATES BRIDGE]========================='),
		);
		const dump_amt_anyFXS = new BigNumber('10025e18');
		console.log('dump_amt_anyFXS: ', dump_amt_anyFXS.div(BIG18).toNumber());

		await anyFXS_instance.transfer(cc_bridge_backer_instance.address, dump_amt_anyFXS, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		await anyUSDC_instance.transfer(cc_bridge_backer_instance.address, dump_amt_USDC, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================GIVE THE canFRAX CONTRACT SOME anyFRAX ==========================='),
		);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================SWAP anyFRAX for canFRAX manually==========================='),
		);
		...
		await cc_bridge_backer_instance.swapAnyForCanonical(0, swapAnyForCanonical_amt_anyFRAX, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================SWAP anyFXS for canFXS manually==========================='),
		);
		...
		await cc_bridge_backer_instance.swapAnyForCanonical(1, swapAnyForCanonical_amt_anyFXS, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================MINT SOME canFRAX and anyFRAX==========================='),
		);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================BURN SOME canFRAX and anyFRAX==========================='),
		);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================COLLECT SOME anyFRAX AND anyFXS==========================='),
		);
		const canToken_collect_amt = new BigNumber('1e18');
		console.log('canToken_collect_amt: ', canToken_collect_amt.div(BIG18).toNumber());

		await cc_bridge_backer_instance.collectBridgeTokens(0, anyFRAX_instance.address, canToken_collect_amt, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await cc_bridge_backer_instance.collectBridgeTokens(1, anyFXS_instance.address, canToken_collect_amt, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================NOTE SOME SpiritSwapLiquidityAMO INFO==========================='),
		);
		...
		let amo_canFXS_bal_before = new BigNumber(await canFXS_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		let amo_usdc_bal_before = new BigNumber(await anyUSDC_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG6)
			.toNumber();

		console.log('Lend 1000 canFRAX');
		await cc_bridge_backer_instance.lendFraxToAMO(STAKING_REWARDS_DISTRIBUTOR, new BigNumber('1000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Lend 1000 canFXS');
		await cc_bridge_backer_instance.lendFxsToAMO(STAKING_REWARDS_DISTRIBUTOR, new BigNumber('1000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Lend 1000 anyUSDC');
		await cc_bridge_backer_instance.lendCollatToAMO(STAKING_REWARDS_DISTRIBUTOR, new BigNumber('1000e6'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		let amo_canFXS_bal_after = new BigNumber(await canFXS_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		let amo_usdc_bal_after = new BigNumber(await anyUSDC_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG6)
			.toNumber();
		...
		await cc_bridge_backer_instance.lendFraxToAMO(
			spiritSwapLiquidityAMO_instance.address,
		...
		utilities.printAllocations(
			...
			the_allocations_spiritswap_amo,
			old_allocations_spiritswap_amo,
		);
		utilities.printTokenBalances(
			'SpiritSwapLiquidityAMO',
			the_token_balances_spiritswap_amo,
			old_balances_spiritswap_amo,
		);
		...
		amo_canFXS_bal_before = new BigNumber(await canFXS_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		amo_usdc_bal_before = new BigNumber(await anyUSDC_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG6)
			.toNumber();

		console.log('Give 250 canFRAX');
		await canFRAX_instance.approve(cc_bridge_backer_instance.address, new BigNumber('250e18'), {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		await cc_bridge_backer_instance.receiveBackViaAMO(canFRAX_instance.address, new BigNumber('250e18'), false, {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});

		console.log('Give 250 canFXS');
		await canFXS_instance.approve(cc_bridge_backer_instance.address, new BigNumber('250e18'), {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		await cc_bridge_backer_instance.receiveBackViaAMO(canFXS_instance.address, new BigNumber('250e18'), false, {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});

		console.log('Give 250 anyUSDC');
		await anyUSDC_instance.approve(cc_bridge_backer_instance.address, new BigNumber('250e6'), {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		await cc_bridge_backer_instance.receiveBackViaAMO(anyUSDC_instance.address, new BigNumber('250e6'), false, {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		...
		amo_canFXS_bal_after = new BigNumber(await canFXS_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		amo_usdc_bal_after = new BigNumber(await anyUSDC_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG6)
			.toNumber();
		...
		await spiritSwapLiquidityAMO_instance.giveFRAXBack(new BigNumber('250e18'), false, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Give back 250 canFXS');
		await spiritSwapLiquidityAMO_instance.giveFXSBack(new BigNumber('250e18'), false, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Give back 250 anyUSDC');
		await spiritSwapLiquidityAMO_instance.giveCollatBack(new BigNumber('250e6'), false, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		await canFRAX_instance.approve(cc_bridge_backer_instance.address, new BigNumber('100e18'), {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		await cc_bridge_backer_instance.receiveBackViaAMO(canFRAX_instance.address, new BigNumber('100e18'), true, {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});

		console.log('Give 100 canFXS');
		await canFXS_instance.approve(cc_bridge_backer_instance.address, new BigNumber('100e18'), {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		await cc_bridge_backer_instance.receiveBackViaAMO(canFXS_instance.address, new BigNumber('100e18'), true, {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});

		console.log('Give 100 anyUSDC');
		await anyUSDC_instance.approve(cc_bridge_backer_instance.address, new BigNumber('100e6'), {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		await cc_bridge_backer_instance.receiveBackViaAMO(anyUSDC_instance.address, new BigNumber('100e6'), true, {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		...
		console.log('Give 100 canFRAX');
		await spiritSwapLiquidityAMO_instance.giveFRAXBack(new BigNumber('100e18'), true, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Give 100 canFXS');
		await spiritSwapLiquidityAMO_instance.giveFXSBack(new BigNumber('100e18'), true, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Give 100 anyUSDC');
		await spiritSwapLiquidityAMO_instance.giveCollatBack(new BigNumber('100e6'), true, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		await cc_bridge_backer_instance.execute(anyFRAX_instance.address, 0, calldata, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
