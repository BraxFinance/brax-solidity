...
module.exports = async (deployer) => {
	...
	// FPI
	fpi_instance = await FPI.new(THE_ACCOUNTS[1], CONTRACT_ADDRESSES.ethereum.misc.timelock);

	console.log(chalk.yellow('========== FPIS =========='));
	// FPIS
	fpis_instance = await FPIS.new(THE_ACCOUNTS[1], CONTRACT_ADDRESSES.ethereum.misc.timelock, fpi_instance.address);
