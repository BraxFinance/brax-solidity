...
contract('FraxCrossChainFarmV2-Tests', async (accounts) => {
	...
	it('Initialization related', async () => {
		...
		await canFXS_instance.transfer(COLLATERAL_FRAX_AND_FXS_OWNER, new BigNumber('1000e18'), {
		...
		await rew1_tkn_instance.transfer(staking_instance.address, new BigNumber('10e18'), {
			from: ADDRESS_WITH_REW1_TKN,
		});
	...
	it('Locked stakes', async () => {
		...
		const fxs_bal_acc_1_time0 = new BigNumber(await canFXS_instance.balanceOf(COLLATERAL_FRAX_AND_FXS_OWNER))
			.div(BIG18)
			.toNumber();
		...
		console.log(
			'Farm FXS balance:',
			new BigNumber(await canFXS_instance.balanceOf(staking_instance.address)).div(BIG18).toNumber(),
		);
		...
		console.log(
			'Farm REW1 balance:',
			new BigNumber(await rew1_tkn_instance.balanceOf(staking_instance.address)).div(BIG18).toNumber(),
		);
		...
		await lp_tkn_instance.approve(staking_instance.address, uni_pool_locked_1_sum, {
		...
		await staking_instance.stakeLocked(new BigNumber('25e17'), 548 * 86400, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		}); // 270 days
		...
		await expectRevert.unspecified(
			staking_instance.withdrawLocked(locked_stake_structs_1_0[0].kek_id, {
				from: COLLATERAL_FRAX_AND_FXS_OWNER,
			}),
		);
		await expectRevert.unspecified(
			staking_instance.withdrawLocked(locked_stake_structs_9_0[0].kek_id, { from: accounts[9] }),
		);
		await time.advanceBlock();
		...
		const user_min_vefxs_for_max_boost_1_0 = new BigNumber(
			await staking_instance.minVeFXSForMaxBoost.call(COLLATERAL_FRAX_AND_FXS_OWNER),
		).div(BIG18);
		const user_min_vefxs_for_max_boost_9_0 = new BigNumber(
			await staking_instance.minVeFXSForMaxBoost.call(accounts[9]),
		).div(BIG18);
		...
		console.log(
			'accounts[9] mid-week part 0 earnings [REW1]: ',
			staking_earned_9_mid0_token1.div(BIG18).toNumber(),
		);
		...
		console.log(
			'accounts[9] mid-week part 1 earnings [REW1]: ',
			staking_earned_9_mid1_token1.div(BIG18).toNumber(),
		);
		...
		const staking_earned_9_fxs = new BigNumber(staking_earned_9[0])
			.plus(staking_earned_9_mid0_fxs)
			.plus(staking_earned_9_mid1_fxs)
			.div(BIG18);
		const staking_earned_9_token1 = new BigNumber(staking_earned_9[1])
			.plus(staking_earned_9_mid0_token1)
			.plus(staking_earned_9_mid1_token1)
			.div(BIG18);
		...
		await staking_instance.withdrawLocked(locked_stake_structs_1_0[0].kek_id, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await expectRevert.unspecified(
			staking_instance.withdrawLocked(locked_stake_structs_9_0[0].kek_id, { from: accounts[9] }),
		...
		const fxs_bal_acc_1_time1 = new BigNumber(await canFXS_instance.balanceOf(COLLATERAL_FRAX_AND_FXS_OWNER))
			.div(BIG18)
			.toNumber();
		...
		console.log(
			chalk.green.bold(
				'Total FXS balance change:',
				fxs_bal_acc_1_time1 + fxs_bal_acc_9_time1 - (fxs_bal_acc_1_time0 + fxs_bal_acc_9_time0),
			),
		);
		...
		await staking_instance.lockAdditional(add_more_before.kek_id, addl_amt_add, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		await rew1_tkn_instance.transfer(staking_instance.address, new BigNumber('100e18'), {
			from: ADDRESS_WITH_REW1_TKN,
		});
		...
		console.log(
			'accounts[1] earnings after 5 weeks (post refill) [FXS]: ',
			staking_fxs_earned_28PR_1_fxs.toString(),
		);
		console.log(
			'accounts[1] earnings after 5 weeks (post refill) [REW1]: ',
			staking_fxs_earned_28PR_1_token1.toString(),
		);
		...
		console.log(
			'accounts[9] earnings after 5 weeks (post refill) [FXS]: ',
			staking_fxs_earned_28PR_9_fxs.toString(),
		);
		console.log(
			'accounts[9] earnings after 5 weeks (post refill) [REW1]: ',
			staking_fxs_earned_28PR_9_token1.toString(),
		);
		...
		console.log(
			'Effective weekly reward at week 5 (post refill) [REW1]: ',
			reward_week_5PR_token1.div(4).toString(),
		); // 1 week delay
		console.log(
			'Effective yearly reward at week 5 (post refill) [FXS]: ',
			effective_yearly_reward_at_week_5PR_fxs.toString(),
		);
		console.log(
			'Effective yearly reward at week 5 (post refill) [REW1]: ',
			effective_yearly_reward_at_week_5PR_token1.toString(),
		);
		...
		console.log(
			'Expected yearly reward (post refill) [FXS]: ',
			duration_reward_3PR_fxs.multipliedBy(52.1429).toString(),
		);
		console.log(
			'Expected yearly reward (post refill) [REW1]: ',
			duration_reward_3PR_token1.multipliedBy(52.1429).toString(),
		);
		...
		await staking_instance.getReward({ from: accounts[9] });
		await expectRevert.unspecified(
			staking_instance.withdrawLocked(locked_stake_structs_1_0[1].kek_id, {
				from: COLLATERAL_FRAX_AND_FXS_OWNER,
			}),
		);
		...
		await staking_instance.withdrawLocked(locked_stake_structs_1_0[1].kek_id, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
	...
	it('Migration Staking / Withdrawal Tests', async () => {
		...
		console.log(
			...
			new BigNumber(await lp_tkn_instance.balanceOf(COLLATERAL_FRAX_AND_FXS_OWNER)).div(BIG18).toNumber(),
		);

		// Stake Locked
		await lp_tkn_instance.approve(staking_instance.address, stake_amt_locked, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		await staking_instance.migrator_withdraw_locked(COLLATERAL_FRAX_AND_FXS_OWNER, locked_stake_structs[2].kek_id, {
		...
		console.log(
			...
			new BigNumber(await lp_tkn_instance.balanceOf(MIGRATOR_ADDRESS)).div(BIG18).toNumber(),
		);
		console.log(
