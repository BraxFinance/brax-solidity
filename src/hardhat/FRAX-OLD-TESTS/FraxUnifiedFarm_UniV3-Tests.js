...
contract('FraxUnifiedFarm_UniV3-Tests', async (accounts) => {
	...
	it('Main test', async () => {
		...
		await frax_instance.transfer(COLLATERAL_FRAX_AND_FXS_OWNER, new BigNumber('2500e18'), {
			from: ADDRESS_WITH_FRAX,
		});
		...
		await rai_instance.transfer(COLLATERAL_FRAX_AND_FXS_OWNER, new BigNumber('3000e18'), {
			from: ADDRESS_WITH_RAI,
		});
		...
		await uniswapV3PositionsNFTInstance.safeTransferFrom(ADDRESS_WITH_UNI_V3_NFT_1, accounts[1], TOKEN_ID_1, {
			from: ADDRESS_WITH_UNI_V3_NFT_1,
		});
		await uniswapV3PositionsNFTInstance.safeTransferFrom(
			ADDRESS_WITH_UNI_V3_NFT_1,
			accounts[1],
			TOKEN_ID_1_ALT_GOOD,
			{ from: ADDRESS_WITH_UNI_V3_NFT_1 },
		);
		...
		await uniswapV3PositionsNFTInstance.safeTransferFrom(ADDRESS_WITH_UNI_V3_NFT_9, accounts[9], TOKEN_ID_9, {
			from: ADDRESS_WITH_UNI_V3_NFT_9,
		});
		await uniswapV3PositionsNFTInstance.safeTransferFrom(
			ADDRESS_WITH_UNI_V3_NFT_9,
			accounts[9],
			TOKEN_ID_9_INVALID_WRONG_TICKS,
			{ from: ADDRESS_WITH_UNI_V3_NFT_9 },
		);
		await uniswapV3PositionsNFTInstance.safeTransferFrom(
			ADDRESS_WITH_UNI_V3_NFT_9,
			accounts[9],
			TOKEN_ID_9_INVALID_WRONG_UNDERLYING_TOKENS,
			{ from: ADDRESS_WITH_UNI_V3_NFT_9 },
		);
		await uniswapV3PositionsNFTInstance.safeTransferFrom(
			ADDRESS_WITH_UNI_V3_NFT_9,
			accounts[9],
			TOKEN_ID_9_INVALID_WRONG_FEE,
			{ from: ADDRESS_WITH_UNI_V3_NFT_9 },
		);
		await uniswapV3PositionsNFTInstance.safeTransferFrom(
			ADDRESS_WITH_UNI_V3_NFT_9,
			accounts[9],
			TOKEN_ID_9_INSIDE_WRONG_TICKS,
			{ from: ADDRESS_WITH_UNI_V3_NFT_9 },
		);
		await uniswapV3PositionsNFTInstance.safeTransferFrom(
			ADDRESS_WITH_UNI_V3_NFT_9,
			accounts[9],
			TOKEN_ID_9_OUTSIDE_WRONG_TICKS,
			{ from: ADDRESS_WITH_UNI_V3_NFT_9 },
		);
		...
		await frax_gauge_controller.gauge_relative_weight_write(staking_instance.address, current_timestamp_0, {
			from: accounts[9],
		});
		await frax_gauge_controller.gauge_relative_weight_write(
	...
	it('Locked stakes', async () => {
		...
		await uniswapV3PositionsNFTInstance.approve(staking_instance.address, TOKEN_ID_1, {
		...
		// account[1]
		await uniswapV3PositionsNFTInstance.approve(staking_instance.address, TOKEN_ID_1_ALT_GOOD, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		const combined_weight_1 = new BigNumber(
		...
		await expectRevert(
			staking_instance.withdrawLocked(TOKEN_ID_1, COLLATERAL_FRAX_AND_FXS_OWNER, {
				from: COLLATERAL_FRAX_AND_FXS_OWNER,
			}),
		...
		await staking_instance.withdrawLocked(TOKEN_ID_1, COLLATERAL_FRAX_AND_FXS_OWNER, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await expectRevert(
			staking_instance.withdrawLocked(TOKEN_ID_9, accounts[9], { from: accounts[9] }),
		...
		await frax_gauge_controller.gauge_relative_weight_write(
			staking_instance.address,
			current_timestamp_re_checkpoint,
			{ from: accounts[9] },
		);
		await frax_gauge_controller.gauge_relative_weight_write(
			'0x3EF26504dbc8Dd7B7aa3E97Bc9f3813a9FC0B4B0',
		...
		await expectRevert.unspecified(
			staking_instance.withdrawLocked(TOKEN_ID_1_ALT_GOOD, COLLATERAL_FRAX_AND_FXS_OWNER, {
				from: COLLATERAL_FRAX_AND_FXS_OWNER,
			}),
		);
		...
		await staking_instance.withdrawLocked(TOKEN_ID_1_ALT_GOOD, COLLATERAL_FRAX_AND_FXS_OWNER, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		assert(
			vefxs_multiplier_9_post_proxy.isGreaterThan(vefxs_multiplier_9_pre_proxy),
			`Proxing should have boosted the weight`,
		);
		...
		// Lock additional
		await staking_instance.lockAdditional(TOKEN_ID_1, add_tkn_amt, add_tkn_amt, 0, 0, false, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		const add_more_balof_ovr_nft_before = utilities.getLockedNFTInfoFromArr(
			add_more_balof_ovr_before_arr,
			TOKEN_ID_1,
		);
		...
		await rai_instance.transfer(staking_instance.address, add_tkn_balof_ovr_amt, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await frax_instance.transfer(staking_instance.address, add_tkn_balof_ovr_amt, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		const add_more_balof_ovr_nft_after = utilities.getLockedNFTInfoFromArr(
			add_more_balof_ovr_after_arr,
			TOKEN_ID_1,
		);
	...
	it('Communal / Token Manager Tests', async () => {
		...
		for (let j = 0; j < staking_reward_tokens_addresses.length; j++) {
			...
			await expectRevert(
				staking_instance.setRewardVars(staking_reward_tokens_addresses[j], 0, ZERO_ADDRESS, ZERO_ADDRESS, {
					from: accounts[9],
				}),
			...
			await expectRevert(
				staking_instance.changeTokenManager(staking_reward_tokens_addresses[j], COLLATERAL_FRAX_AND_FXS_OWNER, {
					from: accounts[9],
				}),
				'Not owner or tkn mgr',
			);
			...
			await staking_instance.setRewardVars(
				staking_reward_tokens_addresses[j],
				0,
				gauge_ctr_add_to_use,
				gauge_rew_dist_add_to_use,
				{ from: token_manager_address },
			);

			console.log('Try recovering reward tokens as the reward manager');
			await staking_instance.recoverERC20(staking_reward_tokens_addresses[j], test_recovery_amount, {
				from: token_manager_address,
			});

			console.log('Change the token manager');
			await staking_instance.changeTokenManager(
				staking_reward_tokens_addresses[j],
	...
	it('Migration Staking / Withdrawal Tests', async () => {
		...
		const combined_weight_before0 = new BigNumber(
			...
			.div(BIG18)
			.toNumber();
		await staking_instance.migrator_withdraw_locked(COLLATERAL_FRAX_AND_FXS_OWNER, TOKEN_ID_1, {
		...
		const combined_weight_after0 = new BigNumber(
			...
			.toNumber();
		console.log(
			`accounts[1] lockedLiquidityOf change [${locked_liq_before0} -> ${locked_liq_after0}]:`,
			locked_liq_after0 - locked_liq_before0,
		);
		console.log(
			`accounts[1] combinedWeightOf change [${combined_weight_before0} -> ${combined_weight_after0}]:`,
			combined_weight_after0 - combined_weight_before0,
		);
		...
		const combined_weight_after1 = new BigNumber(
			...
			.toNumber();
		console.log(
			`accounts[1] lockedLiquidityOf change [${locked_liq_before1} -> ${locked_liq_after1}]:`,
			locked_liq_after1 - locked_liq_before1,
		);
		console.log(
			`accounts[1] combinedWeightOf change [${combined_weight_before1} -> ${combined_weight_after1}]:`,
			combined_weight_after1 - combined_weight_before1,
		);
	...
	it('Migration Fail Tests ', async () => {
		...
		await uniswapV3PositionsNFTInstance.approve(staking_instance.address, TOKEN_ID_9_INVALID_WRONG_TICKS, {
			from: accounts[9],
		});
		await expectRevert(
		...
		await uniswapV3PositionsNFTInstance.approve(staking_instance.address, TOKEN_ID_9_INSIDE_WRONG_TICKS, {
			from: accounts[9],
		});
		await expectRevert(
		...
		await uniswapV3PositionsNFTInstance.approve(staking_instance.address, TOKEN_ID_9_OUTSIDE_WRONG_TICKS, {
			from: accounts[9],
		});
		await expectRevert(
		...
		await uniswapV3PositionsNFTInstance.approve(
			staking_instance.address,
			TOKEN_ID_9_INVALID_WRONG_UNDERLYING_TOKENS,
			{ from: accounts[9] },
		);
		...
		await uniswapV3PositionsNFTInstance.approve(staking_instance.address, TOKEN_ID_9_INVALID_WRONG_FEE, {
			from: accounts[9],
		});
		await expectRevert(
		...
		await expectRevert(
			staking_instance.migrator_withdraw_locked(COLLATERAL_FRAX_AND_FXS_OWNER, TOKEN_ID_1, {
				from: MIGRATOR_ADDRESS,
			}),
			'Not in migration',
		);
		...
		await staking_instance.recoverERC721(uniswapV3PositionsNFTInstance.address, TOKEN_ID_1, {
			from: STAKING_OWNER,
		}),
			await uniswapV3PositionsNFTInstance.safeTransferFrom(
				STAKING_OWNER,
