...
contract('CCFrax1to1AMM-Tests', async (accounts) => {
	...
	it('Main test', async () => {
		...
		await anyUSDC_instance.transfer(cc_bridge_backer_instance.address, new BigNumber('3000e6'), {
			from: ADDRESS_WITH_USDC,
		});

		console.log(chalk.yellow('========== GIVE THE CCFrax1to1AMM SOME USDC  =========='));
		await anyUSDC_instance.transfer(ccfrax_1to1_amm_instance.address, new BigNumber('3000e6'), {
			from: ADDRESS_WITH_USDC,
		});

		console.log(chalk.yellow('========== GIVE THE COLLATERAL_FRAX_AND_FXS_OWNER SOME USDC  =========='));
		await anyUSDC_instance.transfer(COLLATERAL_FRAX_AND_FXS_OWNER, new BigNumber('3000e6'), {
			from: ADDRESS_WITH_USDC,
		});
		...
		await canFRAX_instance.transfer(COLLATERAL_FRAX_AND_FXS_OWNER, new BigNumber('3000e18'), {
		...
		await usdt_instance.transfer(ccfrax_1to1_amm_instance.address, new BigNumber('1000e6'), {
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold(
					'===========================LEND SOME CANONICAL TOKENS TO THE CCFrax1to1AMM===========================',
				),
		);

		console.log('Lend 1000 canFRAX');
		await cc_bridge_backer_instance.lendFraxToAMO(ccfrax_1to1_amm_instance.address, new BigNumber('1000e18'), {
		...
		await cc_bridge_backer_instance.lendCollatToAMO(ccfrax_1to1_amm_instance.address, new BigNumber('1000e6'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk.hex('#ff8b3d').bold('===========================SWAP USDC FOR FRAX==========================='),
		);

		const usdc_only_swap_amt = new BigNumber('50e6');
		await anyUSDC_instance.approve(ccfrax_1to1_amm_instance.address, usdc_only_swap_amt, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Try swapping before it is a whitelisted collateral (should fail)');
		await expectRevert(
			ccfrax_1to1_amm_instance.swapTokenForFrax(anyUSDC_instance.address, usdc_only_swap_amt, {
				from: COLLATERAL_FRAX_AND_FXS_OWNER,
			}),
			'Invalid swap token',
		);
		...
		await ccfrax_1to1_amm_instance.addSwapToken(anyUSDC_instance.address, 400, new BigNumber('100000e6'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Swap 50 USDC for FRAX');
		await ccfrax_1to1_amm_instance.swapTokenForFrax(anyUSDC_instance.address, usdc_only_swap_amt, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Turn off USDC and try swapping again (should fail)');
		await ccfrax_1to1_amm_instance.toggleSwapToken(anyUSDC_instance.address, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await expectRevert(
			ccfrax_1to1_amm_instance.swapTokenForFrax(anyUSDC_instance.address, usdc_only_swap_amt, {
		...
		console.log(
			chalk.hex('#ff8b3d').bold('===========================SWAP FRAX FOR USDC==========================='),
		);

		console.log('Swap 50 canFRAX');
		const frax_only_swap_amt = new BigNumber('50e18');
		await canFRAX_instance.approve(ccfrax_1to1_amm_instance.address, frax_only_swap_amt, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await ccfrax_1to1_amm_instance.swapFraxForToken(anyUSDC_instance.address, frax_only_swap_amt, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk.hex('#ff8b3d').bold('===========================WITHDRAW SOME USDT==========================='),
		);

		console.log('Withdraw 1 USDT');
		const usdt_only_swap_amt = new BigNumber('1e6');
		await ccfrax_1to1_amm_instance.withdrawSwapTokens(MOONRIVER_ADDRESSES.collaterals.USDT, usdt_only_swap_amt, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		await ccfrax_1to1_amm_instance.giveFRAXBack(new BigNumber('1e18'), false, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		await ccfrax_1to1_amm_instance.giveCollatBack(new BigNumber('1e6'), false, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		await expectRevert(
			ccfrax_1to1_amm_instance.withdrawSwapTokens(anyUSDC_instance.address, test_amount_1, {
				from: COLLATERAL_FRAX_AND_FXS_OWNER,
			}),
		...
		await expectRevert(
			ccfrax_1to1_amm_instance.recoverERC20(ccfrax_1to1_amm_instance.address, test_amount_1, {
				from: INVESTOR_CUSTODIAN_ADDRESS,
			}),
			'Not owner',
		);
		...
		await expectRevert(
			ccfrax_1to1_amm_instance.recoverERC20(anyUSDC_instance.address, test_amount_1, {
				from: COLLATERAL_FRAX_AND_FXS_OWNER,
			}),
