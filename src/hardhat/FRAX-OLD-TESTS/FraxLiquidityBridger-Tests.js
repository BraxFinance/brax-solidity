...
contract('FraxLiquidityBridger-Tests', async (accounts) => {
	...
	it('Main test', async () => {
		...
		await usdc_instance.transfer(frax_bridger_instance.address, new BigNumber('10000e6'), {
			from: ADDRESS_WITH_USDC,
		});
		...
		await frax_amo_minter_instance.nominateNewOwner(process.env.FRAX_ONE_ADDRESS, {
			from: process.env.COMPTROLLER_MSIG_ADDRESS,
		});
		...
		console.log(
			'Bridger collatDollarBalance:',
			new BigNumber((await frax_bridger_instance.dollarBalances.call())[1]).div(BIG18).toNumber(),
		);
		console.log(
		...
		await frax_amo_minter_instance.mintFraxForAMO(frax_bridger_instance.address, new BigNumber('100250e18'), {
		...
		await frax_amo_minter_instance.mintFxsForAMO(frax_bridger_instance.address, new BigNumber('100250e18'), {
			from: process.env.FRAX_ONE_ADDRESS,
		});
		...
		await frax_amo_minter_instance.giveCollatToAMO(frax_bridger_instance.address, new BigNumber('100000e6'), {
			from: process.env.FRAX_ONE_ADDRESS,
		});
		...
		console.log(
			'FRAX TokenType:',
			new BigNumber(await frax_bridger_instance.getTokenType.call(frax_instance.address)).toNumber(),
		);
		await frax_bridger_instance.bridge(frax_instance.address, new BigNumber('1000e18'), {
		...
		console.log(
			'FXS TokenType:',
			new BigNumber(await frax_bridger_instance.getTokenType.call(fxs_instance.address)).toNumber(),
		);
		await frax_bridger_instance.bridge(fxs_instance.address, new BigNumber('1000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			'USDC TokenType:',
			new BigNumber(await frax_bridger_instance.getTokenType.call(usdc_instance.address)).toNumber(),
		);
		await frax_bridger_instance.bridge(usdc_instance.address, new BigNumber('1000e6'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		await frax_bridger_instance.execute(usdc_instance.address, 0, calldata, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===================== CHECK AMO CORRECTION OFFSET [POSITIVE] ====================='),
		);
		await frax_amo_minter_instance.setAMOCorrectionOffsets(
			frax_bridger_instance.address,
			new BigNumber('10e18'),
			new BigNumber('25e18'),
			{ from: process.env.FRAX_ONE_ADDRESS },
		);
		...
		console.log(
			'AMO Profit:',
			new BigNumber(await frax_amo_minter_instance.fraxTrackedAMO.call(frax_bridger_instance.address))
				.div(BIG18)
				.toNumber(),
		);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===================== CHECK AMO CORRECTION OFFSET [NEGATIVE] ====================='),
		);
		await frax_amo_minter_instance.setAMOCorrectionOffsets(
			frax_bridger_instance.address,
			new BigNumber('-10e18'),
		...
		console.log(
			chalk.hex('#ff8b3d').bold('===================== UNSET THE AMO CORRECTION OFFSETS ====================='),
		);
		await frax_amo_minter_instance.setAMOCorrectionOffsets(frax_bridger_instance.address, 0, 0, {
			from: process.env.FRAX_ONE_ADDRESS,
		});
