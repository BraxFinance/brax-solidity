...
contract('CrossChainBridgeBacker_AUR_Rainbow-Tests', async (accounts) => {
	...
	it('Main test', async () => {
		...
		await rnbwFRAX_instance.transfer(COLLATERAL_FRAX_AND_FXS_OWNER, new BigNumber('10000e18'), {
			from: ADDRESS_WITH_RNBWFRAX,
		});
		...
		await rnbwFXS_instance.transfer(COLLATERAL_FRAX_AND_FXS_OWNER, new BigNumber('1000e18'), {
			from: ADDRESS_WITH_RNBWFXS,
		});
		...
		await rnbwUSDC_instance.transfer(COLLATERAL_FRAX_AND_FXS_OWNER, new BigNumber('10000e6'), {
			from: ADDRESS_WITH_RNBWUSDC,
		});
		...
		await canFRAX_instance.nominateNewOwner(COLLATERAL_FRAX_AND_FXS_OWNER, {
			from: process.env.AURORA_ONE_ADDRESS,
		});
		...
		await rnbwFRAX_instance.transfer(canFRAX_instance.address, new BigNumber('5000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await rnbwFXS_instance.transfer(canFXS_instance.address, new BigNumber('500e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('=========================DUMP IN SOME rnbwFRAX [SIMULATES BRIDGE]========================='),
		);
		const dump_amt_rnbwFRAX = new BigNumber('125e18');
		console.log('dump_amt_rnbwFRAX: ', dump_amt_rnbwFRAX.div(BIG18).toNumber());

		await rnbwFRAX_instance.transfer(cc_bridge_backer_instance.address, dump_amt_rnbwFRAX, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('=========================DUMP IN SOME rnbwFXS [SIMULATES BRIDGE]========================='),
		);
		const dump_amt_rnbwFXS = new BigNumber('50e18');
		console.log('dump_amt_rnbwFXS: ', dump_amt_rnbwFXS.div(BIG18).toNumber());

		await rnbwFXS_instance.transfer(cc_bridge_backer_instance.address, dump_amt_rnbwFXS, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		await rnbwUSDC_instance.transfer(cc_bridge_backer_instance.address, dump_amt_USDC, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================GIVE THE canFRAX CONTRACT SOME rnbwFRAX ==========================='),
		);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================SWAP rnbwFRAX for canFRAX manually==========================='),
		);
		...
		await cc_bridge_backer_instance.swapAnyForCanonical(0, swapAnyForCanonical_amt_rnbwFRAX, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================SWAP rnbwFXS for canFXS manually==========================='),
		);
		...
		await cc_bridge_backer_instance.swapAnyForCanonical(1, swapAnyForCanonical_amt_rnbwFXS, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================MINT SOME canFRAX and rnbwFRAX==========================='),
		);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('===========================BURN SOME canFRAX and rnbwFRAX==========================='),
		);
		...
		console.log(
			chalk
				.hex('#ff8b3d')
				.bold('==========COLLECT SOME rnbwFRAX AND rnbwFXS FROM THE CANONICAL CONTRACTS=========='),
		);
		const canToken_collect_amt = new BigNumber('1e18');
		console.log('canToken_collect_amt: ', canToken_collect_amt.div(BIG18).toNumber());

		await cc_bridge_backer_instance.collectBridgeTokens(0, rnbwFRAX_instance.address, canToken_collect_amt, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		await cc_bridge_backer_instance.collectBridgeTokens(1, rnbwFXS_instance.address, canToken_collect_amt, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		...
		let amo_canFXS_bal_before = new BigNumber(await canFXS_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		let amo_usdc_bal_before = new BigNumber(await rnbwUSDC_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG6)
			.toNumber();
		...
		let amo_canFXS_bal_after = new BigNumber(await canFXS_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		let amo_usdc_bal_after = new BigNumber(await rnbwUSDC_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG6)
			.toNumber();
		...
		amo_canFXS_bal_before = new BigNumber(await canFXS_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		amo_usdc_bal_before = new BigNumber(await rnbwUSDC_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG6)
			.toNumber();
		...
		await rnbwUSDC_instance.approve(cc_bridge_backer_instance.address, new BigNumber('5e6'), {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		await cc_bridge_backer_instance.receiveBackViaAMO(rnbwUSDC_instance.address, new BigNumber('5e6'), false, {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		...
		amo_canFXS_bal_after = new BigNumber(await canFXS_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG18)
			.toNumber();
		amo_usdc_bal_after = new BigNumber(await rnbwUSDC_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR))
			.div(BIG6)
			.toNumber();
		...
		console.log(
			'rnbwUSDC balance [STAKING_REWARDS_DISTRIBUTOR] change: ',
		...
		await rnbwUSDC_instance.approve(cc_bridge_backer_instance.address, new BigNumber('1e6'), {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		await cc_bridge_backer_instance.receiveBackViaAMO(rnbwUSDC_instance.address, new BigNumber('1e6'), true, {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		...
		await cc_bridge_backer_instance.execute(rnbwFRAX_instance.address, 0, calldata, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
