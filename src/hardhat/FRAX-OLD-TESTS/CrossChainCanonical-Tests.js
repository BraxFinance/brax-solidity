...
contract('CrossChainCanonical-Tests', async (accounts) => {
	...
	it('Initialization related', async () => {
		...
		await anyFRAX_instance.transfer(GOVERNOR_GUARDIAN_ADDRESS, new BigNumber('5000e18'), {
		...
		await anyFRAX_instance.transfer(ORACLE_ADDRESS, new BigNumber('5000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Give the TIMELOCK_ADMIN address some anyFRAX, for later tests');
		await anyFRAX_instance.transfer(TIMELOCK_ADMIN, new BigNumber('5000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Give the STAKING_REWARDS_DISTRIBUTOR address some anyFRAX, for later tests');
		await anyFRAX_instance.transfer(STAKING_REWARDS_DISTRIBUTOR, new BigNumber('5000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log(chalk.gray('---------------------------'));
		console.log('Give ORACLE_ADDRESS some canonical tokens, for later tests');
		await canFRAX_instance.transfer(ORACLE_ADDRESS, new BigNumber('1000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Give TIMELOCK_ADMIN some canonical tokens, for later tests');
		await canFRAX_instance.transfer(TIMELOCK_ADMIN, new BigNumber('1000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});

		console.log('Give the STAKING_REWARDS_DISTRIBUTOR some canonical tokens for later tests');
		await canFRAX_instance.transfer(STAKING_REWARDS_DISTRIBUTOR, new BigNumber('1000e18'), {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
	...
	it('Main functions', async () => {
		...
		// =========================================================================
		console.log(
			chalk.hex('#1da1f2')('=============TEST AN EXCHANGE [OLD -> NEW, non-minter, non exempt]============='),
		);
		const exchange_amt = new BigNumber('100e18');

		// Approve
		await anyFRAX_instance.approve(canFRAX_instance.address, new BigNumber('500e18'), {
		...
		console.log(
			'Canonical before:',
			new BigNumber(await canFRAX_instance.balanceOf.call(GOVERNOR_GUARDIAN_ADDRESS)).div(BIG18).toNumber(),
		);
		console.log(
			'anyFRAX before:',
			new BigNumber(await anyFRAX_instance.balanceOf.call(GOVERNOR_GUARDIAN_ADDRESS)).div(BIG18).toNumber(),
		);

		// Exchange
		await canFRAX_instance.exchangeOldForCanonical(anyFRAX_instance.address, exchange_amt, {
			from: GOVERNOR_GUARDIAN_ADDRESS,
		});
		...
		console.log(
			'Canonical before:',
			new BigNumber(await canFRAX_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR)).div(BIG18).toNumber(),
		);
		console.log(
			'anyFRAX before:',
			new BigNumber(await anyFRAX_instance.balanceOf.call(STAKING_REWARDS_DISTRIBUTOR)).div(BIG18).toNumber(),
		);

		// Exchange
		await canFRAX_instance.exchangeOldForCanonical(anyFRAX_instance.address, exchange_amt_1, {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		...
		// =========================================================================
		console.log(
			chalk.hex('#1da1f2')('=============TEST AN EXCHANGE [OLD -> NEW, non-minter, fee-exempt]============='),
		);
		...
		console.log(
			'Canonical before:',
			new BigNumber(await canFRAX_instance.balanceOf.call(TIMELOCK_ADMIN)).div(BIG18).toNumber(),
		);
		console.log(
			'anyFRAX before:',
			new BigNumber(await anyFRAX_instance.balanceOf.call(TIMELOCK_ADMIN)).div(BIG18).toNumber(),
		);

		// Exchange
		await canFRAX_instance.exchangeOldForCanonical(anyFRAX_instance.address, exchange_amt_2, {
			from: TIMELOCK_ADMIN,
		});
		...
		await canFRAX_instance.minter_mint(STAKING_REWARDS_DISTRIBUTOR, mint_amt, {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		console.log(
			'Canonical after:',
		...
		// Exchange
		await canFRAX_instance.exchangeCanonicalForOld(anyFRAX_instance.address, exchange_amt2, {
			from: STAKING_REWARDS_DISTRIBUTOR,
		});
		...
		console.log(
			'Canonical before:',
			new BigNumber(await canFRAX_instance.balanceOf.call(ORACLE_ADDRESS)).div(BIG18).toNumber(),
		);
		console.log(
			'anyFRAX before:',
			new BigNumber(await anyFRAX_instance.balanceOf.call(ORACLE_ADDRESS)).div(BIG18).toNumber(),
		);

		// Exchange
		await canFRAX_instance.exchangeCanonicalForOld(anyFRAX_instance.address, exchange_amt3, {
			from: ORACLE_ADDRESS,
		});
		...
		// =========================================================================
		console.log(
			chalk.hex('#1da1f2')('=============TEST AN EXCHANGE [NEW -> OLD, non-minter, fee exempt]============='),
		);
		...
		// Exchange
		await canFRAX_instance.exchangeCanonicalForOld(anyFRAX_instance.address, exchange_amt4, {
			from: TIMELOCK_ADMIN,
		});
		...
		console.log(
			'anyFRAX before:',
			new BigNumber(await anyFRAX_instance.balanceOf.call(COLLATERAL_FRAX_AND_FXS_OWNER)).div(BIG18).toNumber(),
		);
		await canFRAX_instance.withdrawBridgeTokens(anyFRAX_instance.address, withdrawal_amt, {
			from: COLLATERAL_FRAX_AND_FXS_OWNER,
		});
		console.log(
			'anyFRAX after:',
	...
	it('Fail Tests ', async () => {
		...
		await expectRevert(
			canFRAX_instance.exchangeOldForCanonical(frax_instance.address, test_amount_1, {
				from: GOVERNOR_GUARDIAN_ADDRESS,
			}),
			'Invalid old token',
		);
		...
		await expectRevert(
			canFRAX_instance.exchangeOldForCanonical(anyFRAX_instance.address, test_amount_1, {
				from: GOVERNOR_GUARDIAN_ADDRESS,
			}),
			'Exchanges paused',
		);
		...
		await expectRevert(
			canFRAX_instance.exchangeOldForCanonical(anyFRAX_instance.address, new BigNumber('250e18'), {
				from: GOVERNOR_GUARDIAN_ADDRESS,
			}),
			'Mint cap',
		);
		...
		await expectRevert(
			canFRAX_instance.exchangeOldForCanonical(anyFRAX_instance.address, new BigNumber('10000e18'), {
				from: GOVERNOR_GUARDIAN_ADDRESS,
			}),
		...
		await expectRevert(
			canFRAX_instance.withdrawBridgeTokens(anyFRAX_instance.address, test_amount_1, {
				from: GOVERNOR_GUARDIAN_ADDRESS,
			}),
		...
		await expectRevert(
			canFRAX_instance.withdrawBridgeTokens(frax_instance.address, test_amount_1, {
				from: COLLATERAL_FRAX_AND_FXS_OWNER,
			}),
			'Invalid old token',
		);
		...
		await expectRevert(
			canFRAX_instance.withdrawBridgeTokens(anyFRAX_instance.address, new BigNumber('1000000000e18'), {
				from: COLLATERAL_FRAX_AND_FXS_OWNER,
			}),
		...
		await expectRevert(
			canFRAX_instance.minter_mint(GOVERNOR_GUARDIAN_ADDRESS, new BigNumber('1000000000e18'), {
				from: GOVERNOR_GUARDIAN_ADDRESS,
			}),
			'Mint cap',
		);
		...
		await expectRevert(
			canFRAX_instance.burnFrom(COLLATERAL_FRAX_AND_FXS_OWNER, test_amount_1, {
				from: GOVERNOR_GUARDIAN_ADDRESS,
			}),
