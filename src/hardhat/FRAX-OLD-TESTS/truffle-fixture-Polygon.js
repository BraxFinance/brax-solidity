...
module.exports = async (deployer) => {
	...
	// Bridges
	cross_chain_bridge_backer_instance = await CrossChainBridgeBacker_POLY_MaticBridge.at(
		CONTRACT_ADDRESSES.polygon.bridge_backers.matic_bridge,
	);
	...
	// Staking
	staking_instance_frax_musd = await FraxCrossChainFarm_FRAX_mUSD.at(
	...
	sushiswap_liquidity_instance = await SushiSwapLiquidityAMO_POLY.at(
		CONTRACT_ADDRESSES.polygon.amos.sushiswap_liquidity,
	);
