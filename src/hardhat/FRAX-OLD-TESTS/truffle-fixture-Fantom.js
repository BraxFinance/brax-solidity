...
module.exports = async (deployer) => {
	...
	// Bridges
	cross_chain_bridge_backer_instance = await CrossChainBridgeBacker_FTM_AnySwap.at(
	...
	// Staking
	staking_instance_frax_fxs_spirit = await FraxCrossChainFarm_FRAX_FXS_Spirit.at(
		CONTRACT_ADDRESSES.fantom.staking_contracts['SpiritSwap FRAX/FXS'],
	);

	// AMOs
	spiritSwapLiquidityAMO_instance = await SpiritSwapLiquidityAMO.at(
		CONTRACT_ADDRESSES.fantom.amos.spiritswap_liquidity,
	);
	...
	await cross_chain_bridge_backer_instance.addAMO(curve_amo_ftm_instance.address, false, {
