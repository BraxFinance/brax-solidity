...
interface IBrax {
  ...
  function brax_pools_array(uint256 ) external view returns (address);
  function brax_price() external view returns (uint256);
  function brax_step() external view returns (uint256);
  function bxs_address() external view returns (address);
  function bxs_btc_oracle_address() external view returns (address);
