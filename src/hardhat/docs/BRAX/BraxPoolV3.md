...
-   `CollateralInformation return_data` struct containing all data regarding the provided collateral address
...
-   `address[] addresses` list of all collateral addresses
...
-   `uint256 balance_tally` total BTC value in pool (E18)
...
-   `uint256 total_brax_mint` Amount of BRAX minted
-   `uint256 collat_needed` Amount of collateral used
-   `uint256 bxs_needed` Amount of BXS used
